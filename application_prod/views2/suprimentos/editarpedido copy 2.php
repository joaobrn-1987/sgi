    ...
    <div class="row-fluid" style="margin-top:0">
        <div class="span12">
            <div class="widget-box">
                <div class="widget-title">
                    ...
                    <h5>Pedido de Compra - Número: <?php echo $this->uri->segment(3); ?> | Data abertura:
                        <?php echo date("d/m/Y H:i:s", strtotime($results[0]->data_cadastro));?></h5>
                    <?php
			...
			if($this->permission->checkPermission($this->session->userdata('permissao'),'vPedCompra')){
				echo '<a href="'.base_url().'index.php/suprimentos/imprimir_pedido/'.$this->uri->segment(3).'/'.$this->uri->segment(4).'" style="margin-right: 1%" class="class="btn btn-mini btn-info" title="Imprimir pedido" target="_blank"><button class="btn btn-mini btn-info" title="Imprimir PDF"><i class="icon-print icon-white"> Imprimir</i></button></a>'; 
                            ...
                            <div class="tab-pane active" id="tab1">
                                ...
                                <div class="span12" id="divCadastrarOs">
                                    ...
                                    <form class="form-inline"
                                        action="<?php echo base_url() ?>index.php/suprimentos/editarpedidocompra"
                                        method="post">
                                        ...
                                        <div style="padding: 1%; margin-left: 1">
                                            <div class="span6" class="control-group">
                                                ...
                                                <input id="idPedidoCompra" type="hidden" name="idPedidoCompra"
                                                    value="<?php echo $results[0]->idPedidoCompra; ?>" />
                                                <?php if(isset($results[0]->idEmitente))
											{
												?>
                                                <input id="emitente" onclick="this.select();" class="span12"
                                                    class="controls" type="text" name="emitente"
                                                    value="<?php echo $results[0]->nome; ?>" size='50' />
                                                <input id="emitente_id" type="hidden" name="emitente_id"
                                                    value="<?php echo $results[0]->idEmitente; ?>" />
											...
											else
											{
                                                ...
                                                <input id="emitente" class="span12" class="controls" type="text"
                                                    name="emitente" value="" size='50' />
											...
											{
												?>
                                                <input id="fornecedor" onclick="this.select();" class="span12"
                                                    class="controls" type="text" name="fornecedor"
                                                    value="<?php echo $results[0]->nomeFornecedor; ?>" size='50' />
                                                <input id="fornecedor_id" type="hidden" name="fornecedor_id"
                                                    value="<?php echo $results[0]->idFornecedores; ?>" />
											...
											else
											{
                                                ...
                                                <input id="fornecedor" class="span12" class="controls" type="text"
                                                    name="fornecedor" value="" size='50' />
                                        ...
                                        <div class="span12" class="control-group"><br><b>Dados NF Vinculada a essa
                                                OC:</b>
                                            <table width='100%'>
                                                <?php 
		$somatoria = 1;
		...
		foreach ($resultsnf as $rnf) {
			...
			?>
                                                <tr>
                                                    <td>
                                                        Prazo Entrega:<b><?php echo $rnf->prazo_entrega; ?></b> dias
                                                    </td>
                                                    <td>Previsão
                                                        Entrega:<b><?php if(!empty($rnf->previsao_entrega)) { echo date("d/m/Y", strtotime($rnf->previsao_entrega));}; ?></b>
                                                    </td>
                                                    <td colspan='2'> Forma de
                                                        pagamento:<b><?php echo $rnf->nome_status_cond_pgt; ?></b></td>
                                                    <td colspan='2'> Condição de
                                                        pagamento:<b><?php echo $rnf->cod_pgto; ?></b></td>
                                                </tr>

                                                <tr>
                                                    <td>Desconto:<b><?php echo number_format($rnf->desconto, 2, ",", ".") ; ?></b>
                                                    </td>
                                                    <td> ICMS:<b><?php echo number_format($rnf->icms, 2, ",", ".") ;  ?></b>
                                                    </td>
                                                    <td> Outros:<b><?php echo number_format($rnf->outros, 2, ",", ".") ;  ?></b>
                                                    </td>
                                                    <td> Frete:<b><?php echo number_format($rnf->frete, 2, ",", ".") ;  ?></b>
                                                    </td>
                                                    <td>Data
                                                        NF:<b><?php if(!empty($rnf->datanf)) { echo date("d/m/Y", strtotime($rnf->datanf));}; ?></b>
                                                    </td>
                                                    <td>Nº NF:<b><?php echo $rnf->notafiscal; ?></b></td>
                                                </tr>
                                                <tr>
                                                    <td colspan='8'>
                                                        OBS:<br><b><?php echo nl2br($rnf->obscompras); ?></b></td>
                                                </tr>
                                                <br><br>
                                                <?php	
		$somatoria ++;
		...
		?>
                                            ...
                                            <input type="hidden" name="icms" id="icms"
                                                value="<?php echo number_format($icmsitem, 2, ",", ".") ;?>">
                                            <input type="hidden" name="frete" id="frete"
                                                value="<?php echo number_format($freteitem, 2, ",", ".");?>">
                                            <input type="hidden" name="desconto" id="desconto"
                                                value="<?php echo number_format($descontoitem, 2, ",", ".");?>">
                                            <input type="hidden" name="outros" id="outros"
                                                value="<?php echo number_format($outrositem, 2, ",", ".");?>">
...
<input id="idPedidoCompra"  type="hidden" name="idPedidoCompra" value="<?php echo $results[0]->idPedidoCompra; ?>"  />
                                        ...
                                        <div class="span12" style="padding: 1%; margin-left: 0">
                                            ...
                                            <div class="form-actions" align='center'>
                                                ...
                                                <button type="submit" class="btn btn-success"><i
                                                        class="icon-plus icon-white"></i> Salvar</button>
    ...
    <div class="widget-box">
        <div class="widget-title">
            ...
            <h5>Itens Pedido de compra</h5><a href="#modal-dadosnotafiscal" style="margin-right: 1%" role="button"
            ...
            <form action="<?php echo base_url() ?>index.php/suprimentos/salvaritemcompra" method="post">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <th>Status<a href="#modal-ipi" style="margin-right: 1%" role="button" data-toggle="modal"
                                title="Editar IPI">
                                <font color='red'><i class="icon-pencil icon-white"></i></font>
                            </a></th>
                        <th>Data <br>Entregue<a href="#modal-ipi" style="margin-right: 1%" role="button"
                                data-toggle="modal" title="Editar IPI">
                                <font color='red'><i class="icon-pencil icon-white"></i></font>
                            </a></th>
                        <th>Grupo</th>
                        <th width='15'>QTD<br>recebida</th>
                        <th>Valor Unit.</th>
                        <th width='35'>IPI% <a href="#modal-ipi" style="margin-right: 1%" role="button"
                                data-toggle="modal" title="Editar IPI">
                                <font color='red'><i class="icon-pencil icon-white"></i></font>
                            </a></th>
                        <th>Valor <br>total</th>

                        <th>N° NF <a href="#modal-ipi" style="margin-right: 1%" role="button" data-toggle="modal"
                                title="Editar IPI">
                                <font color='red'><i class="icon-pencil icon-white"></i></font>
                            </a></th>
                ...
                foreach ($results as $r) {
                 ...
                 ?>
                    ...
                    <tr style="color:<?php echo $color;?>">
                        ...
                        <input id="idPedidoCompraItens" type="hidden" name="idPedidoCompraItens[]"
                            value="<?php echo $r->idPedidoCompraItens;?>" />
                        <input id="idCotacaoItens" type="hidden" name="idCotacaoItens[]"
                            value="<?php echo $r->idCotacaoItens;?>" />
                        <input type="hidden" id="item<?php echo $contador;?>" name="item[]" value="" size="1" />
                        <td><a href="#modal-usuario<?php echo $r->idPedidoCompraItens; ?>" style="margin-right: 1%"
                                role="button" data-toggle="modal" class="btn tip-top"><i class="icon icon-user"></i></a>
                            <font size='1'><?php echo $r->idOs;?></font>
                        </td>
                        <td><input id="quantidade<?php echo $contador;?>" type="hidden" name="quantidade[]"
                                value="<?php echo $r->quantidade;?>" /><?php echo $r->quantidade;?> -
                            <?php
                        ...
                        <td>
                            <font size='1'><?php echo $r->descricaoInsumo." ".$r->dimensoes;?></font>
                        </td>
                        ...
                        <td>
                            <select class="recebe-solici" class="controls" style="font-size: 10px;"
                                ...
                                <?php foreach ($dados_statuscompra as $so) { ?>
                                    ...
                                    ?>
                                                ...
                                                <option value="<?php echo $so->idStatuscompras; ?>"
                                                    <?php if($so->idStatuscompras == $r->idStatuscompras ){ echo "selected='selected'";}?>>
                                                    <?php echo $so->nomeStatus; ?></option>
                                                <?php
                                    }
                                    else
                        ...
                        if(!empty($r->datastatusentregue))
                        {
                            ...
                            ?>
                                            <input id="dataentregue" class="data span14" type="hidden" name="dataentregue[]"
                                                value="<?php echo $dataentr;?>" />
                        ...
                        else
                        {
                            ?>
                                            ...
                                            <input id="dataentregue" class="data span14" type="text" name="dataentregue[]" value=""
                        ...
                        {
                            ?>
                            <a href="#modalsaida2" data-toggle="modal" role="button"
                                idInsumos_e="<?php echo $r->idInsumos ;?>"
                                idPedidoCompra_e="<?php echo $r->idPedidoCompra ;?>"
                                idPedidoCompraItens_e="<?php echo $r->idPedidoCompraItens ;?>"
                                quantidade_e="<?php echo $r->quantidade ;?>" dimensoes_e="<?php echo $r->dimensoes ;?>"
                                valor_unitario_e="<?php echo $r->valor_unitario ;?>"
                                idEmitente_e="<?php echo $r->idEmitente ;?>"><img
                                    src="<?php echo base_url()?>assets/img/sign-in.png" title="Dar Entrada" /></a>
                        ...
                        <td><input class="span8" onclick="this.select();" type="text" style="font-size: 10px;"
                                name="qtdrecebida[]" value="<?php echo $r->qtdrecebida; ?>"></td>
			            ...
			            <input style="font-size: 10px;" class="span12" onclick="this.select();" onKeyPress="FormataValor2(this,event,10,4);" type="text" id="valor_unitario<?php echo $contador;?>"  name="valor_unitario[]" value="<?php echo number_format($r->valor_unitario, 4, ",", "."); ?>"  onKeyUp="calculaSubTotal(<?php echo $contador; ?>);"> -->
                            <input style="font-size: 10px;" class="span12" onclick="this.select();" type="text"
                                id="valor_unitario<?php echo $contador;?>" name="valor_unitario[]"
                                value="<?php echo number_format($r->valor_unitario, 4, ",", "."); ?>"
                        ...
                        <td>
                            ...
                            <a href="#modal-nfdata<?php echo $r->idPedidoCompraItens; ?>" style="margin-right: 1%"
                        ...
                        <div id="modal-usuario<?php echo $r->idPedidoCompraItens; ?>" class="modal hide fade"
		...
		?>
                ...
                <div class="span12" style="padding: 1%; margin-left: 0">
                    ...
                    <div class="form-actions" align='center'>
                        ...
                        <button type="submit" class="btn btn-success"><i class="icon-plus icon-white"></i> SALVAR
                            ITENS</button>
    ...
    <div align='right'>
        VALOR DOS PRODUTOS R$:<input name="valor_produtos_" type="text" id="valor_produtos_"
            style="font-family: Arial; font-size: 12px; background-color:#E3EEF2; border: 0px solid #000000;"
            value="0,00" size="12" readonly="true">
    </div>
    <div align='right'>
        IPI R$: <input name="ipi_" type="text" id="ipi_"
            style="font-family: Arial; font-size: 12px; background-color:#E3EEF2; border: 0px solid #000000;"
            value="0.00" size="12" readonly="true">
    </div>
    <div align='right'>
        DESCONTO R$: <input name="desconto_" type="text" id="desconto_"
            style="font-family: Arial; font-size: 12px; background-color:#E3EEF2; border: 0px solid #000000;"
            value="0.00" size="12" readonly="true">
    </div>
    <div align='right'>
        OUTROS R$: <input name="outros_" type="text" id="outros_"
            style="font-family: Arial; font-size: 12px; background-color:#E3EEF2; border: 0px solid #000000;"
            value="0.00" size="12" readonly="true">
    </div>
    <div align='right'>
        FRETE R$: <input name="frete_" type="text" id="frete_"
            style="font-family: Arial; font-size: 12px; background-color:#E3EEF2; border: 0px solid #000000;"
            value="0.00" size="12" readonly="true">
    </div>
    <div align='right'>
        ICMS R$: <input name="icms_" type="text" id="icms_"
            style="font-family: Arial; font-size: 12px; background-color:#E3EEF2; border: 0px solid #000000;"
            value="0.00" size="12" readonly="true">
    </div>
    <div align='right'>
        TOTAL R$: <input name="valor_total_" type="text" id="valor_total_"
            style="font-family: Arial; font-size: 12px; background-color:#E3EEF2; border: 0px solid #000000;"
            value="0.00" size="12" readonly="true">
    </div>
    ...
    <div id="modal-imprimiritem" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
        aria-hidden="true">
        <form action="<?php echo base_url() ?>index.php/suprimentos/imprimiritem" method="post">
            ...
            <div class="modal-body">
                <input id="idPedidoCompraipi" type="hidden" name="idPedidoCompraipi"
                    value="<?php echo $results[0]->idPedidoCompra; ?>" />
    ...
    <div id="modal-ipi" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
        aria-hidden="true">
        <form action="<?php echo base_url() ?>index.php/suprimentos/editar_ipi" method="post">
            ...
            <div class="modal-body">
                <input id="idPedidoCompraipi" type="hidden" name="idPedidoCompraipi"
                    value="<?php echo $results[0]->idPedidoCompra; ?>" />
                Valor IPI%:<input id="valoripi" onKeyPress="FormataValor2(this,event,10,2);" onclick="this.select();"
                    type="text" name="valoripi" value="" />% ex.:5,00<br><br>
                Status Compra:<select class="recebe-solici" class="controls" name="idStatuscompras2"
                    id="idStatuscompras2">
                    <option value=''></option>
                    <?php foreach ($dados_statuscompra as $so) { ?>
	...
	foreach ($results as $r) {
	 ?>
		<div id="modal-nfdata<?php echo $r->idPedidoCompraItens; ?>" class="modal hide fade"
			tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			...
			<div class="modal-body">
				...
				<form action="<?php echo base_url() ?>index.php/suprimentos/editar_ipi" method="post">
					<div style="float:right; size:20px">
						...
						<font size="3">
							<input id="idPedidoCompraipi" type="hidden" name="idPedidoCompraipi"
                    			value="<?php echo $r->idPedidoCompra; ?>" />
							...
							Data
							NF:
							<input class="data" type="text" style="font-size: 18px;" size=13 name="dataentregue2" value="<?php if(!empty($r->datastatusentregue)) { echo date("d/m/Y", strtotime($r->datastatusentregue ));}; ?>" />
					...
					Previsão
					Entrega:<b><?php if(!empty($r->previsao_entrega)) { echo date("d/m/Y", strtotime($r->previsao_entrega));}; ?></b><br>
    ...
    <div id="modalsaida2" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
        aria-hidden="true">
        <form action="<?php echo base_url(); ?>index.php/estoque/cadastrarestoque" id="formCadastrar"
