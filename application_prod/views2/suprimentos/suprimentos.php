                                ...
                                <form class="form-inline" action="<?php echo base_url() ?>index.php/suprimentos"
                                    ...
                                    <div class="span12" style="padding: 1%; margin-left: 0">
                                        ...
                                        <div class="span2" class="control-group">
                                            ...
                                            <input class="form-control" type="text" name="idPedidoCompra" value="<?=set_value('idPedidoCompra', null)?>"
                                        ...
                                        <div class="span2" class="control-group">
                                            ...
                                            <input class="form-control" type="text" name="nf_fornecedor" value="<?=set_value('nf_fornecedor', null)?>"
                                                class="span12">
                                        ...
                                        <div class="span2" class="control-group">
                                                ...
                                                <input class="form-control" type="text" name="idOs" value="<?=set_value('idOs', null)?>"
                                                class="span12">
                                    ...
                                    <div class="span12" style="padding: 1%; margin-left: 0">
                                        ...
                                        <div class="span2" class="control-group">
                                            ...
                                            <input class="form-control" type="text" name="numPedido" value="<?=set_value('numPedido', null)?>"
                                            class="span12">
                                        ...
                                        <div class="span2" class="control-group">
                                            ...
                                            <input class="form-control" type="text" name="descricao" value="<?=set_value('descricao', null)?>"
                                            class="span12">
