                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab1">
                            ...
                            <div class="span12" id="divCadastrarOs">
                              ...
                              <form class="form-inline" action="<?php echo base_url() ?>index.php/suprimentos/almoxarifado" method="post" name="form1" id="form1">
...
<div class="widget-content nopadding">
 ...
 <form class="form-inline" action="<?php echo base_url() ?>index.php/pedidocompra/montarpedidocompra" method="post" name="form1" id="form1">
...
<form  action="<?php echo base_url() ?>index.php/pedidocompra/editarpc" method="post">
...
<div id="modal-excluiritempedido" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <form action="<?php echo base_url() ?>index.php/pedidocompra/excluir_itempedido" method="post" >
  <div class="modal-header">
    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
