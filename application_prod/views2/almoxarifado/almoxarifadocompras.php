...
<div id="suprimentos" style="display:block"> 
                                    ...
                                    <form class="form-inline" action="<?php echo base_url() ?>index.php/suprimentos"
                                        ...
                                        <div class="span12" style="padding: 1%; margin-left: 0">
                                            ...
                                            <div class="span2" class="control-group">
                                                ...
                                                <input class="form-control" type="text" name="idPedidoCompra" id="idPedidoCompra" value=""
                                            ...
                                            <div class="span2" class="control-group">
                                                ...
                                                <input class="form-control" type="text" name="nf_fornecedor" id="nf_fornecedor" value=""
                                                    class="span12">
                                            ...
                                            <div class="span3" class="control-group">
                                                ...
                                                <br>
                                                        ...
                                                        <select class="recebe-solici" class="controls" 
                                            ...
                                            <div class="span2" class="control-group">
                                                    ...
                                                    <input class="form-control" type="text" name="numPedido" id="numPedido" value=""
                                                    class="span12">
                                    ...
                                    <td >
                                        ...
                                        if($this->permission->checkPermission($this->session->userdata('permissao'),'ePedidocompraalmox')){
                                            if($r->idStatuscompras == 1 || $r->idStatuscompras ==2){ ?>
                                                <a href="#modal-editarquantidade" style="margin-right: 1%" role="button"
                                                data-toggle="modal" quantidadeDistri="<?php if(isset($r->quantidade)){echo $r->quantidade;}?>" idDistribuirOS="<?php if(isset($r->idDistribuir)){echo $r->idDistribuir;}?>" 
                                    ...
                                    <form class="form-inline">
                                        ...
                                        <div class="span12" style="padding: 1%; margin-left: 0">                                            
                                            ...
                                            <div class="span3" class="control-group">
                                                ...
                                                <textarea class="span12" class="form-control" id="obs"
                                                    type="text" name="obs" value="" ></textarea>                                                
                                            </div>     
...
<div id="materialentregue" style="display:none">
    <div class="widget-box">
        <div class="widget-title">
            <span class="icon">
                <i class="icon-user"></i>
               ...
               <tbody>
                    <?php foreach($dados_aguardandoarmazenamento as $r){ ?>
                     <tr>
                        ...
                        <td>
                            <a style="margin-right: 1%" href="#modal-cancelarEntrada" data-toggle="modal" role="button" 
                                class="btn btn-danger tip-top " cancelarEntradaId = "<?php echo $r->idAlmoAgArmaz?>" descricaoEntrada = "<?php echo $r->descricaoInsumo?>" qtdEntrada = "<?php echo $r->quantidade?>" class="excluir">
...
<div id="abrirpedido" style="display:none">
    <a href="#modal-imprimiritem" style="margin-right: 1%" role="button" data-toggle="modal" title="Imprimir Parcial"><font color="blue"><i class="icon-print icon-white">Imprimir</i></font></a>
    <div class="widget-box">
        <div class="widget-title">
            <span class="icon">
                <i class="icon-user"></i>
    ...
    <div id="modal-editar_1" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
        ...
        <div class="modal-body">
            ...
            <input id="idPedidoCompra4" type="hidden" name="idPedidoCompra4"
                value="" />
...
<div id="modal-editarpedidocompraitens" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    ...
    <div class="modal-body">
        ...
        Enviar item para o pedido de compra número: <input type="text" id="idPedidoCompra_n2" name="idPedidoCompra_n2"
...
<div id="modal-editarquantidade" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    aria-hidden="true">
...
<div id="modal-entradaTodos" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    aria-hidden="true">
    <!--<form action="<?php echo base_url() ?>index.php/suprimentos/alterarItens" method="post">-->
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
    ...
    <div class="modal-footer">
        <a class="btn" data-dismiss="modal" aria-hidden="true">Cancelar</a>
        <a class="btn btn-danger" name="btnGerar" value = "btnGerar" onclick="modelEntradaB()">Confirmar</a>
    </div>
    <!--</form>-->
</div>

<div id="modal-entradaSelecionados" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    aria-hidden="true">
    <!--<form action="<?php echo base_url() ?>index.php/suprimentos/alterarItens" method="post">-->
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
    ...
    <div class="modal-footer">
        <a class="btn" data-dismiss="modal" aria-hidden="true">Cancelar</a>
        <a  class="btn btn-danger" name="btnGerar" value = "btnGerar" onclick="modelEntradaB(1)">Confirmar</a>
    </div>
    <!--</form>-->
</div>

<div id="modal-cancelarEntrada" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    aria-hidden="true">
    <!--<form action="<?php echo base_url() ?>index.php/suprimentos/alterarItens" method="post">-->
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
...
<script type="text/javascript">
    ...
    function inserirItensTabela(){
        ...
        if(typeof idProdutos != "UNDEFINED" && idProdutos != null && idProdutos != "" && typeof prod != "UNDEFINED" && prod != null && prod != "" && typeof prod != "UNDEFINED" && qtd != null && qtd != "" && typeof idEmpresa != "UNDEFINED" && idEmpresa != null && idEmpresa != ""){
            ...
            newCell.innerHTML = pn.split("|")[0]+"<input value='"+idProdutos+"' name='idProdutoTD_' id='idProdutoTD_' type='hidden'/><input value='"+dimensoes+"' name='idDimensoesTD_' id='idDimensoesTD_' type='hidden'/>";
    ...
    function cadastrarItensOS(){
        ...
        for(var x=0;x<idProdutoTD_.length;x++){
            ...
            obj={
                'idProdutoTD':idProdutoTD_[x].value,
                'idDimensoesTD':idDimensoesTD_[x].value,
                'osTD':osTD_[x].value,
                'obsTD':obsTD_[x].value,
                'qtdTD':qtdTD_[x].value
        }
    ...
    function tabelaEditarPedido(suprimentos){
        ...
        for(x=0;x<suprimentos.length;x++){
            ...
            html = "";
            if(suprimentos[x].dimensoes){
                html = suprimentos[x].dimensoes
            }
            if(suprimentos[x].comprimento){
                html = suprimentos[x].comprimento+" cm"
            }
            if(suprimentos[x].volume){
                html = suprimentos[x].volume+" ml"
            }
            if(suprimentos[x].peso){
                html = '<b id="b'+suprimentos[x].idDistribuir+'">'+suprimentos[x].peso+' g </b><a href="#modal-editar_dimensoes'+suprimentos[x].idDistribuir+'" style="margin-right: 1%" role="button" data-toggle="modal"'+
                            'id_disti1="" title="Alterar Unidade">'+
                            '<font color="red"><i class="icon-pencil icon-white"></i></font>'+
                            '</a>';
            }
            if(suprimentos[x].dimensoesL){
                html = "Larg.: "+suprimentos[x].dimensoesL+" mm"
            }
            if(suprimentos[x].dimensoesC){
                html = "Comp.: "+suprimentos[x].dimensoesC+" mm"
            }
            if(suprimentos[x].dimensoesA){
                html = "Alt.: "+suprimentos[x].dimensoesA+" mm"
            }
            newCell = newRow.insertCell(2);
            newCell.innerHTML = '<font size="1">'+suprimentos[x].descricaoInsumo+" "+html+' </font>';
    ...
    function modelEditarPedido(suprimentos){
        ...
        for(x=0;x<suprimentos.length;x++){
            ...
            html5 = '<div id="modal-editar_dimensoes'+suprimentos[x].idDistribuir+'" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">'+
                '<div class="modal-header">	<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>	<h5 id="myModalLabel">Alterar dimensões</h5> </div>'+
                '<div class="modal-body">';
                    html5 += '<div class="span12" style="margin-left:0px">';
                        html5 += '<div class="span4">'+
                            '<label>Peso</label>'+
                            '<input id="editarPeso'+suprimentos[x].idDistribuir+'" value="'+suprimentos[x].peso+'">'+
                        '</div>';
                    html5 += '</div>';
                    html5 += '</div>';
                '</div>';                
            html5 += '<div class="modal-footer">'+
                        '<a class="btn" data-dismiss="modal" aria-hidden="true">Cancelar</a>'+
						'<a class="btn btn-danger" onclick="editar_dimensoes('+suprimentos[x].idDistribuir+')">Alterar</a>'+
            '</div></div>'; 
        ...
        document.querySelector('#divModels').insertAdjacentHTML('afterbegin',html5);
    ...
    function editar_dimensoes(idDistribuir){
        var editarPeso = document.querySelector("#editarPeso"+idDistribuir).value;
        editarPeso = editarPeso.replaceAll(",",".")
        if(isNaN(editarPeso)){
            alert("O número informado não é válido.");
            return;
        }
        $.ajax({
            url: "<?php echo base_url(); ?>index.php/suprimentos/alterarpeso",
            type: 'POST',
            dataType: 'json',
            data: {
            ...
            success:function(data){
                ...
                $( "#b"+idDistribuir ).empty();
                $( "#b"+idDistribuir ).append(editarPeso+" g ");
            },
            error: function(xhr, textStatus, error) {
                alert("Erro ao alterar o peso. Atualize a pagina e tente novamente");
                console.log(xhr.responseText);
                console.log(xhr.statusText);
                console.log(textStatus);
                console.log(error);
