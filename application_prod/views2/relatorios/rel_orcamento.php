...
?>
 <div class="row-fluid" style="margin-top:0">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab1">
                            ...
                            <div class="span12" id="divCadastrarOs">
                              ...
                              <form class="form-inline" action="<?php echo base_url() ?>index.php/relatorios/rel_orcamento" method="post" name="form1" id="form1">
  ...
  <div class="span12" style="padding: 1%; margin-left: 0">
         ...
         De: <input id="dataInicialcad" class="data" type="text" name="dataInicialcad" value="13/10/2020"/> |  Até:<input id="dataFinalcad" class="data" type="text" name="dataFinalcad" value="<?php echo $data_atual;?>"/>
                                        </div>
										 <div class="span6" class="control-group">
...
$i = 1;
										 ...
										 ?>
										 <td>
    <input type="checkbox" name="clientes_id[]" value="<?php echo $cli->idClientes; ?>"> <?php echo $cli->nomeCliente; ?></td>
   <?php
   if($i % 2)
   {
	   echo "</tr><tr>";
...
$count = 1;				
			...
			if(!empty($os_item))
				{
					$ositem1 = "<u><b> OS:</b>".$os_item[0]->idOs."</u>";
				}
				else
				{
					$ositem1 = '';
				...
				$valor_orc = $valor_orc + $itemo->valor_total;  
				
				$rest = '';
		   $desc_banco.= "<b> ".$count."- </b>".substr($itemo->descricao_item, 0, 60)."(...) ".$ositem1;
							/*$conta = strlen($itemo->descricao_item);
							if($conta > 60)
							{
								$rest = " (...)";
							}*/
           ...
           echo '<td align="right">'.$vencimento .'</td>';
            ...
            echo '<td align="right">'.number_format($valor_orc, 2, ",", ".").'</td>';
