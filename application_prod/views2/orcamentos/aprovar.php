...
Novo Status Orçamento: <select class="form-control" name="idstatusOrcamento">
                        ...
                        <option value="<?php echo $o->idstatusOrcamento; ?>" <?php if($o->idstatusOrcamento == 4){ echo "selected='selected'";}?>><?php echo $o->nome_status_orc; ?></option>
                        <?php } ?>
              ...
              <div class="span12">
				...
				<td><b>Status OS:</b>
				 <select class="form-control" name="idStatusOs">
                        ...
                        <option value="<?php echo $e->idStatusOs; ?>" <?php if($e->idStatusOs == 5) { echo "selected='selected'"; } ?>><?php echo $e->nomeStatusOs; ?></option>
                        <?php } ?>
...
<option value="<?php echo $exec->id_unid_exec; ?>" <?php if($exec->id_unid_exec == 2) { echo "selected='selected'"; } ?>><?php echo $exec->status_execucao; ?></option>
                        <?php } ?>
...
<option value="<?php echo $fat->id_unid_fat; ?>" <?php if($fat->id_unid_fat == 2) { echo "selected='selected'"; } ?>><?php echo $fat->status_faturamento; ?></option>
                        <?php } ?>
...
<option value="<?php echo $ostipo->id_tipo; ?>" <?php if($ostipo->id_tipo == 1) { echo "selected='selected'"; } ?>><?php echo $ostipo->nome_tipo; ?></option>
                        <?php } ?>
                  ...
                  <table class='comBordas' width='100%'>
                      <thead>
                          <tr>
						  <td><input class="checkall" type="checkbox" checked></td>
...
/*if($this->data['os_itens'] == true)
{
	echo $this->data['os_itens']->idOs;
					  ...
					  if($this->data['os_itens'] == false)
					  {
						  ...
						  ?>
					 <input class="checkfilho" name="item[]" type="checkbox"  value="<?php echo $item->idOrcamento_item;?>" checked></td>
					  <?php
					  }
					  else
					  {
...
$(document).ready(function(){
   ...
   $(document).on('click', 'a', function(event) {
	...
	$(".checkall").click(function(){
		$(".checkfilho").not(this).prop("checked", this.checked);
	});
