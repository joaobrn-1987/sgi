...
?>
    ...
    if ($this->permission->checkPermission($this->session->userdata('permissao'), 'reagendarOs') || $this->permission->checkPermission($this->session->userdata('permissao'), 'eDataReproCil') || $this->permission->checkPermission($this->session->userdata('permissao'), 'eDataReproFab') || $this->permission->checkPermission($this->session->userdata('permissao'), 'eDataReproServ') || $this->permission->checkPermission($this->session->userdata('permissao'), 'eDataReproPet')) {
            ...
            <table class="comBordas">
                ...
                <tbody>
                    ...
                    <?php
                        ...
                        echo '</font></td>';
                        echo '</tr>';
                        //$valorip = $r->val_ipi_os / 100 * $r->subtot_os;

                        //$valor = $valor + $r->subtot_os + $valorip - $r->desconto_os;
                        $valor = $valor + $result;
                    }
                    ?>
                    <tr>
                        <td colspan='7' align='right'>
                            <?php 
							if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vvalorOs')) {
								echo "Somatória: " . number_format($valor, 2, ",", "."); 
							}
							?>
                        </td>
                    </tr>
...
<div id="modal-alterarOS" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <form id = 'formConjunto' action="<?php echo base_url() ?>index.php/os/alterarconjuntoos"  enctype="multipart/form-data" method="post" class="form-horizontal">
        ...
        <div style="margin: 15px;">
            <div class="span12">
                <div class="span6">
                    <input type="checkbox" name="alterarOS[]" id="editarDataOS" class='check' value="editarDataOS" <?php if(!$this->permission->checkPermission($this->session->userdata('permissao'), 'reagendarOs')){ echo "disabled";} ?>> &nbsp;Alterar Data O.S.            
            ...
            <div class="span12" style="margin-left:0px">
                <div class="span6">
                    <input type="checkbox" name="alterarOS[]" id="editarDataEntregaOS" class='check' value="editarDataEntregaOS" <?php if(!$this->permission->checkPermission($this->session->userdata('permissao'), 'reagendarOs')){ echo "disabled";} ?>> &nbsp;Alterar Data Entrega O.S.            
                    <div style="border: 1px #6a6a6a57 solid;margin-top:5px; padding: 10px;margin-bottom:25px">
                        Nova data: <input disabled type="text" id="dataEntregaOs" name="dataEntregaOs" value=""  class="data"/>
                    </div>
                </div>
                <div class="span6" >
                    <input type="checkbox" name="alterarOS[]" id="editarStatusOS" class='check' value="editarStatusOS" <?php if(!$this->permission->checkPermission($this->session->userdata('permissao'), 'reagendarOs')){ echo "disabled";} ?>> &nbsp;Alterar Status O.S.            
                    <div style="border: 1px #6a6a6a57 solid;margin-top:5px; padding: 10px;margin-bottom:25px">
            ...
            <div class="span12" style="margin-left:0px">
                <div class="span3">
                    <input type="checkbox" name="alterarOS[]" id="editarUnidExecOS" class='check' value="editarUnidExecOS" <?php if(!$this->permission->checkPermission($this->session->userdata('permissao'), 'reagendarOs')){ echo "disabled";} ?>> &nbsp;Alterar Unid. exec.            
                    <div style="border: 1px #6a6a6a57 solid;margin-top:5px; padding: 10px;margin-bottom:25px">
                ...
                <div class="span3">
                    <input type="checkbox" name="alterarOS[]" id="editarUnidFatOS" class='check' value="editarUnidFatOS" <?php if(!$this->permission->checkPermission($this->session->userdata('permissao'), 'reagendarOs')){ echo "disabled";} ?>> &nbsp;Alterar Unid. fat.            
                    <div style="border: 1px #6a6a6a57 solid;margin-top:5px; padding: 10px;margin-bottom:25px">
                ...
                <div class="span3">
                    <input type="checkbox" name="alterarOS[]" id="editarContratoOS" class='check' value="editarContratoOS" <?php if(!$this->permission->checkPermission($this->session->userdata('permissao'), 'reagendarOs')){ echo "disabled";} ?>> &nbsp;Alterar Contrato            
                    <div style="border: 1px #6a6a6a57 solid;margin-top:5px; padding: 10px;margin-bottom:25px">
                ...
                <div class="span3">
                    <input type="checkbox" name="alterarOS[]" id="editarTipoOS" class='check' value="editarTipoOS" <?php if(!$this->permission->checkPermission($this->session->userdata('permissao'), 'reagendarOs')){ echo "disabled";} ?>> &nbsp;Alterar Tipo.            
                    <div style="border: 1px #6a6a6a57 solid;margin-top:5px; padding: 10px;margin-bottom:25px">
            ...
            <div class="span12" style="margin-left:0px">
                <input type="checkbox" name="alterarOS[]" id="editarAnexoPedidoOS" class='check' value="editarAnexoPedidoOS" <?php if(!$this->permission->checkPermission($this->session->userdata('permissao'), 'reagendarOs')){ echo "disabled";} ?>> &nbsp; Alterar Nº PEDIDO E ANEXO PEDIDO         
                <div style="border: 1px #6a6a6a57 solid;margin-top:5px; padding: 10px;margin-bottom:25px">
                    <label for="obs_controle" class="control-label">Nº Pedido</label>
                    <div class="controls">
