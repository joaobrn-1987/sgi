                        ...
                        <table class="table table-bordered">
                            <tbody>
								...
								<tr>
                                    ...
                                    <td>
                                        <label>
                                            <input <?php if(isset($permissoes['vAlmoxarifado'])){ if($permissoes['vAlmoxarifado'] == '1'){echo 'checked';}}?> name="vAlmoxarifado" class="marcar" type="checkbox" value="1" />
                                    ...
                                    <td>
                                        <label>
                                            <input <?php if(isset($permissoes['aAlmoxarifado'])){ if($permissoes['aAlmoxarifado'] == '1'){echo 'checked';}}?> name="aAlmoxarifado" class="marcar" type="checkbox" value="1" />
                                    ...
                                    <td>
                                        <label>
                                            <input <?php if(isset($permissoes['eAlmoxarifado'])){ if($permissoes['eAlmoxarifado'] == '1'){echo 'checked';}}?> name="eAlmoxarifado" class="marcar" type="checkbox" value="1" />
                                            <span class="lbl"> Editar Almoxarifado</span>
                                        </label>
                                    </td>
                                    <td>
                                        <label>
                                            <input <?php if(isset($permissoes['dAlmoxarifado'])){ if($permissoes['dAlmoxarifado'] == '1'){echo 'checked';}}?> name="dAlmoxarifado" class="marcar" type="checkbox" value="1" />
								...
								<tr>
                                    ...
                                    <td>
                                        <label>
                                            <input <?php if(isset($permissoes['vPedidocompraalmox'])){ if($permissoes['vPedidocompraalmox'] == '1'){echo 'checked';}}?> name="vPedidocompraalmox" class="marcar" type="checkbox" value="1" />
                                    ...
                                    <td>
                                        <label>
                                            <input <?php if(isset($permissoes['aPedidocompraalmox'])){ if($permissoes['aPedidocompraalmox'] == '1'){echo 'checked';}}?> name="aPedidocompraalmox" class="marcar" type="checkbox" value="1" />
                                    ...
                                    <td>
                                        <label>
                                            <input <?php if(isset($permissoes['ePedidocompraalmox'])){ if($permissoes['ePedidocompraalmox'] == '1'){echo 'checked';}}?> name="ePedidocompraalmox" class="marcar" type="checkbox" value="1" />
                                            <span class="lbl"> Editar Almoxarifado P.C.</span>
                                        </label>
                                    </td>
                                    <td>
                                        <label>
                                            <input <?php if(isset($permissoes['dPedidocompraalmox'])){ if($permissoes['dPedidocompraalmox'] == '1'){echo 'checked';}}?> name="dPedidocompraalmox" class="marcar" type="checkbox" value="1" />
                                            <span class="lbl"> Excluir Almoxarifado P.C.</span>
                                        </label>
                                    </td>
                                    <td>
                                        <label>
                                            <input <?php if(isset($permissoes['aPermisaocompras'])){ if($permissoes['aPermisaocompras'] == '1'){echo 'checked';}}?> name="aPermisaocompras" class="marcar" type="checkbox" value="1" />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label>
                                            <input <?php if(isset($permissoes['vGerenciaalmo'])){ if($permissoes['vGerenciaalmo'] == '1'){echo 'checked';}}?> name="vGerenciaalmo" class="marcar" type="checkbox" value="1" />
                                    ...
                                    <td>
                                        <label>
                                            <input <?php if(isset($permissoes['eVale'])){ if($permissoes['eVale'] == '1'){echo 'checked';}}?> name="eVale" class="marcar" type="checkbox" value="1" />
                                    ...
                                    <td>
                                        <label>
                                            <input <?php if(isset($permissoes['ePecamorta'])){ if($permissoes['ePecamorta'] == '1'){echo 'checked';}}?> name="ePecamorta" class="marcar" type="checkbox" value="1" />
                                            <span class="lbl"> Editar Peça Morta</span>
                                        </label>
                                    </td>
                                    <td>
                                        <label>
                                            <input <?php if(isset($permissoes['eLiberarpcp'])){ if($permissoes['eLiberarpcp'] == '1'){echo 'checked';}}?> name="eLiberarpcp" class="marcar" type="checkbox" value="1" />
								 ...
								 <tr>
                                    ...
                                    <td>
                                        <label>
                                            <input <?php if(isset($permissoes['vCotacao'])){ if($permissoes['vCotacao'] == '1'){echo 'checked';}}?> name="vCotacao" class="marcar" type="checkbox" value="1" />
                                    ...
                                    <td>
                                        <label>
                                            <input <?php if(isset($permissoes['aCotacao'])){ if($permissoes['aCotacao'] == '1'){echo 'checked';}}?> name="aCotacao" class="marcar" type="checkbox" value="1" />
                                    ...
                                    <td>
                                        <label>
                                            <input <?php if(isset($permissoes['eCotacao'])){ if($permissoes['eCotacao'] == '1'){echo 'checked';}}?> name="eCotacao" class="marcar" type="checkbox" value="1" />
                                            <span class="lbl"> Editar Cotação</span>
                                        </label>
                                    </td>
                                    <td>
                                        <label>
                                            <input <?php if(isset($permissoes['dCotacao'])){ if($permissoes['dCotacao'] == '1'){echo 'checked';}}?> name="dCotacao" class="marcar" type="checkbox" value="1" />
								 ...
								 <tr>
                                    ...
                                    <td>
                                        <label>
                                            <input <?php if(isset($permissoes['vPedCompra'])){ if($permissoes['vPedCompra'] == '1'){echo 'checked';}}?> name="vPedCompra" class="marcar" type="checkbox"  value="1" />
                                    ...
                                    <td>
                                        <label>
                                            <input <?php if(isset($permissoes['aPedCompra'])){ if($permissoes['aPedCompra'] == '1'){echo 'checked';}}?> name="aPedCompra" class="marcar" type="checkbox" value="1" />
                                    ...
                                    <td>
                                        <label>
                                            <input <?php if(isset($permissoes['ePedCompra'])){ if($permissoes['ePedCompra'] == '1'){echo 'checked';}}?> name="ePedCompra" class="marcar" type="checkbox" value="1" />
                                            <span class="lbl"> Editar Pedido Compra</span>
                                        </label>
                                    </td>
                                    <td>
                                        <label>
                                            <input <?php if(isset($permissoes['dPedCompra'])){ if($permissoes['dPedCompra'] == '1'){echo 'checked';}}?> name="dPedCompra" class="marcar" type="checkbox" value="1" />
                                ...
                                <tr>
                                    <td>
                                        <label>
                                            <input <?php if(isset($permissoes['vAutCompra'])){ if($permissoes['vAutCompra'] == '1'){echo 'checked';}}?> name="vAutCompra" class="marcar" type="checkbox"  value="1" />
                                    ...
                                    <td>
                                        <label>
                                            <input <?php if(isset($permissoes['aAutCompra'])){ if($permissoes['aAutCompra'] == '1'){echo 'checked';}}?> name="aAutCompra" class="marcar" type="checkbox" value="1" />
                                            <span class="lbl"> Adicionar Autorização Compra</span>
                                        </label>
                                    </td>
                                    <td>
                                        <label>
                                            <input <?php if(isset($permissoes['pSolCompra'])){ if($permissoes['pSolCompra'] == '1'){echo 'checked';}}?> name="pSolCompra" class="marcar" type="checkbox" value="1" />
                                ...
                                <td>
                                    <label>
                                        <input <?php if(isset($permissoes['vInsumo'])){ if($permissoes['vInsumo'] == '1'){echo 'checked';}}?> name="vInsumo" class="marcar" type="checkbox" value="1" />
                                ...
                                <td>
                                    <label>
                                        <input <?php if(isset($permissoes['aInsumo'])){ if($permissoes['aInsumo'] == '1'){echo 'checked';}}?> name="aInsumo" class="marcar" type="checkbox" value="1" />
                                ...
                                <td>
                                    <label>
                                        <input <?php if(isset($permissoes['eInsumo'])){ if($permissoes['eInsumo'] == '1'){echo 'checked';}}?> name="eInsumo" class="marcar" type="checkbox" value="1" />
                                ...
                                <td>
                                    <label>
                                        <input <?php if(isset($permissoes['dInsumo'])){ if($permissoes['dInsumo'] == '1'){echo 'checked';}}?> name="dInsumo" class="marcar" type="checkbox" value="1" />
								...
								<tr>
                                    ...
                                    <td>
                                        <label>
                                        <input <?php if(isset($permissoes['vEstoque'])){ if($permissoes['vEstoque'] == '1'){echo 'checked';}}?> name="vEstoque" class="marcar" type="checkbox" value="1" />
                                        <span class="lbl"> Visualizar Estoque</span>
                                    </label>
                                    </td>
									 <td>
                                        <label>
                                        <input <?php if(isset($permissoes['aEstoque'])){ if($permissoes['aEstoque'] == '1'){echo 'checked';}}?> name="aEstoque" class="marcar" type="checkbox" value="1" />
                                        <span class="lbl"> Adicionar Estoque</span>
                                    </label>
                                    </td>
									 <td>
                                        <label>
                                        <input <?php if(isset($permissoes['sEstoque'])){ if($permissoes['sEstoque'] == '1'){echo 'checked';}}?> name="sEstoque" class="marcar" type="checkbox" value="1" />
                                        <span class="lbl"> Saida Estoque</span>
                                    </label>
                                    </td>
									 <td>
                                        <label>
                                        <input <?php if(isset($permissoes['valorEstoque'])){ if($permissoes['valorEstoque'] == '1'){echo 'checked';}}?> name="valorEstoque" class="marcar" type="checkbox" value="1" />
                                ...
                                <td>
                                    <label>
                                        <input <?php if(isset($permissoes['vSubcategoria'])){ if($permissoes['vSubcategoria'] == '1'){echo 'checked';}}?> name="vSubcategoria" class="marcar" type="checkbox" value="1" />
                                ...
                                <td>
                                    <label>
                                        <input <?php if(isset($permissoes['aSubcategoria'])){ if($permissoes['aSubcategoria'] == '1'){echo 'checked';}}?> name="aSubcategoria" class="marcar" type="checkbox" value="1" />
                                ...
                                <td>
                                    <label>
                                        <input <?php if(isset($permissoes['eSubcategoria'])){ if($permissoes['eSubcategoria'] == '1'){echo 'checked';}}?> name="eSubcategoria" class="marcar" type="checkbox" value="1" />
                                ...
                                <td>
                                    <label>
                                        <input <?php if(isset($permissoes['dSubcategoria'])){ if($permissoes['dSubcategoria'] == '1'){echo 'checked';}}?> name="dSubcategoria" class="marcar" type="checkbox" value="1" />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label>
                                            <input <?php if(isset($permissoes['vMaquina'])){ if($permissoes['vMaquina'] == '1'){echo 'checked';}}?> name="vMaquina" class="marcar" type="checkbox" value="1" />
                                    ...
                                    <td>
                                        <label>
                                            <input <?php if(isset($permissoes['aMaquina'])){ if($permissoes['aMaquina'] == '1'){echo 'checked';}}?> name="aMaquina" class="marcar" type="checkbox" value="1" />
                                    ...
                                    <td>
                                        <label>
                                            <input <?php if(isset($permissoes['eMaquina'])){ if($permissoes['eMaquina'] == '1'){echo 'checked';}}?> name="eMaquina" class="marcar" type="checkbox" value="1" />
                                    ...
                                    <td>
                                        <label>
                                            <input <?php if(isset($permissoes['dMaquina'])){ if($permissoes['dMaquina'] == '1'){echo 'checked';}}?> name="dMaquina" class="marcar" type="checkbox" value="1" />
                                ...
                                <tr><td colspan="4"></td></tr>
								 ...
								 <tr>
                                    ...
                                    <td>
                                        <label>
                                            <input <?php if(isset($permissoes['vMaquinausuario'])){ if($permissoes['vMaquinausuario'] == '1'){echo 'checked';}}?> name="vMaquinausuario" class="marcar" type="checkbox" value="1" />
                                    ...
                                    <td>
                                        <label>
                                            <input <?php if(isset($permissoes['aMaquinausuario'])){ if($permissoes['aMaquinausuario'] == '1'){echo 'checked';}}?> name="aMaquinausuario" class="marcar" type="checkbox" value="1" />
                                    ...
                                    <td>
                                        <label>
                                            <input <?php if(isset($permissoes['eMaquinausuario'])){ if($permissoes['eMaquinausuario'] == '1'){echo 'checked';}}?> name="eMaquinausuario" class="marcar" type="checkbox" value="1" />
                                    ...
                                    <td>
                                        <label>
                                            <input <?php if(isset($permissoes['dMaquinausuario'])){ if($permissoes['dMaquinausuario'] == '1'){echo 'checked';}}?> name="dMaquinausuario" class="marcar" type="checkbox" value="1" />
								...
								<tr>
								 <td>
                                        <label>
                                            <input <?php if(isset($permissoes['eHoramaquinas'])){ if($permissoes['eHoramaquinas'] == '1'){echo 'checked';}}?> name="eHoramaquinas" class="marcar" type="checkbox" value="1" />
								...
								<tr>
                                    ...
                                    <td>
									 <label>
                                            <input <?php if(isset($permissoes['vvalorOs'])){ if($permissoes['vvalorOs'] == '1'){echo 'checked';}}?> name="vvalorOs" class="marcar" type="checkbox" value="1" />
                                    ...
                                    <td>
                                        <label>
                                            <input <?php if(isset($permissoes['vpedidoOs'])){ if($permissoes['vpedidoOs'] == '1'){echo 'checked';}}?> name="vpedidoOs" class="marcar" type="checkbox" value="1" />
                                    ...
                                    <td>
                                        <label>
                                            <input <?php if(isset($permissoes['apedidoOs'])){ if($permissoes['apedidoOs'] == '1'){echo 'checked';}}?> name="apedidoOs" class="marcar" type="checkbox" value="1" />
								...
								<tr>
                                    <td>
                                        <label>
                                            <input <?php if(isset($permissoes['vdesenhoOs'])){ if($permissoes['vdesenhoOs'] == '1'){echo 'checked';}}?> name="vdesenhoOs" class="marcar" type="checkbox" value="1" />
                                            <span class="lbl"> Visualizar Desenho</span>
                                        </label>
                                    </td>
                                    <td>
                                        <label>
                                            <input <?php if(isset($permissoes['adesenhoOs'])){ if($permissoes['adesenhoOs'] == '1'){echo 'checked';}}?> name="adesenhoOs" class="marcar" type="checkbox" checked="checked" value="1" />
                                    ...
                                    <td>
                                        <label>
                                            <input <?php if(isset($permissoes['vnotafiscalOs'])){ if($permissoes['vnotafiscalOs'] == '1'){echo 'checked';}}?> name="vnotafiscalOs" class="marcar" type="checkbox" value="1" />
                                    ...
                                    <td>
                                        <label>
                                            <input <?php if(isset($permissoes['anotafiscalOs'])){ if($permissoes['anotafiscalOs'] == '1'){echo 'checked';}}?> name="anotafiscalOs" class="marcar" type="checkbox" value="1" />
								...
								<tr>
                                    ...
                                    <td>
                                        <label>
                                            <input <?php if(isset($permissoes['vobscontroleOS'])){ if($permissoes['vobscontroleOS'] == '1'){echo 'checked';}}?> name="vobscontroleOS" class="marcar" type="checkbox" checked="checked" value="1" />
                                    ...
                                    <td>
                                        <label>
                                            <input <?php if(isset($permissoes['eobscontroleOS'])){ if($permissoes['eobscontroleOS'] == '1'){echo 'checked';}}?> name="eobscontroleOS" class="marcar" type="checkbox" value="1" />
                                            <span class="lbl"> Ediar OBS Controle</span>
                                        </label>
                                    </td>
									 <td>
                                        <label>
                                            <input <?php if(isset($permissoes['eDistribuirOs'])){ if($permissoes['eDistribuirOs'] == '1'){echo 'checked';}}?> name="eDistribuirOs" class="marcar" type="checkbox" value="1" />
                                            <span class="lbl">Inserir/Editar Distribuir OS</span>
                                        </label>
                                    </td>
                                    <td>
                                        <label>
                                            <input <?php if(isset($permissoes['vVerificacaocontroleOS'])){ if($permissoes['vVerificacaocontroleOS'] == '1'){echo 'checked';}}?> name="vVerificacaocontroleOS" class="marcar" type="checkbox" value="1" />
                                            <span class="lbl"> Visualizar Verificação Controle</span>
                                        </label>
                                    </td>
									 <td>
                                        <label>
                                            <input <?php if(isset($permissoes['eErificacaocontroleOS'])){ if($permissoes['eErificacaocontroleOS'] == '1'){echo 'checked';}}?> name="eErificacaocontroleOS" class="marcar" type="checkbox" value="1" />
                                ...
                                <tr>
                                    ...
                                    <td>
									 ...
									 <td>
                                        <label>
                                            <input <?php if(isset($permissoes['APOrcamento'])){ if($permissoes['APOrcamento'] == '1'){echo 'checked';}}?> name="APOrcamento" class="marcar" type="checkbox" value="1" />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label>
                                            <input <?php if(isset($permissoes['vAnexo'])){ if($permissoes['vAnexo'] == '1'){echo 'checked';}}?> name="vAnexo" class="marcar" type="checkbox" value="1" />
                                    ...
                                    <td>
                                        <label>
                                            <input <?php if(isset($permissoes['aAnexo'])){ if($permissoes['aAnexo'] == '1'){echo 'checked';}}?> name="aAnexo" class="marcar" type="checkbox" value="1" />
                                    ...
                                    <td>
                                        <label>
                                            <input <?php if(isset($permissoes['eAnexo'])){ if($permissoes['eAnexo'] == '1'){echo 'checked';}}?> name="eAnexo" class="marcar" type="checkbox" value="1" />
                                    ...
                                    <td>
                                        <label>
                                            <input <?php if(isset($permissoes['dAnexo'])){ if($permissoes['dAnexo'] == '1'){echo 'checked';}}?> name="dAnexo" class="marcar" type="checkbox" value="1" />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label>
                                            <input <?php if(isset($permissoes['vApontamento'])){ if($permissoes['vApontamento'] == '1'){echo 'checked';}}?> name="vApontamento" class="marcar" type="checkbox" value="1" />
                                    ...
                                    <td>
                                        <label>
                                            <input <?php if(isset($permissoes['aApontamento'])){ if($permissoes['aApontamento'] == '1'){echo 'checked';}}?> name="aApontamento" class="marcar" type="checkbox" value="1" />
                                    ...
                                    <td>
                                        <label>
                                            <input <?php if(isset($permissoes['eApontamento'])){ if($permissoes['eApontamento'] == '1'){echo 'checked';}}?> name="eApontamento" class="marcar" type="checkbox" value="1" />
                                    ...
                                    <td>
                                        <label>
                                            <input <?php if(isset($permissoes['dApontamento'])){ if($permissoes['dApontamento'] == '1'){echo 'checked';}}?> name="dApontamento" class="marcar" type="checkbox" value="1" />
                                ...
                                <tr>
                                    <td>
                                        <label>
                                            <input <?php if(isset($permissoes['vPeritagem'])){ if($permissoes['vPeritagem'] == '1'){echo 'checked';}}?> name="vPeritagem" class="marcar" type="checkbox" value="1" />
                                            <span class="lbl">Visualizar Peritagem</span>
                                        </label>
                                    </td>
                                    <td>
                                        <label>
                                            <input <?php if(isset($permissoes['aPeritagem'])){ if($permissoes['aPeritagem'] == '1'){echo 'checked';}}?> name="aPeritagem" class="marcar" type="checkbox" value="1" />
                                            <span class="lbl">Adicionar Peritagem</span>
                                        </label>
                                    </td>
                                    <td>
                                        <label>
                                            <input <?php if(isset($permissoes['ePeritagem'])){ if($permissoes['ePeritagem'] == '1'){echo 'checked';}}?> name="ePeritagem" class="marcar" type="checkbox" value="1" />
                                            <span class="lbl">Editar Peritagem</span>
                                        </label>
                                    </td>
                                    <td>
                                        <label>
                                            <input <?php if(isset($permissoes['cPeritagem'])){ if($permissoes['cPeritagem'] == '1'){echo 'checked';}}?> name="cPeritagem" class="marcar" type="checkbox" value="1" />
                                ...
                                <tr>
                                    <td>
                                        <label>
                                            <input <?php if(isset($permissoes['peritagemCil'])){ if($permissoes['peritagemCil'] == '1'){echo 'checked';}}?> name="peritagemCil" class="marcar" type="checkbox" value="1" />
                                            <span class="lbl">Peritagem de Cilindros</span>
                                        </label>
                                    </td>
                                    <td>
                                        <label>
                                            <input <?php if(isset($permissoes['peritagemMaq'])){ if($permissoes['peritagemMaq'] == '1'){echo 'checked';}}?> name="peritagemMaq" class="marcar" type="checkbox" value="1" />
                                            <span class="lbl">Peritagem de Máquinas</span>
                                        </label>
                                    </td>
                                    <td>
                                        <label>
                                            <input <?php if(isset($permissoes['peritagemSub'])){ if($permissoes['peritagemSub'] == '1'){echo 'checked';}}?> name="peritagemSub" class="marcar" type="checkbox" value="1" />
                                ...
                                <tr>
                                    ...
                                    <td>
									 ...
									 <td>
                                        <label>
                                            <input <?php if(isset($permissoes['rOrdemcompra'])){ if($permissoes['rOrdemcompra'] == '1'){echo 'checked';}}?> name="rOrdemcompra" class="marcar" type="checkbox" value="1" />
                                ...
                                <tr>
                                    <td>
                                        <label>
                                            <input <?php if(isset($permissoes['clientes'])){ if($permissoes['clientes'] == '1'){echo 'checked';}}?> name="clientes" class="marcar" type="checkbox" value="1" />
