                            ...
                            <table class="table table-bordered">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <label>
                                                <input name="eDataReproCil" class="marcar" type="checkbox" value="1" />
                                        ...
                                        <td>
                                            <label>
                                                <input name="eDataReproServ" class="marcar" type="checkbox" value="1" />
                                                <span class="lbl"> Reagendar OS - Serviço</span>
                                            </label>
                                        </td>
                                        <td>
                                            <label>
                                                <input name="eDataReproFab" class="marcar" type="checkbox" value="1" />
                                                <span class="lbl"> Reagendar OS - Fabricação</span>
                                            </label>
                                        </td>
                                        <td>
                                            <label>
                                                <input name="eDataReproPet" class="marcar" type="checkbox" value="1" />
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <label>
                                                ...
                                                <span class="lbl">Peritagem Máquinas</span>
                                            </label>
                                        </td>
                                        <td>
                                            <label>
                                                <input name="peritagemSub" class="marcar" type="checkbox" value="1" />
                                                <span class="lbl">Peritagem Peças</span>
                                            </label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <label>
                                                <input name="vBacklog" class="marcar" type="checkbox" value="1" />
                                                <span class="lbl">Visualizar Backlog</span>
                                            </label>
                                        </td>
                                        <td>
                                            <label>
                                                <input name="aBacklog" class="marcar" type="checkbox" value="1" />
