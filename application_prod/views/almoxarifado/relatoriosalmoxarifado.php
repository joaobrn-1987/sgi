                    ...
                    <div class="span12" style="padding: 1%; margin-left: 0">    
                      ...
                      <div class="span2" class="control-group">
                        ...
                        <select class="span12 form-control" name="idEmpresae" id="idEmpresae" 'onchange="alterarLocal2e(this.value)">
                          ...
                          ?>
                            <option value="<?php echo $r->id ?>"><?php echo $r->nomeExibicao ?> </option>
                          <?php
                          }?>
                ...
                if(isset($dados_saida)){
                  foreach($dados_saida as $saida){
                    ...
                    <tr>
                      ...
                      <td><?php echo $saida->nomeExibicao." | Local: ".$saida->local?></td>
                      <td><?php echo $saida->descricaoDepartamento?></td>
                      <td><?php echo $saida->destinoNomeExibicao?></td>
              ...
              <tbody>
                ...
                if(isset($dados_entrada)){
                  foreach($dados_entrada as $entrada){
                    ...
                    <td><?php echo $entrada->nomeExibicao?></td> 
...
<script type="text/javascript">
    ...
    function preencherTabelaEstoqueGeral(resultado){
      ...
      for(y=0;y<resultado.length;y++){
        ...
        if(resultado[x].valor_unit_medio == null){
          ...
          newCell.innerHTML = "R$ "+Number(resultado[x].valor_unit_medio).toFixed(3).replace(".",",");
        }   
        ...
        if(resultado[x].valor_total_entrada == null){
          ...
          newCell.innerHTML = "R$ "+Number(resultado[x].valor_total_entrada).toFixed(3).replace(".",",");
        }
        ...
        if(resultado[x].valor_total_saida == null){
          ...
          newCell.innerHTML = "R$ "+Number(resultado[x].valor_total_saida).toFixed(3).replace(".",",");
        }
        ...
        if(resultado[x].valor_total == null){
          ...
          newCell.innerHTML = "R$ "+Number(resultado[x].valor_total).toFixed(3).replace(".",",");
        }
    ...
    function preencherTabelaEntradas(resultado){
      ...
      for(y=0;y<resultado.length;y++){
        ...
        newCell = newRow.insertCell(5);          
        newCell.innerHTML =resultado[y].nomeExibicao
    ...
    function preencherTabelaSaida(resultado){
        ...
        for(y=0;y<resultado.length;y++){
            ...
            if(resultado[y].local == null){
                ...
                newCell.innerHTML =resultado[y].nomeExibicao+" | Local: "+resultado[y].local;
            } 
            ...
            newCell = newRow.insertCell(6);   
            newCell.innerHTML = resultado[y].destinoNomeExibicao;
