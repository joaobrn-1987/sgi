                                ...
                                <form class="form-inline" action="<?php echo base_url() ?>index.php/suprimentos"
                                    ...
                                    <div class="span12" style="padding: 1%; margin-left: 0">
                                        ...
                                        <div class="span2" class="control-group">
                                            ...
                                            <input class="form-control" type="text" name="idPedidoCompra" value=""
                                        ...
                                        <div class="span2" class="control-group">
                                            ...
                                            <input class="form-control" type="text" name="nf_fornecedor" value=""
                                                class="span12">
                                        ...
                                        <div class="span2" class="control-group">
                                                ...
                                                <input class="form-control" type="text" name="idOs" value=""
                                                class="span12">
                                    ...
                                    <div class="span12" style="padding: 1%; margin-left: 0">
                                            ...
                                            <div class="span2" class="control-group">
                                                <label for="numPedido" class="control-label">N° Pedido</label><br>
                                                <input class="form-control" type="text" name="numPedido" value=""
                                                class="span12">
                                            ...
                                            <div class="span5" class="control-group">
                                                <a href="#" onClick="document.getElementById('form1').submit();" sty><i class="icon-search" style="font-size:30px; float: right; margin-right:50%"></i></a>
...
<div class="widget-box">
 ...
 <form action="<?php echo base_url() ?>index.php/cotacao/imprimir_cotacao2" method="get" target="_blank">                
        <div>Emitente:
