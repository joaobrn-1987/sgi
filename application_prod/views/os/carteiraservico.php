...
?>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tab1">
                                ...
                                <div class="span12" id="divCadastrarOs">
                                    ...
                                    <form class="form-inline" action="<?php echo base_url() ?>index.php/os/carteiraservico" method="post" name="form1" id="form1">
	...
	Empresa: <?php echo $results[0]->nome; ?>
                ...
                <tr>
                    ...
                    <td align='center' ><b>Data Rep.</b></td> -->
                    <td align='center' ><b>Data Rep.</b></td> 
                ...
                foreach ($results as $r) {
                    ...
                    echo '<td align="right">' . $r->qtd_os . '</td>';
                    $rest = '';
                    ...
                    if($r->data_reagendada == ""){
                        ...
                        echo '<td align="center">' . date("d/m/Y", strtotime($r->data_reagendada)) . '</td>';
                    }
                    ...
                    if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vVerificacaocontroleOS')) {
                        $control = "";
                        if($r->idVerificacaoControle == 1){
                            $control = "NÃO";
                        }else if($r->idVerificacaoControle == 2){
                            $control = "SIM";
                        } else if($r->idVerificacaoControle == 3){
                            $control = "SEM CONFORM.";
                        }else{
                            $control = $r->descricaoControle;
                        }
	...
	Empresa: <?php echo $results[0]->nome; ?>
                ...
                <tr>
                    ...
                    <td align='center' style="font-size: 11px;"><b>NF Cli.</b></td>
                    ...
                    <td align='center' style="font-size: 11px;"><b>Data Rep.</b></td>
                ...
                foreach ($results as $r) {
                    ...
                    if($this->session->userdata('permissao') == 1){
                        $rest1 = '';
                        $desc_banco1 = substr($r->nomeCliente, 0, 32);
                        //$desc_banco1 = $r->nomeCliente;/**/
                        $conta1 = strlen($r->nomeCliente);
                        if ($conta1 > 32) {
                            $rest1 = " (...)";
                    ...
                    echo '<td align="center">' . date("d/m/Y", strtotime($r->data_abertura)) . '</td>';
                    if($r->nf_cliente == '' || $r->nf_cliente == null){
                        echo '<td style="width:100px">'. $r->nf_cliente .'</td>';
                    }else{
                        echo '<td>'. $r->nomeArquivo .'</td>';
                    }
                    echo '<td align="right">' . $r->qtd_os . '</td>';
