            ...
            <div class="widget-content nopadding">
                ...
                <form action="<?php echo current_url(); ?>" id="formInsumo" method="post" class="form-horizontal" >
                    <div class="control-group">
                        ...
                        <label for="nomeInsumo" class="control-label">Nome<span class="required">*</span></label>
                        <div class="controls">
                            <input id="nomeInsumo" type="text" name="nomeInsumo" value="<?php echo $result->nomeInsumo; ?>"  />
                        </div>
                    </div>
                    <div class="control-group">
...
<script type="text/javascript">
      $(document).ready(function(){
           $('#formInsumo').validate({
            ...
            messages:{
                  nomeInsumo :{ required: 'Campo Requerido.'},
