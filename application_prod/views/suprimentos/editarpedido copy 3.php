...
<body onLoad="calculaSubTotal();">
        ...
        <div>
            ...
            <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <th>Valor Unit.</th>
                        <th width='40'>IPI% <a href="#modal-ipi" style="margin-right: 1%" role="button"
                                data-toggle="modal" title="Editar IPI">
                                <font color='red'><i class="icon-pencil icon-white"></i></font>
                            </a></th>
                ...
                foreach ($results as $r) {
                 ...
                 ?>
                    ...
                    <tr style="color:<?php echo $color;?>" class="table-bordered">
                        ...
                        <input id="idDistribuir" type="hidden" name="idDistribuir[]"
                            value="<?php echo $r->idDistribuir;?>" />
                                ...
                                <?php foreach ($dados_statuscompra as $so) { ?>
                                    ...
                                    ?>
                                            <?php if($r->idStatuscompras == 6 && $so->idStatuscompras >= 3){ ?>
                                                <option value="<?php echo $so->idStatuscompras; ?>" <?php if($so->idStatuscompras == $r->idStatuscompras ){ echo "selected='selected'";}?>>
                        ...
                        <td><input class="span8" onclick="this.select();" type="text" style="font-size: 10px;"
                                name="qtdrecebida[]" value="<?php if($r->qtdrecebida){echo $r->qtdrecebida;}else{echo $r->quantidade;} ?>"></td>
            ...
            <div class="modal-body">
                ...
                foreach ($results as $rsi) {
			     ...
			     ?>
                    ...
                    value="<?php echo $rsi->idPedidoCompra; ?>" />
                 <?php
		        }
		        ?>
	...
	foreach ($results as $r) {
	 ...
	 ?>
		<div id="modal-fornec-emitente<?php echo $r->idPedidoCompra.$r->previsao_entrega; ?>" class="modal hide fade"
			tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			...
			<div class="modal-body">
				...
				<form action="<?php echo base_url() ?>index.php/suprimentos/editarpedidocompra" method="post">
					<div style="size:20px">
                        <?php
                        foreach ($results as $rs) {
                        ?>
                        ...
                        {
                            ?>
                            <input id="emitente" onclick="this.select();" class="span12 controls emitente"
                                type="text" name="emitente"
                                value="<?php echo $r->nome; ?>" size='50' />
                            <input id="emitente_id" type="hidden" name="emitente_id" class="emitente_id"
                                value="<?php echo $r->idEmitente; ?>" />
                        ...
                        else
                        {
                            ...
                            <input id="emitente" class="span12 emitente controls" type="text"
                        ...
                        {
                        ?>
                            <input id="fornecedor" onclick="this.select();" class="span12 controls fornecedor"
                                type="text" name="fornecedor"
                                value="<?php echo $r->nomeFornecedor; ?>" size='50' />
                            <input id="fornecedor_id" type="hidden" name="fornecedor_id" class="fornecedor_id"
                                value="<?php echo $r->idFornecedores; ?>" />
                        ...
                        else
                        {
                            ...
                            <input id="fornecedor" class="span12 fornecedor controls" type="text"
                                name="fornecedor" value="" size='50' />
                            <input id="fornecedor_id" type="hidden" name="fornecedor_id" value="" class="fornecedor_id"/>
                    ...
                    <table>
                        <tr>
                            <td> <input id="idPedidoCompraipi" type="hidden" name="idPedidoCompraipi"
                                    value="<?php echo $results[0]->idPedidoCompra; ?>" />
                                Previsão de entrega:<input size='6' id="previsao_entrega" class=" data" type="text"
                                    name="previsao_entrega" value="<?php if(!empty($r->previsao_entrega)) { echo date("d/m/Y", strtotime($r->previsao_entrega));}; ?>" />

                            </td>
                            <td>Prazo de entrega:<input size='3' class="span8 form-control" type="text" name="prazo_entrega"
                                    value="<?php echo $r->prazo_entrega; ?>">dias</td>
                            <td>Pagamento:
                                <select class=" recebe-solici" class=" controls" name="idCondPgto" id="idCondPgto">
                                    <option value="" selected='selected'></option>
                                    <?php 
                        ...
                        <tr>
                            <td colspan='4'>
                                ICMS:
                                <input class=" form-control" size='7' onKeyPress="FormataValor2(this,event,10,2);"
                                    type="text" name="icmsit" id="icmsit<?php echo $contadorOS;?>" value="<?php echo number_format($r->icms, 2, ",", ".") ;  ?>">
                                    Frete:
                                <input class=" form-control" size='7' onKeyPress="FormataValor2(this,event,10,2);"
                                    type="text" name="freteit" id="freteit<?php echo $contadorOS;?>" value="<?php echo number_format($r->frete, 2, ",", ".") ;  ?>">
                                    Desconto:
                                <input class=" form-control" size='7' onKeyPress="FormataValor2(this,event,10,2);"
                                    type="text" name="descontoit" id="descontoit<?php echo $contadorOS;?>" value="<?php echo number_format($r->desconto, 2, ",", ".") ; ?>">
                                    Outros:
                        ...
                        <tr>
                            <td colspan='6'>OBS:
                                <textarea id="obs" rows="5" cols="100" class="" name="obs"><?php echo nl2br($r->obscompras); ?></textarea>
                            </td>
                        </tr>
                    </table>
