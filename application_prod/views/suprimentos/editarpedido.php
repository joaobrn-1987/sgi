...
?>
                ...
                <form action="<?php echo base_url() ?>index.php/suprimentos/salvaritemcompra" method="post">
                    ...
                    <table class="table table-bordered">
                        ...
                        foreach ($results as $r) {
                            ...
                            $listaPedidoCompraItens = $r->idPedidoCompraItens.",".$listaPedidoCompraItens;
                            $listaDistribuir = $r->idDistribuir.",".$listaDistribuir;
                        ?>
                            <?php
                            ...
                            <tr style="color:<?php echo $color; ?>" class="table-bordered">
                                                    ...
                                                    if($r->etapa <= 3 && ($r->autorizadoCompra == 0 || $r->aprovacaoPCP == 0 || $r->aprovacaoSUP == 0 || $r->aprovacaoDir == 0)){
                                                        if($so->etapa<=3 && $so->etapa!= 0){
                                                            ?>
                                                                <option value="<?php echo $so->idStatuscompras; ?>" <?php if ($so->idStatuscompras == $r->idStatuscompras) {
                                                                                                                        echo "selected='selected'";
                                                                                                                    }else if($r->etapa==3 && $so->etapa==3){ echo "disabled";} ?>>
                                                                    <?php echo $so->nomeStatus; ?>
                                                                </option>
                                                            <?php
                                                        }
                                                    ...
                                                    if($r->etapa <= 3 && ($r->autorizadoCompra == 0 || $r->aprovacaoPCP == 0 || $r->aprovacaoSUP == 0 || $r->aprovacaoDir == 0)){
                                                        if($so->etapa<=3 && $so->etapa!= 0){
                                                            ?>
                                                                <option value="<?php echo $so->idStatuscompras; ?>" <?php if ($so->idStatuscompras == $r->idStatuscompras) {
                                                                                                                        echo "selected='selected'";
                                                                                                                    }elseif($r->etapa==3 && $so->etapa==3){ echo "disabled";} ?>>
                                                                    <?php echo $so->nomeStatus; ?>
                                                                </option>
                                                            <?php
                                                        }
                                ...
                                <td><input class="span12" onclick="this.select();" type="text" style="font-size: 10px;" name="qtdrecebida[]" value="<?php if ($r->qtdrecebida) {
                                                                                                                                                        echo $r->qtdrecebida;
                                                                                                                                                    } else {
                                                                                                                                                        echo $r->quantidade;
                                                                                                                                                    } ?>"></td>
			            ...
			            <input style="font-size: 10px;" class="span12" onclick="this.select();" onKeyPress="FormataValor2(this,event,10,4);" type="text" id="valor_unitario<?php echo $contador; ?>"  name="valor_unitario[]" value="<?php echo number_format($r->valor_unitario, 4, ",", "."); ?>"  onKeyUp="calculaSubTotal(<?php echo $contador; ?>);"> -->
                                    <input <?php if($r->etapa == 3 || ($r->etapa == 4 && $r->idStatuscompras != 5) ){echo 'readonly';} ?> style="font-size: 10px;" class="span12" onclick="this.select();" type="text" onkeypress="alterarStatus(<?php echo $contador; ?>)" id="valor_unitario<?php echo $contador; ?>" name="valor_unitario[]" 'onKeyPress="FormataValor2(this,event,10,3);"
                        ...
                        <td> 
                            <input style="font-size: 10px;" class="span12" onclick="this.select();" type="text"
                                ...
                                name="valor_icms[]" value="<?php echo number_format($r->icms, 2, ",", "."); ?>"
                                >
                            ...
                            <div id="modal-fornec-emitente<?php echo $r->idPedidoCompra . $r->previsao_entrega; ?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                ...
                                <div class="modal-body">
                                    <div style="size:20px">
                                        ...
                                        ?>
                                            <input id="emitente-<?php echo $r->idPedidoCompra . $r->previsao_entrega; ?>" onclick="this.select();" class="span12 controls emitente" type="text" name="emitente" value="<?php echo $r->nome; ?>" size='50' />
                                            <input id="emitente_id-<?php echo $r->idPedidoCompra . $r->previsao_entrega; ?>" type="hidden" name="emitente_id" class="emitente_id" value="<?php echo $r->idEmitente; ?>" />

                                        <?php
                                        } else {
                                        ?>

                                            <input id="emitente-<?php echo $r->idPedidoCompra . $r->previsao_entrega; ?>" class="span12 emitente controls" type="text" name="emitente" value="" size='50' />
                                            <input id="emitente_id-<?php echo $r->idPedidoCompra . $r->previsao_entrega; ?>" type="hidden" name="emitente_id" value="" class="emitente_id" />
                                        <?php
                                        }
                                        ?>
        ...
        <form action="<?php echo base_url() ?>index.php/suprimentos/imprimiritem" method="post">
            ...
            <div class="modal-body">
                ...
                ?>
                    ...
                    <input id="idDistribuir2" type="hidden" name="idDistribuir2[]" value="<?php echo $rsi->idDistribuir; ?>" />
                <?php
                }
                ?>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            console.log("Lista distribuir: <?php echo $listaDistribuir;?>");
            console.log("Lista pedido compra itens: <?php echo $listaPedidoCompraItens;?>");
