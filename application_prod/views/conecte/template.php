...
<html lang="pt-br">
  ...
  <body>
    ...
    <!--Header-part-->
    <div id="header">
      <h1><a href="dashboard.html">SGI</a></h1>
    </div>
    <!--close-Header-part--> 
    ...
    <div id="sidebar"> <a href="#" class="visible-phone"><i class="icon icon-list"></i> Menu</a>
      <ul>
        ...
        <li class="<?php if(isset($menuOrcamentos)){echo 'active';};?>"><a href="<?php echo base_url()?>index.php/conecte/compras"><i class="icon icon-shopping-cart"></i> <span>Compras</span></a></li>
