    ...
    <div class="span12">
        <div class="widget-box">
            ...
            <div class="widget-content nopadding">
                ...
                <form action="<?php echo base_url();?>index.php/desenho/add_pn_existente" id="formProduto1" method="post" class="form-horizontal" enctype="multipart/form-data">
                    
                    <input id="idProdutos" name="idProdutos" type="hidden" value="<?php echo (isset($resultado[0]->idProdutos)? $resultado[0]->idProdutos : ""); ?>">
...
<script type="text/javascript">
    ...
    function confirmaDados(){
        ...
        var idProdutos          = document.getElementById('idProdutos');
        ...
        if(!pn.value || pn.value ==="" || !descricao.value || descricao.value ==="" ||
           ...
           !file_dataDwg.files[0] || !file_dataJpg.files[0]){
            ...
            //INPUTS PARA ENVIO
            form_data.append('idProdutos', idProdutos.value);
    ...
    function enviaPN(botao){
        ...
        $.ajax({
            url: "<?php echo base_url(); ?>index.php/desenho/add_pn_existente",
            dataType: 'json',
            cache: false,
            async: false,
            contentType: false,
            ...
            success: function(data2) {
                if(data2.result == true){
                    ...
                    window.location.href = "<?php echo base_url() . 'index.php/desenho/add_pn_existente';?>";
                }
            },
