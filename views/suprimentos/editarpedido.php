                    ...
                    <table class="table table-bordered">
                                ...
                                <td>
                                    ...
                                    <select style="<?php echo ((empty($anexoImagens3) || count($anexoImagens3)< 2)  && $r->idStatuscompras == 3 && $r->sem_cotacao == 0? "pointer-events:none" : "") ?>" class="recebe-solici" class="controls" style="font-size: 10px;" name="idStatuscompras[]" id="idStatuscompras<?php echo $contador; ?>">
                                        ...
                                        <?php foreach ($dados_statuscompra as $so) { ?>
                                            ...
                                            //var_dump($r->autorizadoCompra." ".$r->aprovacaoPCP." ".$r->aprovacaoSUP." ".$r->aprovacaoDir);
                                            if ($r->idOs <= 19999) {
			            ...
			            <input style="font-size: 10px;" class="span12" onclick="this.select();" onKeyPress="FormataValor2(this,event,10,4);" type="text" id="valor_unitario<?php echo $contador; ?>"  name="valor_unitario[]" value="<?php echo number_format($r->valor_unitario, 4, ",", "."); ?>"  onKeyUp="calculaSubTotal(<?php echo $contador; ?>);"> -->
                                <input <?php if ($r->etapa == 3 || ($r->etapa == 4 && $r->idStatuscompras != 5)) {
                                            echo 'readonly';
                                        } ?> <?php echo ((empty($anexoImagens3) || count($anexoImagens3)< 2)  && $r->idStatuscompras == 3 && $r->sem_cotacao == 0 ? "readonly" : "") ?> style="font-size: 10px;" class="span12" onclick="this.select();" type="text" onkeypress="alterarStatus(<?php echo $contador; ?>)" id="valor_unitario<?php echo $contador; ?>" name="valor_unitario[]" 'onKeyPress="FormataValor2(this,event,10,3);"
                        ...
                        <td style="text-align: center"> 
                            ...
                            <input style="font-size: 10px;" class="span12" onclick="this.select();" type="text"
                                ...
                                name="valor_icms[]" <?php echo ((empty($anexoImagens3) || count($anexoImagens3)< 2)  && $r->idStatuscompras == 3 && $r->sem_cotacao == 0 ? "readonly" : "") ?> value="<?php if ($r->porcentagem) {
                    ...
                    foreach ($results as $r) { ?>
                        ...
                        ?>
                            ...
                            <div id="modal-fornec-emitente<?php echo $r->idPedidoCompra . $r->previsao_entrega; ?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                ...
                                <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                    <h5 id="myModalLabel">Dados Orçamento</h5> <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'ePedCompra')) { ?>
        ...
        if ($anexoImagens2) {
            ...
            foreach ($anexoImagens2 as $anex) {
                ...
                echo '<td><a href="' . base_url() .  $anex->caminho . $anex->imagem . '" style="margin-right: 1%" class="btn tip-top" ><i class="icon-eye-open"></i></a>
                    ...
                    '<td><a onclick="" style="margin-right: 1%" role="button"                                                                         
