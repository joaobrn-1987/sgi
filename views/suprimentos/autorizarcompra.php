...
<div class="tab-content">
    <div class="tab-pane active" id="tab1">
        <form action="<?php echo base_url() ?>index.php/suprimentos/aprovacao/1" method="post" name="form1" id="form1">
                                                    ...
                                                    <?php foreach ($listaPedidos as $r) {
                                                        ...
                                                        $anexoImagens = $this->pedidocompra_model->getAnexoCotacaoSuprimentosByIdPedidoCompra($r->idPedidoCompra);
                                                            echo '<td><a href="#modal-anexo_cotacao'.$r->idPedidoCompra.'" role="button" data-toggle="modal" style="margin-right: 3%" class="btn tip-top"><i class="icon-folder-open" id="i_obs_" style="color:'.($anexoImagens?"green":"grey").'"></i></a>'.
                                                                ...
                                                                '</div>'; 
                                                            '</td>';
                                                        //if ($r->aprovacaoSUP == 0 || empty($r->aprovacaoSUP)) {
                                                        ...
                                                        foreach ($r->itens as $i) {
                                                            ...
                                                            if(!empty($i->dimensoesL)){
                                                                $html .= " L: ".$i->dimensoesL." mm |";
                                                            }
                                                            if(!empty($i->dimensoesC)){
                                                                $html .= " C: ".$i->dimensoesC." mm |";
                                                            }
                                                            if(!empty($i->dimensoesA)){
                                                                $html .= " A: ".$i->dimensoesA." mm";
                                                            }
                                                            echo '<td>' . $html. '</td>';
                ...
                <div class="tab-pane active">
                    <div class="span12" >
                        ...
                        <div class="span12" style="padding: 1%; margin-left: 0">
                            ...
                            <div class="span2" class="control-group">
                                <label for="idGrupoServico" class="control-label">Data de Abertura: </label>
                                <input type="text" class="span12" value="" disabled/>
                            </div>
                            <div class="span2" class="control-group">
                            ...
                            <div class="span2" class="control-group">
                                <label for="idGrupoServico" class="control-label">Data Reagendada: </label>
                                <input type="text" class="span12" value="" disabled/>
                            </div>
                        </div>
                        <div class="span12" style="padding: 1%; margin-left: 0">                                        
...
<script>
    ...
    $("input:checkbox[name=checkPedidoCompraItens]").click(function() {
        ...
        if (soma.value <= 5000) {
            permCompra(this.value, this.checked, soma, 14);
    ...
    $("input:checkbox[name=checkPedidoCompra]").click(function() {
        ...
        if (soma.value <= 5000) {
            arrayItens.forEach((elemento) => {
                ...
                permCompra(elemento.value, this.checked, soma, 14);
            })
            /*
    ...
    function permCompra(idDistribuir, checked, soma, status) {
        $.ajax({
            url: "<?php echo base_url(); ?>index.php/suprimentos/permcompradistribuir",
            type: 'POST',
            dataType: 'json',
            async: false,
            data: {
