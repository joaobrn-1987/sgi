                  ...
                  <table border='1' width='100%' style="border-color: #aaaaab;border-style: solid;">
                    <tr>
                      <td>
                        ...
                        Data Criação: <?php echo $data_insert ?>


                      </td>
                      <td>
                        Data OS: <input size='6' id="data_abertura" class="data" type="text" name="data_abertura" value="<?php if (!empty($result->data_abertura)) {
                      ...
                      ?>
                      <td>
                        Data Reprog.:<input size='6' id="data_reagendada" class="data" onclick="this.select();" type="text" name="data_reagendada" value="<?php if ($result->data_reagendada <> '') {
                      ...
                      <td>
                        Unid. Exec.:<select name="unid_execucao" <?php if (empty($result->unid_execucao)) {
                                                                    echo 'disabled';
                                                                  } ?>>
                      ...
                      <td>
                        Unid. Fat.:<select name="unid_faturamento" <?php if (empty($result->unid_faturamento)) {
                                                                      echo 'disabled';
                                                                    } ?>>
                    ...
                    <tr>
                      ...
                      <td colspan='3'>Status:
                        <select name="idStatusOs" <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'alterarStatusOsPeritagem')) {
                                                    echo 'onchange="alterarStatus(this,' . $result->idOs . ')"';
                                                  } else {
