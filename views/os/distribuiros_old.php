													...
													<td>
														<font color='<?php echo $color; ?>'>
															...
															if (!empty($dist->dimensoesL)) {
																$html .= " Largura: " . $dist->dimensoesL . " mm";
															}
															if (!empty($dist->dimensoesC)) {
																$html .= " Comp.: " . $dist->dimensoesC . " mm";
															}
															if (!empty($dist->dimensoesA)) {
																$html .= " Altura: " . $dist->dimensoesA . " mm";
															}
															echo $html; ?>
													</td>
													</font>
													...
													<form action="<?php echo base_url(); ?>index.php/os/editar_distribuiros" id="formAlterar" enctype="multipart/form-data" method="post" class="form-horizontal">
														<div class="control-group">
															...
															<div class="tamanho<?php echo $dist->idDistribuir; ?>">
																<div class="control-group">
																	Comprimento(cm):
																	<input class="" class="form-control" id="tamanho<?php echo $dist->idDistribuir; ?>" type="text" name="tamanho" value="" />
																</div>
															</div>
															<div class="volume<?php echo $dist->idDistribuir; ?>">
																<div class="control-group">
																	Volume(ml):
																	<input class="" class="form-control" id="volume<?php echo $dist->idDistribuir; ?>" type="text" name="volume" value="" />
																</div>
															</div>
															<div class="peso<?php echo $dist->idDistribuir; ?>">
																<div class="control-group"><br>
																	Peso(g):
																	<input class="" class="form-control" id="peso<?php echo $dist->idDistribuir; ?>" type="text" name="peso" value="" />
																</div>
															</div>
															<div class="dimensoes<?php echo $dist->idDistribuir; ?>">
																<div class="control-group"><br>
																	Dimensões(mm):
																	<div class="">
																		<input class="" class="form-control" id="dimensoesL<?php echo $dist->idDistribuir; ?>" type="text" name="dimensoesL" value="" placeholder='Largura' />
																		<input class="" class="form-control" id="dimensoesC<?php echo $dist->idDistribuir; ?>" type="text" name="dimensoesC" value="" placeholder='Comp.' />
																		<input class="" class="form-control" id="dimensoesA<?php echo $dist->idDistribuir; ?>" type="text" name="dimensoesA" value="" placeholder='Altura' />
																	</div>
...
<div id="modalFinalizar" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<form action="<?php echo base_url(); ?>index.php/os/finalizarpcp" id="formCadastrar" enctype="multipart/form-data" method="post" class="form-horizontal">
		<div class="modal-header">
			<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
...
<div id="modalinserir" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<form action="<?php echo base_url(); ?>index.php/os/cad_distribuir" id="formCadastrar" enctype="multipart/form-data" method="post" class="form-horizontal">
		...
		<div class="modal-body">
			...
			<div class="control-group">
				Quantidade em Estoque:
				<input id="estoque" type="text" name="estoque" value="0" readonly /><br>
				<!--<font red='red' size='1'>*Se a qtd solicitada for maior que o estoque, será gerado 2 itens automaticamente, 1 para solicitar ao estoque outro para solicitar compra</font>-->
