						...
						<table class='comBordas' width='100%'>
							...
							<tbody>
								...
								foreach ($itens_orcamento as $item) {
									...
									$valoripi = $item->val_ipi / 100 * $item->qtd * $item->val_unit;

									$valordesconto = $valordesconto + $item->desconto;
									$valorsub =  $valorsub + ($item->qtd * $item->val_unit)- $item->desconto;
									$valortot = $valortot + $valor_calc + $valoripi + $item->frete;
