        ...
        <form class="form-inline" action="<?php echo base_url() ?>index.php/peritagem/criarperitagemorc" method="post" id="formPeritag">
            ...
            <div class="widget-box">
                <div class="widget-title">
                    ...
                    <span style="padding: 3px 10px 3px 11px;">
                        <select name="idStatusPeritagem" id="idStatusPeritagem">
                            <?php foreach($statusPeritagem as $r){ ?>
                                <option value="<?php echo $r->idStatusPeritagem ?>" <?php if(!empty($orcServicoEscopo)){if($r->idStatusPeritagem == $orcServicoEscopo->idStatusPeritagem){echo "selected";}} ?>><?php echo $r->descricaoPeritagem ?></option>
                            <?php
                            } ?>
                        </select>
                    </span>
