...
<form action="<?php echo current_url(); ?>" id="formOrcamento" method="post" name='form'>
    ...
    <div class="widget-box">
        <div class="widget-title">
            ...
            <h5>Cadastro de Itens </h5> <a href="#" onclick="duplicarCampos();" class="btn btn-success"><i class="icon-plus icon-white"></i> Adicionar Item Orçamento</a>
    ...
    <a href="#" onclick="duplicarCampos();" class="btn btn-success"><i class="icon-plus icon-white"></i> Adicionar Item Orçamento</a>
...
<script type="text/javascript">
    ...
    function duplicarCampos() {
        ...
        cloneDiv = '<tr class="trpai' + contador_local_autocomplete + '">' +
            ...
            '</div>' +
            '<div class="span2" alt="Código de identificação do produto." title="Código de identificação do produto.">' +
            '<label>Tag:</label>' +
            ...
            '<div class="span1">' +
            '<label>QTD:</label>' +
            '<input type="text" class="span12 number" id="qtd_' + contador_local_autocomplete + '" name="qtd[]" onblur="calculaSubTotal(' + contador_local_autocomplete + ');" onclick="this.select();" value="1" />' +
            '</div>' +
            '<div class="span1">' +
            '<label>Vl.Unit.:</label>' +
            '<input type="text" class="span12" id="val_unit_' + contador_local_autocomplete + '" name="val_unit[]" value="0,00" onKeyUp="calculaSubTotal(' + contador_local_autocomplete + ');"   onKeyPress="FormataValor2(this,event,13,2);" onclick="this.select();" /> ' +
            '</div>' +
            '<div class="span2">' +
            '<label>Sub.Tot.:</label>' +
            ...
            '<div class="span1">' +
            '<label>Frete:</label>' +
            '<input type="text" class="span12" id="frete_' + contador_local_autocomplete + '" name="frete[]" value="0,00" onKeyUp="calculaSubTotal(' + contador_local_autocomplete + ');"  onKeyPress="FormataValor2(this,event,13,2);" onclick="this.select();" />' +
            '</div>' +
            '<div class="span2">' +
            '<label>Desconto:</label>' +
            '<input type="text" class="span12" id="desconto_' + contador_local_autocomplete + '" name="desconto[]" value="0,00" onKeyUp="calculaSubTotal(' + contador_local_autocomplete + ');"  onKeyPress="FormataValor2(this,event,13,2);" onclick="this.select();" />' +
            '</div>' +
            '<div class="span1">' +
            '<label>IPI (%):</label>' +
            '<input type="text" class="span12" id="val_ipi_' + contador_local_autocomplete + '" name="val_ipi[]" value="0,00" onKeyUp="calculaSubTotal(' + contador_local_autocomplete + ');"  onKeyPress="FormataValor2(this,event,13,2);" onclick="this.select();" />' +
            '</div>' +
            '<div class="span1">' +
            '<label>IPI (R$):</label>' +
