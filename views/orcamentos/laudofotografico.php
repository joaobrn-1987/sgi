...
<div class="row-fluid" style="margin-top:0">
    <div class="span12">
        <div class="tab-content" style="background-color: white;border: 1px #cdcdcd solid;">
            <form id="formSalvar" action="<?php echo base_url(); ?>index.php/peritagem/salvarlaudocomercial" id="formAlterar" enctype="multipart/form-data" method="post" class="form-horizontal">
                                ...
                                <div style="min-height: 350px">
                                    ...
                                    <div>
                                        <ul class="nav nav-tabs">
                                            <li class="active"><a href="#tab1<?php echo $contador?>" data-toggle="tab">Comercial</a></li>
                                            <li><a href="#tab2<?php echo $contador?>" data-toggle="tab">Peritagem</a></li>
                                        </ul>
                                    </div>
                                    <div class="tab-content">
								        <div class="tab-pane active" id="tab1<?php echo $contador?>">
                                            <div style="margin-top:50px; margin-bottom:15px">
                                                <div class="comentario_<?php echo $contador?>" style="margin-left: 30px;margin-right: 30px; text-align:center">
                                                    ...
                                                    <textarea name="inputComm[]" id="inputComm[]"  style="max-width:95%; width:90%; height: 130px;"><?php echo $r->comentariosExibicao ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="tab-pane" id="tab2<?php echo $contador?>">
                                            <div style="margin-top:50px; margin-bottom:15px">
                                                <div style="margin-left: 30px;margin-right: 30px; text-align:center">
                                                    <div style="text-align:left;margin-left:20px">
                                                        <label>Comentários:</label>
                                                    </div>
                                                    <textarea readonly style="max-width:95%; width:90%; height: 130px;"><?php echo $r->comentarios ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
