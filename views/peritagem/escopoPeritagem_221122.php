                            ...
                            <div class="tab-pane active" id="tab1">
                                <div class="span12" id="divCadastrarOs">
                                    ...
                                    <div style="text-align: center;"><!--
                                        ...
                                        <?php if($this->permission->checkPermission($this->session->userdata('permissao'),'aPeritagem') && $escopo->idStatusPeritagem != 4){ ?>
                                            <a class="btn btn-success" onclick="salvarItens()">Salvar</a>
                                        <?php } ?>
                                        <?php if($this->permission->checkPermission($this->session->userdata('permissao'),'cPeritagem') && $escopo->idStatusPeritagem != 4){ ?>
