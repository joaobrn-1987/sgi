                                                                                        ...
                                                                                        echo '<tr>' .
                                                                                           ...
                                                                                           echo '<td>' . $r->pn . '</td>' .
                                                                                            ...
                                                                                            if($r->tipoCampo == "input" || empty($r->tipoCampo)){
                                                                                                echo '<td></td>';
                                                                                                echo '<td style="width:7%"><input type="text" onblur="salvarEscopoItem('.$r->idOrcServicoEscopoItens.',\'quantidade\',this)" onkeyup="onoffTiposServico('.$r->idOrcServicoEscopoItens.',this)"class="span12 number" '.($escopo->idStatusPeritagem != 2 && $escopo->idStatusPeritagem != 7?"readonly":"").' name="quantidade_'.$d->idOrcamento_item.'[]" value="'. $r->quantidade .'"></td>';
                                                                                                echo '<td style="width:7%"><input type="text" onblur="salvarEscopoItem('.$r->idOrcServicoEscopoItens.',\'dimenExt\',this)" class="span12 number" '.($escopo->idStatusPeritagem != 2 && $escopo->idStatusPeritagem != 7?"readonly":"").' name="dimenExt_'.$d->idOrcamento_item.'[]" value="'. $r->dimenExt .'"></td>';
                                                                                                echo '<td style="width:7%"><input type="text" onblur="salvarEscopoItem('.$r->idOrcServicoEscopoItens.',\'dimenInt\',this)" class="span12 number" '.($escopo->idStatusPeritagem != 2 && $escopo->idStatusPeritagem != 7?"readonly":"").' name="dimenInt_'.$d->idOrcamento_item.'[]" value="'. $r->dimenInt .'"></td>';
                                                                                                echo '<td style="width:7%"><input type="text" onblur="salvarEscopoItem('.$r->idOrcServicoEscopoItens.',\'diminComp\',this)" class="span12 number" '.($escopo->idStatusPeritagem != 2 && $escopo->idStatusPeritagem != 7?"readonly":"").' name="dimenComp_'.$d->idOrcamento_item.'[]" value="'. $r->dimenComp .'"></td>';
                                                                                                //echo '<td style="width:7%"><input type="text" class="span12" '.($escopo->idStatusPeritagem != 2?"readonly":"").' name="obs_'.$d->idOrcamento_item.'[]" value="'. $r->obs .'"></td>';
                                            ...
                                            <tbody>
                                                <?php foreach($orcItem as $r){
                                                    ...
                                                    if($r->tipoOrc == "serv" && (($r->tipoProd == "cil" && 
                                                        ...
                                                        if($escopo->idStatusPeritagem == 4){
                                                            echo '<td><input type="checkbox" '.($escopo->idStatusPeritagem == 4?"checked disabled":"").' value="'.$escopo->idOrcServicoEscopo.'"></td>';
                                                        }else if($escopo->idStatusPeritagem == 2 || $escopo->idStatusPeritagem == 3){
                                        ...
                                        <table id="table_id" class="table table-bordered " id="dadosTlbOsOc">
                                            ...
                                            <tbody>
                                                <?php foreach($orcItem as $r){
                                                    ...
                                                    $this->permission->checkPermission($this->session->userdata('permissao'),'peritagemPec')))){
                                                        $escopo = $this->peritagem_model->getOrcEscopoActiveByOrcItem($r->idOrcamento_item);
                                                        if($escopo->idStatusPeritagem == 4 || $escopo->idStatusPeritagem == 3){
                                                            echo '<td><input type="checkbox" checked disabled value="'.$escopo->idOrcServicoEscopo.'"></td>';
                                                        }else if($escopo->idStatusPeritagem == 2 || $escopo->idStatusPeritagem == 7){
                                                            echo '<td><input type="checkbox" name="idOrcServEscopo[]" value="'.$escopo->idOrcServicoEscopo.'"></td>';
                                                        }else{
                                                            echo '<td></td>';
                                                        }
                                            ...
                                            <tbody>
                                                <?php foreach($orcItem as $r){
                                                    ...
                                                    if($r->tipoOrc == "serv" && (($r->tipoProd == "cil" && 
                                                        ...
                                                        $this->permission->checkPermission($this->session->userdata('permissao'),'peritagemPec')))){
                                                        $escopo = $this->peritagem_model->getOrcEscopoActiveByOrcItem($r->idOrcamento_item);
                                                         if($escopo->idStatusPeritagem == 2 || $escopo->idStatusPeritagem == 3  || $escopo->idStatusPeritagem == 7){
                                                            echo '<td><input type="checkbox"  name="idOrcServEscopo[]" value="'.$escopo->idOrcServicoEscopo.'"></td>';
                                                        }else{
                                                            echo '<td></td>';
                                                        }
