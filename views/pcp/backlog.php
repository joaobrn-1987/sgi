                        ...
                        <div class="tab-pane active">
                            <form action="<?php echo base_url() ?>index.php/pcp/backlog" method="post" name="form1" id="form1">
                                ...
                                <div class="span12" id="divCadastrarOs" style="margin-left: 0">
                                    ...
                                    <div class="span12" style="padding: 1%; margin-left: 0">
                                        <div class="span12" class="control-group">
                                            <label for="idGrupoServico" class="control-label">Usuarios:</label>&nbsp;<input type="checkbox" name="todasUser" id="todasUser" value="USER" onClick="CheckAll2('USER');">&nbsp;Marcar/Desmarcar todos
                                            <table width='100%'>
                                                <tr>
                                                    <?php
                                                    $i = 0;
                                    ...
                                    <table id="tableHistVale" class="table table-bordered ">
                                        ...
                                        <tbody>
                                            <?php foreach ($result as  $r) {
                                                ...
                                                echo '<td>' . $r->pn . '</td>';
                                                echo '<td>' . $r->idOs . '</td>';
                                                echo '<td>' . (!empty($r->entrega_os) ? date("d/m/Y", strtotime($r->entrega_os)) : "") . '</td>';
												echo '<td align="center">' . $r->status_execucao . '</td>';
                                                echo '<td>' . (!empty($r->reagendada_os) ? date("d/m/Y", strtotime($r->reagendada_os)) : "") . '</td>';
                                                ...
                                                echo '<td ><input type="text" class="data" style="width: 100px;" onblur="alterarLimite('.$r->idDistribuir.',this)" value="'.(!empty($r->data_limite) ? date("d/m/Y", strtotime($r->data_limite)) : "").'"></td>';
...
<script type="text/javascript">
    ...
    function CheckAll2(inputCheck) {
        ...
        var user = document.querySelector("#todasUser");
        ...
        if (inputCheck == 'USER') {
            for (var i = 0; i < document.form1.elements.length; i++) {
                var x = document.form1.elements[i];
                if (x.name == 'idUsuarios[]') {
                    x.checked = user.checked;
                }
            }
        } 
        if (inputCheck == 'EXEC') {
