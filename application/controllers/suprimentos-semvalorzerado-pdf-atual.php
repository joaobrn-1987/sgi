...
/*---------fim pegando o idFornecedores ------------------------------------------------------------------------------------------------------------*/		
 ...
 public function aprovacao() {
    ...
    if ($idComprador) {
        $where .= " AND distribuir_os.idUser_aguardandoOrc = " . $idComprador;
        //echo "<pre>DEBUG - Filtro idComprador Adicionado: $where</pre>";
    }

    // Aqui você pode colocar a verificação que deseja para filtrar por status_execucao se o usuário for 99
    /*$idUsuario = $this->session->userdata('id'); // exemplo, ajuste se necessário
    if ($idUsuario == 99) {
        $where .= " AND unidade_execucao.status_execucao = 1";
    }*/
  ...
  public function aprovarpcp(){
        ...
        $this->data['menuPedidoCompra'] = null;
        $this->data['menuPcp'] = "Aprovar";
        if($this->session->userdata('idUsuarios') == 85 ||   $this->session->userdata('idUsuarios') == 87 || $this->session->userdata('idUsuarios') == 98 || $this->session->userdata('idUsuarios') == 6){
            $this->data['comprasSolicitadas'] = $this->pedidocompra_model->getComprasParaAprovarPcp2();	//	3-PETR
        }else if($this->session->userdata('idUsuarios') == 1){
            $this->data['comprasSolicitadas'] = $this->pedidocompra_model->getComprasParaAprovarPcpAdmin(); // todas
        }else if($this->session->userdata('idUsuarios') == 88 || $this->session->userdata('idUsuarios') == 50 || $this->session->userdata('idUsuarios') == 184 || $this->session->userdata('idUsuarios') == 98 || $this->session->userdata('idUsuarios') == 119 || $this->session->userdata('idUsuarios') == 128 || $this->session->userdata('idUsuarios') == 129){
            $this->data['comprasSolicitadas'] = $this->pedidocompra_model->getComprasParaAprovarPcp3(); // 5-PARÃ 	8-MINING 
        }else if($this->session->userdata('idUsuarios') == 57 || $this->session->userdata('idUsuarios') == 11 || $this->session->userdata('idUsuarios') == 48 || $this->session->userdata('idUsuarios') == 241 || $this->session->userdata('idUsuarios') == 107 || $this->session->userdata('idUsuarios') == 57  ){
            $this->data['comprasSolicitadas'] = $this->pedidocompra_model->getComprasParaAprovarPcp4(); // 1 - SERV 6-CESU 
        }else{
            $this->data['comprasSolicitadas'] = $this->pedidocompra_model->getComprasParaAprovarPcp();
        }
        ...
        if(!empty($this->data['comprasSolicitadas'] )){
            for($x = 0; $x < count($this->data['comprasSolicitadas']); $x++){
                if($this->data['comprasSolicitadas'][$x]->idOs == 1 || $this->data['comprasSolicitadas'][$x]->idOs == 2 ||$this->data['comprasSolicitadas'][$x]->idOs == 3 ||$this->data['comprasSolicitadas'][$x]->idOs == 6){
                    if($this->session->userdata('idUsuarios') == 85 || $this->session->userdata('idUsuarios') == 87 || $this->session->userdata('idUsuarios') == 98 || $this->session->userdata('idUsuarios') == 6){
                        $this->data['comprasSolicitadas'][$x]->itens = $this->pedidocompra_model->getItensByIdosLimited2($this->data['comprasSolicitadas'][$x]->idOs); //3-PETR
                    }else if ($this->session->userdata('idUsuarios') == 1){
                    ...
                    }else if($this->session->userdata('idUsuarios') == 88 || $this->session->userdata('idUsuarios') == 184 || $this->session->userdata('idUsuarios') == 50  || $this->session->userdata('idUsuarios') == 119 || $this->session->userdata('idUsuarios') == 128 || $this->session->userdata('idUsuarios') == 129){
                        $this->data['comprasSolicitadas'][$x]->itens = $this->pedidocompra_model->getItensByIdosLimited3($this->data['comprasSolicitadas'][$x]->idOs); // 5 para - 8 mining
                    }else if($this->session->userdata('idUsuarios') == 57 || $this->session->userdata('idUsuarios') == 11 || $this->session->userdata('idUsuarios') == 48 || $this->session->userdata('idUsuarios') == 241 || $this->session->userdata('idUsuarios') == 107 || $this->session->userdata('idUsuarios') == 57){
                        $this->data['comprasSolicitadas'][$x]->itens = $this->pedidocompra_model->getItensByIdosLimited4($this->data['comprasSolicitadas'][$x]->idOs); // 1serv 6cesu
                    }else{
                        $this->data['comprasSolicitadas'][$x]->itens = $this->pedidocompra_model->getItensByIdosLimited($this->data['comprasSolicitadas'][$x]->idOs);
                    }                    
					}else{
                    if($this->session->userdata('idUsuarios') == 85 || $this->session->userdata('idUsuarios') == 87 || $this->session->userdata('idUsuarios') == 98  || $this->session->userdata('idUsuarios') == 6){
                        $this->data['comprasSolicitadas'][$x]->itens = $this->pedidocompra_model->getItensByIdos2($this->data['comprasSolicitadas'][$x]->idOs);   //3 petrolina            
                    }else if($this->session->userdata('idUsuarios') == 1){
                        $this->data['comprasSolicitadas'][$x]->itens = $this->pedidocompra_model->getItensByIdosAdmin($this->data['comprasSolicitadas'][$x]->idOs);                  
                    }else if($this->session->userdata('idUsuarios') == 88 || $this->session->userdata('idUsuarios') == 184 || $this->session->userdata('idUsuarios') == 50  || $this->session->userdata('idUsuarios') == 119 || $this->session->userdata('idUsuarios') == 128 || $this->session->userdata('idUsuarios') == 129){
                        $this->data['comprasSolicitadas'][$x]->itens = $this->pedidocompra_model->getItensByIdos3($this->data['comprasSolicitadas'][$x]->idOs); // 5 para 8 mining
                    }else if($this->session->userdata('idUsuarios') == 57 || $this->session->userdata('idUsuarios') == 11 || $this->session->userdata('idUsuarios') == 48 || $this->session->userdata('idUsuarios') == 241 || $this->session->userdata('idUsuarios') == 107 || $this->session->userdata('idUsuarios') == 57){
                        $this->data['comprasSolicitadas'][$x]->itens = $this->pedidocompra_model->getItensByIdos4($this->data['comprasSolicitadas'][$x]->idOs); // 1serv 6cesu
                    }else{
        ...
        if($this->session->userdata('idUsuarios') == 85 || $this->session->userdata('idUsuarios') == 87 || $this->session->userdata('idUsuarios') == 98 || $this->session->userdata('idUsuarios') == 6){
            $this->data['histAprovacao'] = $this->pedidocompra_model->getHistAprovacaoPCP2(); //3-PETR
        }else if($this->session->userdata('idUsuarios') == 1){
            ...
            $this->data['histAprovacao'] = $this->pedidocompra_model->getHistAprovacaoPCP3(); // 5 para - 8 mining
        }else if($this->session->userdata('idUsuarios') == 57 || $this->session->userdata('idUsuarios') == 11 || $this->session->userdata('idUsuarios') == 48 || $this->session->userdata('idUsuarios') == 241 ||  $this->session->userdata('idUsuarios') == 107 || $this->session->userdata('idUsuarios') == 57){
    ...
    public function autorizacaodirtec(){
	   ...
	   //Gambiarra - Foi necessário para dividir os itens de aprovação de PETR
        ...
        }else if($this->session->userdata('idUsuarios') == 1 || $this->session->userdata('idUsuarios') == 107 || $this->session->userdata('idUsuarios') == 11 || $this->session->userdata('idUsuarios') == 48 || $this->session->userdata('idUsuarios') == 241 || $this->session->userdata('idUsuarios') == 68){
            if(!empty($permCompra)){
                if(!empty($permCompra->valorMax)){
        ...
        } else if($this->session->userdata('idUsuarios') == 88 || $this->session->userdata('idUsuarios') == 98 || $this->session->userdata('idUsuarios') == 135  || $this->session->userdata('idUsuarios') == 50 || $this->session->userdata('idUsuarios') == 119  || $this->session->userdata('idUsuarios') == 237 || $this->session->userdata('idUsuarios') == 219 || $this->session->userdata('idUsuarios') == 18){
        ...
        } else if($this->session->userdata('idUsuarios') == 104 || $this->session->userdata('idUsuarios') == 11 || $this->session->userdata('idUsuarios') == 48 || $this->session->userdata('idUsuarios') == 241 || $this->session->userdata('idUsuarios') == 107 || $this->session->userdata('idUsuarios') == 18 || $this->session->userdata('idUsuarios') == 57) {
            if(!empty($permCompra)){
                if(!empty($permCompra->valorMax)){
