...
/*---------fim pegando o idFornecedores ------------------------------------------------------------------------------------------------------------*/		
    ...
    public function aprovarpcp(){
        ...
        }else if($this->session->userdata('idUsuarios') == 88 || $this->session->userdata('idUsuarios') == 50 || $this->session->userdata('idUsuarios') == 98 || $this->session->userdata('idUsuarios') == 135  || $this->session->userdata('idUsuarios') == 119 || $this->session->userdata('idUsuarios') == 128 || $this->session->userdata('idUsuarios') == 219 || $this->session->userdata('idUsuarios') == 129){
    ...
    public function autorizacaodirtec(){
	   ...
	   //Gambiarra - Foi necessário para dividir os itens de aprovação de PETR
        ...
        } else if($this->session->userdata('idUsuarios') == 88 || $this->session->userdata('idUsuarios') == 98 || $this->session->userdata('idUsuarios') == 135  || $this->session->userdata('idUsuarios') == 50 || $this->session->userdata('idUsuarios') == 119  || $this->session->userdata('idUsuarios') == 128 || $this->session->userdata('idUsuarios') == 219 || $this->session->userdata('idUsuarios') == 18){
