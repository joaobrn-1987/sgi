...
class Almoxarifado extends CI_Controller {
    ...
    public function cadastrarEntradas(){
        ...
        for($x=0;$x<count($this->input->post('idProdutoTD_'));$x++){
            ...
            if($m==0 || $m==1 || $m==2 || $m==3){
                $this->data["verificaPMEL"] = $this->almoxarifado_model->verificaPMEL($p,$m,$c,$v,$ps,null,null,null,$e,$l,null);
                if(count($this->data["verificaPMEL"] )<1){
                    $this->almoxarifado_model->criarEstoqueEntrada($p,$m,$c,$v,$ps,null,null,null,$e,$l,$this->input->post('qtdTD_')[$x],$idUser,$nf,$idOs,$vu,null);
                    $this->almoxarifado_model->criarEstoque($p,$m,$c,$v,$ps,null,null,null,$e,$l,$this->input->post('qtdTD_')[$x],null);
                }else {
    ...
    public function cadastrarSaidas(){
        ...
        for($x=0;$x<count($this->input->post('idAlmoEstoque_'));$x++){
            ...
            $this->almoxarifado_model->cadastrarSaidas($est,$qtd,$emp,$set,$idUser,$user,$idOs,null);
