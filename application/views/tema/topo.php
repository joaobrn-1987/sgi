...
<?php
  ...
  $arrayNomenclatura[sizeof($arrayNomenclatura)-1]->nomenclatura = "Aprovação Suprimentos";
  ...
  $arrayNomenclatura[sizeof($arrayNomenclatura)]   = new nomenclaturas();
  $arrayNomenclatura[sizeof($arrayNomenclatura)-1]->nome = "criar_pn";
  $arrayNomenclatura[sizeof($arrayNomenclatura)-1]->nomenclatura = "Repositório";

  $arrayNomenclatura[sizeof($arrayNomenclatura)]   = new nomenclaturas();
  $arrayNomenclatura[sizeof($arrayNomenclatura)-1]->nome = "adicionar_pn";
  $arrayNomenclatura[sizeof($arrayNomenclatura)-1]->nomenclatura = "Adicionar PN";

  $arrayNomenclatura[sizeof($arrayNomenclatura)]   = new nomenclaturas();
  $arrayNomenclatura[sizeof($arrayNomenclatura)-1]->nome = "page_addPn";
  $arrayNomenclatura[sizeof($arrayNomenclatura)-1]->nomenclatura = "Adicionar PN";

  $arrayNomenclatura[sizeof($arrayNomenclatura)]   = new nomenclaturas();
  $arrayNomenclatura[sizeof($arrayNomenclatura)-1]->nome = "page_add_versao_Pn";
  $arrayNomenclatura[sizeof($arrayNomenclatura)-1]->nomenclatura = "Cadastrar Versão de PN";

  $arrayNomenclatura[sizeof($arrayNomenclatura)]   = new nomenclaturas();
  $arrayNomenclatura[sizeof($arrayNomenclatura)-1]->nome = "page_editar_pn";
  $arrayNomenclatura[sizeof($arrayNomenclatura)-1]->nomenclatura = "Editar PN";

  $arrayNomenclatura[sizeof($arrayNomenclatura)]   = new nomenclaturas();
  $arrayNomenclatura[sizeof($arrayNomenclatura)-1]->nome = "page_add_pn_existente";
  $arrayNomenclatura[sizeof($arrayNomenclatura)-1]->nomenclatura = "Adicionar Desenho";
  ...
  $arrayNomenclatura[sizeof($arrayNomenclatura)-1]->nomenclatura = "Autorização";
  ...
  $arrayNomenclatura[sizeof($arrayNomenclatura)] = new nomenclaturas();
  $arrayNomenclatura[sizeof($arrayNomenclatura)-1]->nome = "pendente";
  $arrayNomenclatura[sizeof($arrayNomenclatura)-1]->nomenclatura = "Alteração PN Pendente";

  
  $arrayNomenclatura[sizeof($arrayNomenclatura)] = new nomenclaturas();
  $arrayNomenclatura[sizeof($arrayNomenclatura)-1]->nome = "linhadotempo";
  $arrayNomenclatura[sizeof($arrayNomenclatura)-1]->nomenclatura = "Histórico";

  
  $arrayNomenclatura[sizeof($arrayNomenclatura)] = new nomenclaturas();
  $arrayNomenclatura[sizeof($arrayNomenclatura)-1]->nome = "ossemmateriais";
  $arrayNomenclatura[sizeof($arrayNomenclatura)-1]->nomenclatura = "O.S. Sem Lançamentos";
  //echo '<script>console.log('.json_encode($arrayNomenclatura).')</script>'; 
  if($this->uri->segment(2)== "almoxarifadocompras"){
    $arrayNomenclatura[sizeof($arrayNomenclatura)] = new nomenclaturas();
    $arrayNomenclatura[sizeof($arrayNomenclatura)-1]->nome = "suprimentos";
    $arrayNomenclatura[sizeof($arrayNomenclatura)-1]->nomenclatura = "Almoxarifado";
    $arrayNomenclatura[sizeof($arrayNomenclatura)-1]->link = base_url().'index.php/suprimentos/almoxarifadocompras/';
  }
?>
...
<link rel="stylesheet" href="<?php echo base_url();?>assets/css/matrix-style2.css" />
<link rel="stylesheet" href="<?php echo base_url();?>assets/css/matrix-media2.css" />
...
-->
<script  type="text/javascript" charset="utf8" src="<?php echo base_url();?>assets/js/jquery-1-11-13.js"></script>
...
<div id="sidebar"> <a href="#" class="visible-phone"><i class="icon icon-list"></i> Menu</a>
  <ul>
    ...
    if($this->permission->checkPermission($this->session->userdata('permissao'),'fComercial')){ ?>
      <li class="submenu <?php if(isset($menuos)){echo 'active open';};?>"><a href="<?php echo base_url()?>index.php/orcamentos"><i class="icon-fixed-width icon-book"></i> <span>Comercial</span><span class="label"><i class="icon-chevron-down"></i></span></a>
        <ul>
          <li><a href="<?php echo base_url()?>index.php/orcamentos">Orçamentos</a></li>
          <li><a href="<?php echo base_url()?>index.php/orcamentos/pendente">Pendente Alteração PN</a></li>
            <?php if($this->permission->checkPermission($this->session->userdata('permissao'),'vOs')){ ?>
              <li><a href="<?php echo base_url()?>index.php/os">Ordem de Serviço</a></li>
            <?php } ?>
        </ul>
      </li>
   <?php }
    ...
    <?php }*/ ?>
      ...
      <li class="<?php if(isset($menuPcp)){echo 'active';};?>"><a href="<?php echo base_url()?>index.php/suprimentos/autorizacaopcp"><i class="icon-fixed-width icon-book"></i> <span>PCP</span></a></li>-->
    <?php
       if($this->permission->checkPermission($this->session->userdata('permissao'),'fPCP')){ ?>

        <li class="submenu <?php if(isset($menuPcp)){echo 'active open';};?>"><a href="<?php echo base_url()?>index.php/os/ordemservico_pcp"><i class="icon-fixed-width icon-book"></i> <span>PCP</span><span class="label"><i class="icon-chevron-down"></i></span></a>
          <ul>            
            <?php if($this->permission->checkPermission($this->session->userdata('permissao'),'vOs')){ ?>
              <li><a href="<?php echo base_url()?>index.php/os/ordemservico_pcp">Ordem de Serviço</a></li>
            <?php } ?>
<?php 
/*
...
?>
            ...
            <li><a href="<?php echo base_url()?>index.php/almoxarifado/menuvale">Vale</a></li><!--
            <li><a href="<?php echo base_url()?>index.php/pcp/compra">Compra</a></li>-->
    ...
    <!-- MENU DESENHO ALTERADO WESLEY-->
    <?php if($this->permission->checkPermission($this->session->userdata('permissao'),'vDesenho')){ ?>
    <li class="submenu <?php if(isset($menuDesenho)){echo 'active open';};?>">
      <a href="<?php echo base_url()?>index.php/desenho/aguardandoDesenho">
        <i class="icon-fixed-width icon-book"></i><span>Desenho</span>
        <span class="label"><i class="icon-chevron-down"></i></span>
      </a>
        <ul>
          
          <li><a href="<?php  echo base_url()?>index.php/desenho/aguardandoDesenho">Adicionar PN OS</a></li>
          
          <?php if($this->permission->checkPermission($this->session->userdata('permissao'),'eDesenho')){ ?>  
            <li><a href="<?php echo base_url()?>index.php/desenho/criar_pn">Repositório</a></li>
            <?php } ?>
          <?php if($this->permission->checkPermission($this->session->userdata('permissao'),'eDesenho')){ ?>  
            <li><a href="<?php echo base_url()?>index.php/desenho/catalogo">Catálogo</a></li>   
          <?php } ?>
          <!-- <?php //if($this->permission->checkPermission($this->session->userdata('permissao'),'vOs')){ ?>
            <li><a href="<?php echo base_url()?>index.php/os/ordemservico_pcp">Ordem de Serviço</a></li>
          <?php //} ?> -->
    ...
    if($this->permission->checkPermission($this->session->userdata('permissao'),'vPedCompra')){ ?>
      ...
      <a href="<?php echo base_url()?>index.php/suprimentos/aprovacao"><i class="icon icon-tags"></i> <span>Suprimentos</span> <span class="label"><i class="icon-chevron-down"></i></span></a>
          <ul>          
            <li><a href="<?php echo base_url()?>index.php/suprimentos">Compras</a></li>
			
<?php 
$idUser = (int)$this->session->userdata('idUsuarios');
if (
    $this->permission->checkPermission($this->session->userdata('permissao'), 'vAutCompra') 
    && in_array($idUser, [26,18,53])
) { ?>
    <li class="<?php if(isset($menuAprovacaoFinal)){echo 'active';};?>">
        <a href="<?php echo base_url()?>index.php/suprimentos/aprovacaoFinal">
            <i class="icon icon-check"></i> <span>Aprovação para Compras</span>
        </a>
    </li>
<?php } ?>
            ...
            /*if($this->permission->checkPermission($this->session->userdata('permissao'),'aAutCompraFIN')){?>
              <li><a href="<?php echo base_url()?>index.php/suprimentos/aprovacao">Autorização Suprimentos </a></li><?php 
            }*/
            ?>
            <?php 
            ...
            ?>
            <?php if($this->permission->checkPermission($this->session->userdata('permissao'),'vOs')){ ?>
              <li><a href="<?php echo base_url()?>index.php/suprimentos/ordemservico">Ordem de Serviço</a></li>
            <?php } ?>
          </ul>
        </li><?php
    }
  ...
  <li class=""><a href="<?php echo base_url()?>index.php/registrodescarte"><i class="icon-fixed-width icon-cogs"></i> <span>Registro de Descarte</span></a></li>-->
    ...
    <li class="submenu <?php if(isset($menuAlmoxarifado)){echo 'active open';};?>">
          ...
          <ul>
            <?php if($this->permission->checkPermission($this->session->userdata('permissao'),'aAlmoxarifado')){ ?>
              <li class="submenu2"><a 'href="<?php echo base_url()?>index.php/almoxarifado"><span>Lançamentos</span> <span class="label"><i class="icon-chevron-down"></i></span></a><ul style="padding-left: 36px; list-style-type: none; display: none;background-color: #161d24; border: 1px solid rgb(17, 22, 28);"><li><a href="<?php echo base_url()?>index.php/almoxarifado">Sem ordem de compra</a></li><!----><li><a href="<?php echo base_url()?>index.php/almoxarifado/recebercompras">Com ordem de compra</a></li></ul></li>
            <?php } ?>
            <?php if($this->permission->checkPermission($this->session->userdata('permissao'),'receberMercadoria')){ ?>
              <li><a href="<?php echo base_url()?>index.php/almoxarifado/receber">Receber Mercadoria</a></li>
            <?php } ?>
            <li><a href="<?php echo base_url()?>index.php/almoxarifado/relatorioAlmoxarifado">Relatórios</a></li>
            <li><a href="<?php echo base_url()?>index.php/almoxarifado/linhadotempo">Histórico</a></li><!--
            <li><a href="<?php echo base_url()?>index.php/almoxarifado/reldetalhado">Relatório detalhado</a></li>-->
            <li><a href="<?php echo base_url()?>index.php/almoxarifado/gerencia2">Peças Mortas</a></li>
            <li><a href="<?php echo base_url()?>index.php/almoxarifado/ordemservico">Ordem de Serviço</a></li>
            <?php if($this->permission->checkPermission($this->session->userdata('permissao'),'vPedidocompraalmox')){ ?>
              ...
              <li><a href="<?php echo base_url()?>index.php/suprimentos/almoxarifadocompras">Compras</a></li><!--
              <li><a href="<?php echo base_url()?>index.php/almoxarifado/recebercompras">Entrega MP</a></li> -->
              <li><a href="<?php echo base_url()?>index.php/almoxarifado/desvincularitens">Desvincular itens</a></li><!---->
                
            <?php } ?>
            <?php if($this->permission->checkPermission($this->session->userdata('permissao'),'vGerenciaalmo')){ ?>
    ...
    <?php if($this->permission->checkPermission($this->session->userdata('permissao'),'vPeritagem')){ ?>
      <li class="submenu <?php if(isset($menuPeritagem)){echo 'active open';};?>">
          <a href="<?php echo base_url()?>index.php/peritagem/listaperitagem"><i class="icon icon-tags"></i> <span>Peritagem</span> <span class="label"><i class="icon-chevron-down"></i></span></a>
          <ul>   
            <li><a href="<?php echo base_url()?>index.php/peritagem/listaperitagem">Aguardando</a></li>    
            <?php if($this->permission->checkPermission($this->session->userdata('permissao'),'vOs')){ ?>
              <li><a href="<?php echo base_url()?>index.php/peritagem/ordemservico">Ordem de Serviço</a></li>
            <?php } ?>  
          </ul>
      </li>
      <?php }?>
  ...
  /*
	...
	<?php //if($this->permission->checkPermission($this->session->userdata('permissao'),'vProduto')){ ?>
        <li class="<?php if(isset($menuProcessos)){echo 'active';};?>"><a href="<?php echo base_url()?>index.php/processos"><i class="icon icon-barcode"></i> <span>Processos</span></a></li>
    <?php // } ?>
  ...
  -->
    ...
    <?php //if($this->permission->checkPermission($this->session->userdata('permissao'),'vLancamento')){ ?>
        <li class="submenu <?php //if(isset($menuFinanceiro)){echo 'active open';};?>">
          <a href="<?php //echo base_url()?>index.php/suprimentos/autorizacao"><i class="icon icon-money"></i> <span>Financeiro</span> <span class="label"><i class="icon-chevron-down"></i></span></a>
          <ul>
            <li><a href="<?php //echo base_url()?>index.php/financeiro/lancamentos">Lançamentos</a></li>
            <li><a href="<?php //echo base_url()?>index.php/suprimentos/autorizacao">Autorizar Compra</a></li>
          </ul>
        </li>-->
    <?php //} ?>
        ...
        <li class="submenu <?php if(isset($menuRelatorios)){echo 'active open';};?>" >
          ...
          <ul>
            ...
            <?php if($this->permission->checkPermission($this->session->userdata('permissao'),'vOs')){ ?>
              ...
              <li><a href="<?php echo base_url()?>index.php/os/carteiraservico"> Carteira de Serviço</a></li>
              <li><a href="<?php echo base_url()?>index.php/os/ossemmateriais"> Pendente Lançamentos</a></li>
            <?php } ?>
            <?php if($this->permission->checkPermission($this->session->userdata('permissao'),'rOrdemcompra')){ ?>
            ...
            <?php if($this->permission->checkPermission($this->session->userdata('permissao'),'rOrcamento')){ ?>
                <li><a href="<?php echo base_url()?>index.php/relatorios/relcomercial">Comercial</a></li>
                <li><a href="<?php echo base_url()?>index.php/relatorios/relperitagem">Peritagem</a></li>
            <?php } ?>
            <?php if($this->permission->checkPermission($this->session->userdata('permissao'),'vvalorOs')){ ?>
                <li><a href="<?php echo base_url()?>index.php/relatorios/relvendas">Vendas</a></li>
                <li><a href="<?php echo base_url()?>index.php/relatorios/relfaturamento">Faturamento</a></li>
                <li><a href="<?php echo base_url()?>index.php/relatorios/relfaturamentoitens">Itens faturados</a></li>
            <?php } ?>
            <?php if($this->permission->checkPermission($this->session->userdata('permissao'),'vOs')){ ?>
                <li><a href="<?php echo base_url()?>index.php/relatorios/infoHoras">Tempo das Etapas</a></li>
            <?php } ?>
            ...
            <?php if($this->permission->checkPermission($this->session->userdata('permissao'),'rOrcamento')){ ?>
                <li><a href="<?php echo base_url()?>index.php/relatorios/rel_orcamento_itens">Itens Orçamentos</a></li>
            <?php } ?>
    ...
    <?php if($this->permission->checkPermission($this->session->userdata('permissao'),'cUsuario')  || $this->permission->checkPermission($this->session->userdata('permissao'),'cEmitente') || $this->permission->checkPermission($this->session->userdata('permissao'),'cPermissao') || $this->permission->checkPermission($this->session->userdata('permissao'),'cBackup')){ ?>
        <li class="submenu <?php if(isset($menuConfiguracoes)){echo 'active open';};?>">
          ...
          <ul>
            ...
            <?php } ?>
            <?php if($this->permission->checkPermission($this->session->userdata('permissao'),'desenvolvedor')){ ?>
                <li><a href="<?php echo base_url()?>index.php/mapos/desenvolvedor">Desenvolvedor</a></li>
            <?php } ?>
...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="<?php echo base_url()?>" title="Dashboard" class="tip-bottom"><i class="icon-home"></i> Dashboard</a> <?php if($this->uri->segment(1) != null){?><a href="<?php $verifySegundo = false; foreach($arrayNomenclatura as $v){if($v->nome == $this->uri->segment(1)){ echo $v->link;$verifySegundo = true;break;}} if($verifySegundo == false){ echo base_url().'index.php/'.$this->uri->segment(1);}?>" class="tip-bottom" title="<?php $verifySegundo = false; foreach($arrayNomenclatura as $v){if($v->nome == $this->uri->segment(1)){ echo $v->nomenclatura;$verifySegundo = true;break;}} if($verifySegundo == false){ echo ucfirst($this->uri->segment(1));}?>"><?php $verifySegundo = false; foreach($arrayNomenclatura as $v){if($v->nome == $this->uri->segment(1)){ echo $v->nomenclatura;$verifySegundo = true;break;}} if($verifySegundo == false){ echo ucfirst($this->uri->segment(1));}?></a> <?php if($this->uri->segment(2) != null){?><a href="<?php echo base_url().'index.php/'.$this->uri->segment(1).'/'.$this->uri->segment(2) ?>" class="current tip-bottom" title="<?php echo ucfirst($this->uri->segment(2)); ?>"><?php $verifyTerceiro = false; foreach($arrayNomenclatura as $v){if($v->nome == $this->uri->segment(2)){ echo $v->nomenclatura;$verifyTerceiro = true;break;}} if($verifyTerceiro == false){ echo ucfirst($this->uri->segment(2));}} ?></a> <?php }?></div>
  </div>
...
<script type="text/javascript">
  <?php /*if($this->session->userdata('idUsuarios')==1){?>
    $(document).ready(function() {
      
    })
    console.log("<?php $data4 = new DateTime(); echo $data4->format('Y-m-d H:i:s')?>")
    timeout();
    function timeout() {
      setTimeout(function() {
        var datetime = "LastSync: " + new Date().getDate()+"/"+new Date().getMonth()+"/"+new Date().getFullYear() + " @ " + new Date().getHours()+":"+new Date().getMinutes()+":"+new Date().getSeconds();
        console.log(datetime)
        console.log("Verficar backup");
        salvarBackup();
        timeout();
      }, 300000);
    }
    function salvarBackup(){/*
      Object.assign(document.createElement('a'), {
        ...
        href: "<?php echo base_url(); ?>index.php/mapos/backup2",
      }).click();
  ...
  $(".submenu2").click(function(){
    ...
    var varUl = $(this).children('ul')[0]
    if($(varUl).css("display") == "none"){
