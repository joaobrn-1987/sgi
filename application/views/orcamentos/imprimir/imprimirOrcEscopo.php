            ...
            <div class="span12">
                ...
                <div class="widget-box" >
                    ...
                    <div class="widget-content nopadding" style="font-family:Arial, Helvetica, sans-serif;
                        ...
                        <!--
                        <div class="span12" style="margin-left: 0px;min-height:0px">
                            <div class="span6" style="min-height:0px">
                                <div style="text-align: left; margin-top: 0px;margin-left: 6px;">
                                    PN: <?php echo $descricoes->pn; ?>
                                </div>
                            </div>
                            <div class="span6" style="min-height:0px">
                        ...
                        <div class="span12" style="margin-left: 0px;min-height:0px">
                            <div class="span6" style="min-height:0px">
                                <div style="text-align: left;margin-left: 6px;">
                                    TAG: <?php echo $descricoes->tag; ?>
                                </div>
                            </div>
                            <div class="span6" style="min-height:0px">
                                <div style="text-align: left;">
                                    ORDEM SERV.: <?php echo $descricoes->idOs; ?>
                                </div>
                            </div>                            
                        </div>-->
                    </div>
        ...
        <div class="row-fluid">
                ...
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                        ...
                        <table class='comBordas' width='100%'>
                            ...
                            <tbody>
                                <?php $counta = 1;foreach($itensEscopo as $r){
                                    echo '<tr>';
                                        echo '<td>';
                                            echo $counta;
                                        echo '</td>';
            ...
            <div class="span12" style="margin-left: 0px;">
				...
				<div class="span7">
					...
					<font size="1">
						<div align="right">
							<b> TOTAL DAS PEÇAS R$:</b><input name="valor_produtos_" type="text" id="valor_produtos_" style="font-size: 10px; background-color:#E3EEF2; border: 0px solid #000000;" value="<?php if(isset($itensEscopo)){$valorServ = 0;foreach($itensEscopo as $r){if($r->descricaoClasse == "Serviço"){$valorServ += $r->valorUnitario*$r->quantidade;}} echo "R$ ".number_format($valorServ, 3, ",", ".");}?>" size="12" readonly="true">
						</div>
						<div align="right">
							<b>TOTAL DOS SERVIÇOS R$: </b><input name="ipi_" type="text" id="ipi_" style="font-family: Arial; font-size: 10px; background-color:#E3EEF2; border: 0px solid #000000;" value="<?php if(isset($itensEscopo)){$valorPec = 0;foreach($itensEscopo as $r){if($r->descricaoClasse == "Peça"){$valorPec += $r->valorUnitario*$r->quantidade;}} echo "R$ ".number_format($valorPec, 3, ",", ".");}?>" size="12" readonly="true">
						</div>					
						<div align="right">
							<b>TOTAL DA REFORMA R$:</b> <input name="valor_total_" type="text" id="valor_total_" style="font-family: Arial; font-size: 10px; background-color:#E3EEF2; border: 0px solid #000000;" value="<?php if(isset($itensEscopo)){$valorTot = 0;foreach($itensEscopo as $r){$valorTot += $r->valorUnitario*$r->quantidade;} echo "R$ ".number_format($valorTot, 3, ",", ".");}?>" size="12" readonly="true">
						</div>
					</font>
				</div>
...
<div class="row-fluid">
              <div class="span12">
                  ...
                  <div class="widget-box" style="padding-left: 15px;padding-right: 12px;">
