...
foreach ($results as $r) {
    ...
    echo "<td align='center'>" . (!empty($r->numero_nf) ? htmlspecialchars($r->numero_nf) : "") . "</td>";
    echo "<td align='center'>" . (!empty($r->data_nf_emitida) ? date('d/m/Y', strtotime($r->data_nf_emitida)) : (!empty($r->data_nf_faturamento) ? date('d/m/Y', strtotime($r->data_nf_faturamento)) : "")) . "</td>";
    echo "<td align='center'>" . (!empty($r->usuario_nf) ? htmlspecialchars($r->usuario_nf) : "") . "</td>";

    // ✅ Link Visualizar OS (com ícone de olho)
    $link_visualizar = base_url("index.php/os/visualizar/{$r->idOs}");
    echo "<td align='center'>
            <font size='1'>
                <a href='{$link_visualizar}' style='margin-right:1%' class='btn tip-top' title='Visualizar OS'>
...
<tr>
	...
	Empresa: <?php echo $results[0]->nome; ?>
                 ...
                 <tr>
                    ...
                    <td align='center' class="no-print"><b>Grupo</td>
                    <td align='center' ><b>Cliente</b></td>
					<td align='center' ><b>Solicitante</b></td>
                    <td align='center' class="no-print"><b>Vendedor</b></td>
					<!--<td align='center' ><b>Data Criação OS</b></td>-->
                    ...
                    <td align='center' ><b>Data Ent.</b></td>
                    <td align='center' ><b>Reprogr.</b></td>
					<!--<td align='center' ><b>Data Exp.</b></td>-->
                ...
                foreach ($results as $r) {
                    ...
                    echo '<td align="center">' . $data_faturamento . '</td>';
                    echo '<td align="center">' . $data_fabricacao . '</td>';
					echo '<td align="center">' . $data_producao_formatada . '</td>'; // LINHA ADICIONADA
                    if ($r->statusDesenho == 3) {
                        echo '<td align="center">Finalizado</td>';
                ...
                <tr>
                    ...
                    ?>
                    <td colspan='10' align='right'>Total de OS: <?php echo $totalos; ?></td>
                </tr>
