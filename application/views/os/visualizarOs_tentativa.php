              ...
              <div class="tab-pane active" id="tab1">
                <form action="<?php echo base_url() ?>index.php/os/editaros" method="post">
                      ...
                      <div class="widget-box" style="margin-top:0px">
                        <div class="widget-content nopadding">
                            <div class="tab-content" style="background-color: white;padding: 1%;border: 1px #cdcdcd solid;">
                                  ...
                                  <div class="span12" id="divCadastrarOs">
                                    <div class="span12" >
                                      <div class="span1" class="control-group">
                                        <label for="idGrupoServico" class="control-label">Data Criação: </label>
                                        <p><?php echo $data_insert ?></p>
                                      </div>
                                      <div class="span1" class="control-group">
                                        <label for="idGrupoServico" class="control-label">Data O.S.: </label>
                                        <input type="text" class="span12 data" value="<?php if (!empty($result->data_abertura)) { echo date("d/m/Y", strtotime($result->data_abertura));}  ?>" onclick="this.select();" name="data_abertura" id="data_abertura"/>
                                      ...
                                      <div class="span1" class="control-group">
                                        <label for="idGrupoServico" class="control-label">Data Entrega </label>
                                        <input type="text" class="span12 data" readonly value="<?php echo date("d/m/Y", strtotime($result->data_entrega));  ?>"  onclick="this.select();" name="data_entrega" id="data_entrega" />
                                      </div>
                                      <div class="span2" class="control-group">
                                        ...
                                        if (empty($disabled)) {
                                        ?>
                                        <label for="idGrupoServico" class="control-label">Data Rep.: </label>
                                        <input type="text" class="span8 data" value="<?php if ($result->data_reagendada <> '') {echo date("d/m/Y", strtotime($result->data_reagendada));} ?>" name="data_reagendada" id="data_reagendada" onclick="this.select();"/>
                                        <?php
                                        ...
                                        data-toggle="modal" class="btn btn-primary"><i class="icon-save icon-white"></i></a>';
                                          ...
                                          ?>
                                          <label for="idGrupoServico" class="control-label">Data Rep.: </label>
                                          <input type="text" class="span12 data" value="<?php if ($result->data_reagendada <> '') {echo date("d/m/Y", strtotime($result->data_reagendada));} ?>" name="data_reagendada" id="data_reagendada" onclick="this.select();"/>
                                        <?php
                                        }
                                      ...
                                      <div class="span1" class="control-group">
                                        <label for="idGrupoServico" class="control-label">Data Exp. </label>
                                        <input type="text" class="span12 data" readonly value="<?php ?>"  onclick="this.select();" name="data_expedicao" id="data_expedicao" />
                                      </div>
                                      <div class="span1" class="control-group">
                                        <label for="idGrupoServico" class="control-label">Nº Pedido: </label>
                                        <input size='11' type="text" class="span12" value="<?php echo $result->numpedido_os; ?>" id="numpedido_os" name="numpedido_os" />
                                      </div>
                                      <div class="span1" class="control-group">
                                        <label for="idGrupoServico" class="control-label">Tag </label>
                                        <input size='6' type="text" class="span12" id="tag" value="<?php echo $result->tag;  ?>"  onclick="this.select();" name="data_entrega" id="data_entrega" />
                                      </div>
                                      <div class="span2" class="control-group">
                                        <label for="idGrupoServico" class="control-label"> Unid. Exec.: </label>
                                        <select class="span12" name="unid_execucao" <?php if ($result->idStatusOs == 200) {
                                                                    echo 'disabled';
                                                                  } ?>>
                                      ...
                                      <div class="span2" class="control-group">
                                        ...
                                        <select class="span12" name="unid_faturamento" <?php if (empty($result->unid_faturamento)) {
                                                                      echo 'disabled';
                                                                    } ?>>
                                    ...
                                    <div class="span12" style="margin-top: 7px;margin-left:0px">
                                      <div class="span1" class="control-group">
                                        <label for="idGrupoServico" class="control-label">Cod. OS: </label>
                                        <p><b><?php echo $result->idOs ?></b></p>
                                      </div>
                                      <div class="span1" class="control-group">
                                        ...
                                        <p><b><?php
                                          if ($this->permission->checkPermission($this->session->userdata('permissao'), 'eOrcamento')) {
                                            echo '<a target="_blank" href="' . base_url() . 'index.php/orcamentos/editar/' . $result->idOrcamentos . '" style="color:black"onMouseOver="this.style.color=\'blue\'"
                                              onMouseOut="this.style.color=\'black\'">' . $result->idOrcamentos  . '</a>';
                                          } else { ?>
                                            <?php echo $result->idOrcamentos; ?><?php
                                                                              }
                                                                                ?></b></p>
                                      </div>
                                      <div class="span2" class="control-group">
                                        <label for="idGrupoServico" class="control-label">Natureza Op.: </label>
                                        <p><b><?php echo $dados_natoperacao->nome ?></b></p>
                                      </div>
                                      <div class="span2" class="control-group">
                                        <label for="idGrupoServico" class="control-label">NF Cliente: </label>
                                        <input type="text" class="span12" value="<?php echo $result->nf_cliente; ?>" id="nf_cliente" name="nf_cliente" />
                                      </div>
                                      <div class="span2" class="control-group">
                                        <label for="idGrupoServico" class="control-label">Contrato: </label>
                                        <select class="span12" name="contrato" class="form-control">
                                      ...
                                      <div class="span2" class="control-group">
                                        <label for="idGrupoServico" class="control-label">Nº NF | Data Fat. </label>
                                        <input type="text" class="span6" placeholder="NF" value="<?php echo $result->numero_nf; ?>" id="numero_nf" name="numero_nf" onclick="this.select();"/>
                                        <input type="text" class="span6 data" placeholder="Data" value="<?php if ($result->data_nf_faturamento <> '') {echo date("d/m/Y", strtotime($result->data_nf_faturamento));} ?>" id="data_nf_faturamento" name="data_nf_faturamento" onclick="this.select();"/>
                                      </div>
                                      <div class="span2" class="control-group">
                                        <label for="idGrupoServico" class="control-label">NF Dev.| Fabricaçao </label>
                                        <input type="text" class="span6" placeholder="NF" value="<?php echo $result->nf_venda_dev; ?>" id="nf_venda_dev" name="nf_venda_dev" onclick="this.select();"/>
                                        <input type="text" class="span6 data" placeholder="Data" value="<?php if ($result->data_devolucao <> '') {echo date("d/m/Y", strtotime($result->data_devolucao));} ?>" id="data_devolucao" name="data_devolucao" onclick="this.select();"/>
                                      </div>
                                    </div>
                                    <div class="span12" style="margin-top: 7px;margin-left:0px">
                                      <div class="span2" class="control-group">
                                        <label for="idGrupoServico" class="control-label">Cliente </label>
                                        <p><b><?php echo $orcamento->nomeCliente; ?></b></p>
                                      </div>
                                    </div>
                                  </div>
                                </form>
                  ...
                  <table class="table table-bordered ">
                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                          <td>
                            <?php echo '<a title="Clique aqui para visualizar as informações da O.C." style="cursor:pointer" onclick="openModalInfoOC(' . $dist->idPedidoCompra . ')" ><b>' . $dist->idPedidoCompra . '</b></a>'; ?>
                          </td>
                          <td>
                          ...
                          <td>
                            ...
                            if (!empty($r->dimensoesL)) {
                              $html .= " x L: " . $r->dimensoesL . " mm ";
                            }
                            if (!empty($r->dimensoesC)) {
                              $html .= " x C: " . $r->dimensoesC . " mm ";
                            }
                            if (!empty($r->dimensoesA)) {
                              $html .= " x A: " . $r->dimensoesA . " mm";
                            }
                            echo $html;
                ...
                <div class="span12 well" style="padding: 1%; margin-left: 0">
                  ...
                  <table class="table table-bordered ">
                    <tr>
                      ...
                      <th>Total Produtos: <?php echo 'R$ ' . number_format((float)$totalAlmo, 2, ',', '.'); ?></th>
                    </tr>
                  </table>
                  <!--
                  <div style="text-align: right">
