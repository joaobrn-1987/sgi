<div class="row-fluid" style="margin-top:0">
    ...
    <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="user" type="text" name="user" value="<?php echo set_value('user'); ?>"  />
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        <label for="Empresa"  class="control-label">Empresa<span class="required">*</span></label>
                        <div class="controls">
                            <?php foreach ($dados_emitente as $p) {
                                echo '<div class="control-group"><label  class="control-label"  style="width: 15px; padding-top: 10px;"><input id="idempresa"   type="checkbox" name="idempresa[]" value="'.$p->id.'"  /></label>';
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <?php foreach ($dados_departamento as $p) {
                                echo '<div class="control-group"><label  class="control-label"  style="width: 15px; padding-top: 10px;"><input id="iddepartamento"   type="checkbox" name="iddepartamento[]" value="'.$p->idAlmoEstoqueDep.'"  /></label>';
