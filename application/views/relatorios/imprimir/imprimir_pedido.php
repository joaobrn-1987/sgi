...
<a href='<?php echo base_url();?>/index.php/pedidocompra/editarpedido/<?php echo $result[0]->idPedidoCompra;?>'>Voltar</a>
<?php
...
table.comBordas2 td {
                  ...
                  <table width='100%' align='center' border ='0' class='comBordas'>
					  ...
					  <td style="text-align: center; width: 20%" rowspan='3'><strong><img src=" <?php echo base_url().$result[0]->url_logo.$result[0]->imagem; ?> " width='55%' height='30%'=></strong></td>
						...
						<b><font size='4'><?php echo $result[0]->nome; ?></font> </b> </td>
						 ...
						 <tr>
					  <td>
					  <font size='1'><b>CNPJ: </b><?php echo $result[0]->cnpj; ?></font>
					  <br>
					  <font size='1'><b>ENDEREÇO:</b> <?php echo $result[0]->rua;?> Nº: <?php echo $result[0]->numero;?></font>
					  <br>
					  <font size='1'><b>CIDADE: </b><?php echo $result[0]->cidade;?> </font>
					  <br>
					  <font size='1'><b>EMAIL:</b> <?php echo $result[0]->email_compras;?></font>
					  </td>
					  
					  <td>
					  <font size='1'><b>INSCRIÇÃO ESTADUAL:</b> <?php echo $result[0]->ie; ?></font> </br>
					  <font size='1'><b>BAIRRO:</b> <?php echo $result[0]->bairro;?></font>
					  <br>
					  <font size='1'><b>ESTADO:</b> <?php echo $result[0]->uf; ?></font>
					  <br>
					  <font size='1'><b>TELEFONE:</b> <?php echo $result[0]->telefone; ?></font>
					  </td>
	...
	<tr>
	<td align='center'><font size='1'>ORDEM COMPRA: <b><?php echo $result[0]->idPedidoCompra;?></b></font></td></tr><tr>
						<td align='center'><font size='1'>Data: <b><?php echo date("d/m/Y", strtotime($result[0]->data_cadastro)); ;?></b>
						</font>
	</td></tr>
...
<div class='span5'><br><font size='1'>
<b>Observações:</b>
