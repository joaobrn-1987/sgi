...
?>
    ...
    <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
                                        ...
                                        <div class="span12" style="padding: 1%; margin-left: 0">
                                            ...
                                            <div class="span2" class="control-group">
                                                <label for="idPedidoCompra" class="control-label">PN</label>
                                                <input class="span12" type="text" name="pn" value="" class="span12">
                                                <input class="span12" type="hidden" name="idpn" value="" class="span12">

                                            </div>
                                            <div class="span2" class="control-group">
                                                <label for="idPedidoCompra" class="control-label">Descrição</label>
                                                <input class="span12" type="text" name="descricao" value="" class="span12">
...
<div class="span12" class="control-group">
    ...
    <table width='100%'>
        <tr>
            ...
            // --- LINHA ADICIONADA ---
            // Ordena o array $dados_statuscompra em ordem alfabética pela propriedade 'nomeStatus'
            usort($dados_statuscompra, function ($a, $b) {
                return strcmp($a->nomeStatus, $b->nomeStatus);
            });
            ...
            ?>
                <td>
                    <input type="checkbox" name="idStatuscompras[]" class='check' value="<?php echo $so->idStatuscompras; ?>" <?php if ($so->idStatuscompras == 1 || $so->idStatuscompras == 2 || $so->idStatuscompras == 3 || $so->idStatuscompras == 4 || $so->idStatuscompras == 10) {
                                                                                                                                echo "checked";
                                                        ...
                                                        <tr>
                                                            ...
                                                            ?>
                                                                <td>
                                                                    ...
                                                                    <input type="checkbox" name="idFornecedores[]" value="<?php echo $for->idFornecedores; ?>"> <?php echo $for->nomeFornecedor; ?>
                                                                </td>
                                                            <?php
                                                                if ($i % 2) {
                                                                    echo "</tr><tr>";
