...
<div class="row-fluid" style="margin-top:0">
    ...
    <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
               ...
               <!--<form  action="<?php echo base_url() ?>index.php/clientes/pesquisar_cnpj" method="post">
    <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
-->
                    <div class="control-group">
                        <label for="nomeCliente" class="control-label">Nome<span class="required">*</span></label>
                        <div class="controls" >
                        <input class="span8" id="nomeCliente" type="text" name="nomeCliente" value="<?php echo set_value('nomeCliente'); ?>"  />
                        </div>
                    </div>
                    <div class="control-group">
                        <label for="nomeCliente" class="control-label">Nome - Exibição (Carteira)</label>
                        <div class="controls" >
                        <input class="span8" id="nomeClienteCart" type="text" name="nomeClienteCart" value="<?php echo set_value('nomeClienteCart'); ?>"  />
                        </div>
                    </div>
