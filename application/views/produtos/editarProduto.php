...
<script type="text/javascript">
    ...
    function GerarCódigoDeBarras(elementoInput){
        ...
        JsBarcode('#codBarras', elementoInput, {displayValue: false});
    }
</script>
<div class="row-fluid" style="margin-top:0">
    ...
    <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="pn" type="text" name="pn" value="<?php echo $result->pn; ?>" onkeyup="maiuscula(this)" />
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="fornecedor_original" type="text" name="fornecedor_original" value="<?php echo $result->fornecedor_original; ?>" />
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="subconjunto" type="text" name="subconjunto" value="<?php echo $result->subconjunto; ?>" />
                        </div>
                    </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        GerarCódigoDeBarras("<?php echo $result->pn;?>");
    });
</script>