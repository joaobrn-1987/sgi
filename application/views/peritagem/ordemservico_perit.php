                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tab1">
                                ...
                                <div class="span12" id="divCadastrarOs">
                                    ...
                                    <form class="form-inline" action="<?php echo base_url() ?>index.php/peritagem/ordemservico" method="post" name="form8" id="form8">
...
/*
                                            echo '<td><font size="1">';
                                            if ($this->permission->checkPermission($this->session->userdata('permissao'), 'eDistribuirOs')) {
                                                if(($r->idOs == 1 || $r->idOs == 2 || $r->idOs == 3 || $r->idOs == 4 || $r->idOs == 5 || $r->idOs == 11 || $r->idOs == 12 || $r->idOs == 10) || $r->idGrupoServico == 3)
