...
<form class="form-inline" action="<?php echo base_url() ?>index.php/desenho/salvarCatalogo" method="post" id="formCatalogo">
                                ...
                                <div class="span12" id="divCadastrarOs">
                                    <div class="span12" style="padding: 1%; margin-left: 0">
                                        <div class="span2" class="control-group">
                                            ...
                                            <input type="text" class="span12" id="pn" value="<?php echo $produto->pn?>"  readonly/>
                                            <input type="hidden" id="idProdutos" name="idProdutos" value="<?php echo $produto->idProdutos?>"  readonly/>
                                        </div>
                                        <div class="span5" class="control-group">
                                            <label for="idGrupoServico" class="control-label">Descrição: </label>
                                            <input type="text" class="span12" value="<?php echo $produto->descricao?>" id="prod" readonly />
                                        </div>
                                        <div class="span5" class="control-group">
                                            <label for="idGrupoServico" class="control-label">Tipo de Prod: </label>
                                            <input type="text" name="tipoProdMaster" class="span12" value="<?php echo $tipo?>" readonly>
                                        </div>
                                    </div><!--
                                    <div class="span12" style="padding: 1%; margin-left: 0">
                                        <div class="span2" class="control-group">
