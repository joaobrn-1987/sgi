...
<ul class="nav nav-tabs">
    ...
    <li><a href="#tab2" data-toggle="tab">Rejeitados</a></li>
    <li><a href="#tab3" data-toggle="tab">Histórico de Aprovação</a></li>
</ul>
<div class="tab-content">
    <div class="tab-pane active" id="tab1">
        <form action="<?php echo base_url() ?>index.php/suprimentos/autorizacaodirtec/1" method="post" name="form1" id="form1">
                                                ...
                                                <tbody>
                                                    <?php foreach($listaPedidos as $r){
                                                        echo '<tr class="trpai'.$r->idPedidoCompra.'">';
                                                            ...
                                                            foreach($itens as $c){
                                                                echo '<input type="hidden" name="idPedidoCompraItens" id="idPedidoCompraItens'.$r->idPedidoCompra.'" value="'.$c.'">';
                                                            }                                               
                                                        ...
                                                        echo '<tr class="trfilho'.$r->idPedidoCompra.'" style="display:none">';
                                                            ...
                                                            echo '<td colspan=10 style="background-color: #efefef;padding-top: 0px;">';
                                                                        ...
                                                                        //echo '<script>console.log('.json_encode($r->itens).')</script>';
                                                                            foreach($r->itens as $i){
                                                                                echo '<tr>';
                                                                                    ...
                                                                                    if(!empty($i->dimensoes)){
                                                                                        $html.=" ".$i->dimensoes;
                                                                                    } 
                                                                                    if(!empty($i->comprimento)){
                                                                                        $html.=" X ".$i->comprimento." mm";
                                                                                    } 
                                                                                    if(!empty($i->volume)){
                                                                                        $html.=" ".$i->volume." ml";
                                                                                    } 
                                                                                    ...
                                                                                    if(!empty($i->dimensoesL)){
                                                                                        $html .= " X L: ".$i->dimensoesL." mm";
                                                                                    }
                                                                                    if(!empty($i->dimensoesC)){
                                                                                        $html .= " X C: ".$i->dimensoesC." mm";
                                                                                    }
                                                                                    if(!empty($i->dimensoesA)){
                                                                                        $html .= " X A: ".$i->dimensoesA." mm";
                                                                                    }
                                                                                    echo '<td>' . $html. '</td>';
                                                                                    ...
                                                                                    if($r->planejadoPCP == 1){
                                                                                        if($i->aprovacaoDir == 1){
                                                                                            echo '<td style="text-align:center"><a onclick="openRejeitarItem('.$i->idDistribuir.','.$i->idOs.')" style="margin-right: 1%" class="btn btn-danger tip-top" ><i class="icon-remove icon-white"></i></a></td>';
                                                                                        }else{
                                                                                           echo '<td></td><td></td>'; 
                                                                                        }   
																					}																						
                                                                                    ...
                                                                                    if($i->rejeitado == 0){
                                                                                        if($i->aprovacaoDir == 1){
                                                                                            echo '<td style="text-align: center;"><label class="switch"><input type="checkbox" checked disabled name="checkPedidoCompraItens" id="checkPedidoCompraItens'.$r->idPedidoCompra.'" value="'.$i->idDistribuir.'"><span class="slider round"></span></label></td>';    
                                                                                        }else{
                                                                                            echo '<td style="text-align: center;"><label class="switch"><input type="checkbox" name="checkPedidoCompraItens" id="checkPedidoCompraItens'.$r->idPedidoCompra.'" value="'.$i->idDistribuir.'"><span class="slider round"></span></label></td>';                                                                        
                                                                                        }                                                                                    
                                                                                        echo '<td style="text-align:center"><a onclick="openRejeitarItem('.$i->idDistribuir.','.$i->idOs.')" style="margin-right: 1%" class="btn btn-danger tip-top" ><i class="icon-remove icon-white"></i></a></td>';
                                    ...
                                    <div class="span12" id="divCadastrarOs">                                
                                        <div class="widget-box" style="margin-top:0px">                                        
                                            <table id="table_id" class="table table-bordered " id="dadosTlbOsOc">
                                                ...
                                                <tbody>
                                                    <?php foreach($itensReprovados as $r){
                                                        echo '<tr class="trhistpai'.$r->idPedidoCompra.'">';
                                                            echo '<td onclick="openclose2(this,'.$r->idPedidoCompra.')" style="text-align: center;"><a class="detail-icon" ><i class="fa fa-plus"></i></a></td>';
                                                            echo '<td>'.$r->idPedidoCompra.'</td>';
                                                            echo '<td>'.$r->nomeFornecedor.'</td>';
                                                            echo '<td></td>';
                                                            echo '<td>'.date("d/m/Y H:i:s", strtotime($r->data_cadastro)).'</td>';
                                                            echo '<td>'.$r->nomeRejeitado.'</td>';
                                                            echo '<td>'.date("d/m/Y H:i:s", strtotime($r->data_rejeitado)).'</td>';
                                                            echo '<td style="text-align:center"><a onclick="abrirObservacao('.$r->idPedidoCompra.')" style="margin-right: 3%" class="btn tip-top"><i class="icon-list-alt icon-black"></i></a></td>';
                                                            echo '<td style="text-align:center"><a onclick="reavaliar('.$r->idPedidoCompra.')" style="margin-right: 3%" class="btn tip-top"><i class="icon-retweet icon-black"></i></a></td>';
                                                            echo '<td style="text-align:center"><a onclick="openCancelarOs('.$r->idPedidoCompra.')" orc="" style="margin-right: 1%" class="btn btn-danger tip-top" ><i class="icon-remove icon-white"></i></a></td>';
...
<div id="modal-cancelar" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-header">
    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
    <h5 id="myModalLabel">Cancelar o pedido</h5>
  </div>
  <div class="modal-body">
        <div class="span12">
            <h5 style="text-align: center">Deseja realmente cancelar o pedido <b id="idOcCancelarOb"></b>?</h5>
            <input type="hidden" id="idOcCancelar" value="">
        </div>
  </div>
  <div class="modal-footer">
    <button class="btn" data-dismiss="modal" aria-hidden="true">Cancelar</button>
    <a class="btn btn-danger" onclick="confirmarCancelamento()">Confirmar</a>
  </div>
</div>
<div id="modal-reavaliar" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-header">
    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
    <h5 id="myModalLabel">Liberar a edição do pedido</h5>
  </div>
  <div class="modal-body">
        <div class="span12">
            <h5 style="text-align: center">Deseja realmente liberar a edição do pedido <b id="idOc"></b>?</h5>
            <input type="hidden" id="idOcReavaliar" value="">
        </div>
  </div>
  <div class="modal-footer">
    <button class="btn" data-dismiss="modal" aria-hidden="true">Cancelar</button>
    <a class="btn btn-danger" onclick="confirmarReavaliacao()">Confirmar</a>
  </div>
</div>
<div id="modal-observacaoRej" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-header">
    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
    <h5 id="myModalLabel">Observação.</h5>
  </div>
  <div class="modal-body">
    
        <div class="span12">
            <label>Observação</label>
            <textarea class="span12" id="observacaorej" disabled></textarea>
        </div>
  </div>
  <div class="modal-footer">
    <button class="btn" data-dismiss="modal" aria-hidden="true">Cancelar</button>
...
<div id="modal-rejeitarOs" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  ...
  <div class="modal-body">
        ...
        <div class="span12">
            <label>Observação</label>
            <textarea class="span12" name="obs_rejeitadoOs" id="obs_rejeitadoOs"></textarea>
        </div>
  </div>
  <div class="modal-footer">
    <button class="btn" data-dismiss="modal" aria-hidden="true">Cancelar</button>
...
<div id="modal-rejeitarItem" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  ...
  <div class="modal-body">   
        ...
        <div class="span12">
            <label>Observação</label>
            <textarea class="span12" name="obs_rejeitado" id="obs_rejeitado"></textarea>
        </div>
  </div>
  <div class="modal-footer">
    <button class="btn" data-dismiss="modal" aria-hidden="true">Cancelar</button>
...
<script>
    ...
    function confirmarReavaliacao(){
        idOc = $("#idOcReavaliar").val();
        $.ajax({
            url: "<?php echo base_url(); ?>index.php/suprimentos/reavaliar",
            type: 'POST',
            dataType: 'json',
            async: false,
            data: {
    ...
    function confirmarCancelamento(){
        idOc = $("#idOcCancelar").val();
        $.ajax({
            url: "<?php echo base_url(); ?>index.php/suprimentos/cancelar",
            type: 'POST',
            dataType: 'json',
            async: false,
            data: {
    ...
    function openCancelarOs(idPedidoCompra){
        $("#idOcCancelarOb").empty()
        $("#idOcCancelarOb").append(idPedidoCompra)
        $("#idOcCancelar").val("");
        $("#idOcCancelar").val(idPedidoCompra);
        $("#modal-cancelar").modal("show");
    }
    function reavaliar(idPedidoCompra){
        $("#idOc").empty()
        $("#idOc").append(idPedidoCompra)
        $("#idOcReavaliar").val("");
        $("#idOcReavaliar").val(idPedidoCompra);
        $("#modal-reavaliar").modal("show");
    }
    function abrirObservacao(idPedidoCompra){
        $.ajax({
            url: "<?php echo base_url(); ?>index.php/suprimentos/getObservacaoRejeicaoByIdPedidoCompra",
            type: 'POST',
            dataType: 'json',
            async: false,
            data: {
            ...
            success: function(data4) {
                if(data4.result){
                    $("#modal-observacaoRej").modal("hide");
                    $("#observacaorej").val("");
                    $("#observacaorej").val(data4.obs);
                    $("#modal-observacaoRej").modal("show");
                }else{
                    alert("Não possuí observação.");
                }
            },
            error: function(xhr, textStatus, error) {
                console.log(xhr.responseText);
    ...
    $("input:checkbox[name=checkPedidoCompraItens]").click(function(){
        ...
        $.ajax({
            url: "<?php echo base_url(); ?>index.php/suprimentos/getDistribuirDetails",
            type: 'POST',
            dataType: 'json',
            async:false,
            data: {
                idDistribuir: this.value
            },
            success: function(data){
                obj = data.objDistribuir
            },
            error: function(xhr, textStatus, error){
                console.log(xhr.responseText);
                console.log(xhr.statusText);
        ...
        var soma = document.querySelector("#somaIdDistribuir"+obj.idPedidoCompra)
        if(soma.value <= 5000){
            permCompra(this.value,this.checked,soma,13);
            //permCompra2(obj.idPedidoCompraItens,this.checked);
        }else{
            permCompra(this.value,this.checked,soma,13);
        }
        
        if(this.checked){
            alert("Autorização confirmada.");
        }else{
    ...
    $("input:checkbox[name=checkPedidoCompra]").click(function(){
        ...
        //console.log(this)
        var arrayItens = Array.apply(null,document.querySelectorAll("#checkDistribuir"+this.value));
        var arrayItensPedido = Array.apply(null,document.querySelectorAll("#idPedidoCompraItens"+this.value));
        var soma = document.querySelector("#somaIdDistribuir"+this.value)
        ...
        if(soma.value <= 5000){
            arrayItens.forEach((elemento)=>{ 
                ...
                permCompra(elemento.value,this.checked,soma,13);
            })/*
            arrayItensPedido.forEach((elemento)=>{ 
                //elemento.checked = this.checked;          
                permCompra2(elemento.value,this.checked);
            })*/
        }else{
            arrayItens.forEach((elemento)=>{
                elemento.checked = this.checked;
    ...
    function permCompra(idDistribuir,checked,soma,status){
        $.ajax({
            url: "<?php echo base_url(); ?>index.php/suprimentos/permcompradistribuir2",
            type: 'POST',
            dataType: 'json',
            async: false,
            data: {
            ...
            success: function(data) {
                console.log(idDistribuir+"/"+checked)
                if(data.result){
                    //alert("Compra aprovada com sucesso.")
                }
            },
    ...
    function permCompra2(pedidoCompraItens,checked){
        $.ajax({
    ...
    function rejeitar(idDistribuir,obs) {
        $.ajax({
    ...
    function rejeitarItem() {
        ...
        var obs_rejeitar = $('#obs_rejeitado').val();
        rejeitar(idDistribuir,obs_rejeitar);
    ...
    function carregarinfoModalOC(item){
        ...
        html = '<div style="size:20px">'+
            '<label >Empresa:</label>'+
            '<input readonly id="emitente" class="span12 controls emitente" type="text" value="'+item[0].nome+'" size="50" />'+
            '<label readonly for="fornecedor" class="control-label">Fornecedor:</label>'+
            '<input readonly id="fornecedor" class="span12 controls fornecedor" type="text" value="'+item[0].nomeFornecedor+'" size="50" />'+
        '</div>' +
        '<table>'+
            '<tr>'+
                '<td>'+ 
            ...
            '<tr>'+
                '<td colspan="6">OBS:'+
                    '<textarea id="obs" readonly rows="5" cols="100" class="" id="obs">'+item[0].obscompras+'</textarea>'+
                '</td>'+
            '</tr>'+
        '</table>';
