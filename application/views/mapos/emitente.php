...
<div id="modalCadastrar" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  ...
  <div class="modal-header">
    ...
    <h3 id="myModalLabel">SGI - Cadastrar Dados do Emitente</h3>
  </div>
  <div class="modal-body">
					...
					<div class="control-group">
                        <label for="email_compras" class="control-label"><span class="required">E-mail Compras*</span></label>
                        <div class="controls">
                            <input type="text" name="email_compras" value="" />
                        </div>
                    </div>
    ...
    <div class="span12">
        <div class="widget-box">
            ...
            <div class="widget-content ">
                ...
                corresponde a empresa cadastrada.</div>
                <a href="#modalCadastrar" data-toggle="modal" role="button" class="btn btn-success">Cadastrar Dados</a>
            </div>
        </div>    
        ...
        <div class="widget-box">
            ...
            <div class="alert alert-info">Os dados abaixo serão utilizados no cabeçalho das telas de impressão.</div>
                <table class="table table-bordered">
                    <tbody>
                        <tr>
                            <td style="width: 25%"><img src="<?php echo base_url().$r->url_logo.$r->imagem; ?> "></td>
                            <td> <span style="font-size: 20px; "> <?php echo $r->nome; ?> </span> </br><span><?php echo $r->cnpj; ?> </br> <?php echo $r->rua.', nº:'.$r->numero.', '.$r->bairro.' - '.$r->cidade.' - '.$r->uf; ?> </span> </br> <span> E-mail: <?php echo $r->email.' - Fone: '.$r->telefone; ?></span></br> <span> E-mail Compras: <?php echo $r->email_compras; ?></span></td>
                        </tr>
                    </tbody>
                </table>

                <a href="#modalAlterar<?php echo $r->id; ?>" data-toggle="modal" role="button" class="btn btn-primary">Alterar Dados</a>
                <a href="#modalLogo<?php echo $r->id; ?>" data-toggle="modal" role="button" class="btn btn-inverse">Alterar Logo</a>
            </div>
        </div>
    </div>
</div>
...
<div id="modalAlterar<?php echo $r->id; ?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  ...
  <div class="modal-header">
    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
    <h3 id="">SGI - Editar Dados do Emitente</h3>
  </div>
  <div class="modal-body">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <input id="nome" type="hidden" name="id" value="<?php echo $r->id; ?>"  />
                        </div>
                    </div>
                    <div class="control-group">
                        <label for="cnpj" class="control-label"><span class="required">CNPJ*</span></label>
                        <div class="controls">
                            <input class="" type="text" name="cnpj" value="<?php echo $r->cnpj; ?>"  />
                        </div>
                    </div>
                    <div class="control-group">
                        <label for="descricao" class="control-label"><span class="required">IE*</span></label>
                        <div class="controls">
                            <input type="text" name="ie" value="<?php echo $r->ie; ?>"  />
                        </div>
                    </div>
                    <div class="control-group">
                        <label for="descricao" class="control-label"><span class="required">Logradouro*</span></label>
                        <div class="controls">
                            <input type="text" name="logradouro" value="<?php echo $r->rua; ?>"  />
                        </div>
                    </div>
                    <div class="control-group">
                        <label for="descricao" class="control-label"><span class="required">Número*</span></label>
                        <div class="controls">
                            <input type="text" name="numero" value="<?php echo $r->numero; ?>"  />
                        </div>
                    </div>
                    <div class="control-group">
                        <label for="descricao" class="control-label"><span class="required">Bairro*</span></label>
                        <div class="controls">
                            <input type="text" name="bairro" value="<?php echo $r->bairro; ?>"  />
                        </div>
                    </div>
                    <div class="control-group">
                        <label for="descricao" class="control-label"><span class="required">Cidade*</span></label>
                        <div class="controls">
                            <input type="text" name="cidade" value="<?php echo $r->cidade; ?>"  />
                        </div>
                    </div>
                    <div class="control-group">
                        <label for="descricao" class="control-label"><span class="required">UF*</span></label>
                        <div class="controls">
                            <input type="text" name="uf" value="<?php echo $r->uf; ?>"  />
                        </div>
                    </div>
                    <div class="control-group">
                        <label for="descricao" class="control-label"><span class="required">Telefone*</span></label>
                        <div class="controls">
                            <input type="text" name="telefone" value="<?php echo $r->telefone; ?>"  />
                        </div>
                    </div>
                    <div class="control-group">
                        <label for="descricao" class="control-label"><span class="required">E-mail*</span></label>
     ...
     <div class="control-group">
                        <label for="descricao" class="control-label"><span class="required">E-mail Compras*</span></label>
                        <div class="controls">
                            <input type="text" name="email_compras" value="<?php echo $r->email_compras; ?>" />
                        </div>
                    </div>
...
<div id="modalLogo<?php echo $r->id; ?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  ...
  <div class="modal-header">
    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
    <h3 id="">SGI - Alterar Logomarca</h3>
  </div>
  <div class="modal-body">
...
$(document).ready(function(){
    ...
    $("#formCadastrar").validate({
      ...
      messages:{
         ...
         email_compras: {required:'Campo Requerido.'}
