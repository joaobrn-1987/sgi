                                                    ...
                                                    echo '<tr class="trpai'.$d->idOrcamento_item.$d->idOs.'">';
                                                        ...
                                                        echo '<td ><div id="origem" class="span12" style="padding: 0.2%; margin-left: 0">';
                                                            ...
                                                            echo '</div>'.
                                                                ...
                                                                '</div>' ;
                                                            echo '<div class="span1">';
                                                                echo '<a onclick="receberMercadoria('.$contador_local_autocomplete.')" role="button" data-toggle="modal" class="btn btn-warning"  class="span12" style="/* margin-right: 10px;*/padding: 14px;">Entrada</a>';
                                                            echo '</div>';
                                                            echo '</div>';
                                                            ...
                                                            echo '<div>';
                                                                echo '<div class="widget-box" style="margin-top:0px">';                                        
                                                                    echo '<table id="tableHistVale" class="table table-bordered ">';
                                                                        ...
                                                                        echo ' <tbody>';
                                                                            echo '<tr>';
                                                                                if($c->idStatusEtapaServico!=3 && $c->idStatusEtapaServico!=1){
                                                                    ...
                                                                    echo '<table id="tableHistVale" class="table table-bordered ">';
                                                                        ...
                                                                        echo ' <tbody>';
                                                                            foreach($c->controleEtapaSubitem as $d){
                                                                                echo '<tr>';
                                                                                    if($d->idStatusEtapaServico!=1 && $d->idStatusEtapaServico!=3){
...
<div id="modal-observacao" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <form action="<?php echo base_url(); ?>index.php/controle/confirmarentrada"  enctype="multipart/form-data" method="post" class="form-horizontal">
    <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">

        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            <h5 id="myModalLabel">Entrada</h5>
        </div>
        <div class="modal-body">
            <h5 style="text-align: center">Confirmar a entrada dos itens</h5><!--
                ...
                for(x=0;x<itens.arrayControleEtapa.length;x++){
                    html += '<tr>';
                        ...
                        html += '<td>';
                            ...
                            html += '<input type="hidden" name="quantidadeModal[]" value="'+itens.arrayControleEtapa[x].quantidade+'">';
                        html += '</td>';
                        html += '<td>';
