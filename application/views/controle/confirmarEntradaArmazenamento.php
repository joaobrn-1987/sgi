                                                                        ...
                                                                        for($e=0;$e<count($result[$x]->pnmaster);$e++){
                                                                            echo '<tr>'. 
                                                                                ...
                                                                                '<td style="width:150px">'.                                                                                    
                                                                                    '<input type="text" name="local_master[]" id="local_master"class="span12" value="'.$result[$x]->pnmaster[$e]->local.'">'.
                                                                                '</td>'.
                                                                            '</tr>';
                                                                        }
                                                                    echo '</tbody>';
                                                                    ...
                                                                    if(!empty($result[$x]->existenteSubitem)){
                                                                        for($e=0;$e<count($result[$x]->existenteSubitem);$e++){
                                                                            echo '<tr>'.
                                                                                ...
                                                                                '</td>'.
                                                                                '<td style="width:150px">'. 
                                                                                    '<input type="text" name="local[]" id="local"class="span12" value="'.$result[$x]->existenteSubitem[$e]->local.'">'.
                                                                                '</td>'.
                                                                            '</tr>';
                                                                        }
                                                                    }
                                                                    if(!empty($result[$x]->novoSubitem)){
                                                                        for($e=0;$e<count($result[$x]->novoSubitem);$e++){
                                                                            echo '<tr>'.
                                                                                '<td  style="width:300px">'. 
                                                                                    $result[$x]->novoSubitem[$e]->pn.
                                                                                    '<input type="hidden" name="idProduto[]" value="'.$result[$x]->novoSubitem[$e]->idProdutos.'">'.
                                                                                    '<input type="hidden" name="idControleEtapa_NovoItem[]" value="'.$result[$x]->idControleEtapa.'">'.
                                                                                '</td>'.
                                                                                '<td>'. 
                                                                                    $result[$x]->novoSubitem[$e]->descricao.
                                                                                '</td>'.
                                                                                '<td style="width:80px">'. 
                                                                                ...
                                                                                '</td>'.
                                                                                '<td style="width:150px">'. 
                                                                                    '<input type="text" name="local_NovoItem[]" id="local_NovoItem" value=""class="span12">'.
                                                                                '</td>'.
                                                                            '</tr>';
                                                                        }
                                                                    }
