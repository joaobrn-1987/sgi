...
<div class="btn-group">
    ...
    <li><a tabindex="-1" role="button" href="<?php echo base_url()?>index.php/suprimentos/almoxarifado_compras/1">Solicitar Compra</a></li>
        <li><a tabindex="-1" role="button" onclick="showDivSuprimentos()">Suprimentos</a></li>
        <li><a tabindex="-1" role="button" href="<?php echo base_url()?>index.php/suprimentos/almoxarifado_compras/2">Material Entregue</a></li>
    </ul>
...
<form class="form-inline" action="<?php echo base_url() ?>index.php/suprimentos/montarpedidocompra/1"
            method="post" name="form1" id="form1">
...
<script type="text/javascript">
    ...
    $(function() {
        $(".export-csv").on('click', function(event) {
            ...
            var args = [$('#table_id'), filename + ".csv", 0];
