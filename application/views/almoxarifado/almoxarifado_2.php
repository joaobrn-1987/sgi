...
<div>
  <a style="margin-right: 1%" role="button"  idDistribuir="" class="btn btn-estoque tip-top" title="Estoque" id="btn_estoque">Visualizar Estoque</a>

  <a style="margin-right: 1%" role="button"  idDistribuir="" class="btn btn-entrada tip-top" title="Entrada" id="btn_entrada">Cadastrar Entradas</a>

  <a style="margin-right: 1%" role="button" idDistribuir="" class="btn btn-saida tip-top" title="Saída" id="btn_saida">Cadastrar Saídas</a>
...
<!--
  <a style="margin-right: 1%; float: right" role="button" idDistribuir="" class="btn btn-insumos tip-top" title="Local" id="btn_insumos">Lançamento Antecipado</a>  
-->
</div>
            ...
            foreach($result as $r){?>
              <tr>
                  ...
                  <td> <a href="#modal-editarprodutoestoque" style="margin-right: 1%" role="button" 
                    data-toggle="modal" insumoAlterar = "<?php echo $r->descricaoInsumo; ?>" idAlmoEstoqueAlterar = "<?php echo $r->idAlmoEstoque; ?>" localAlterar = "<?php echo $r->local; ?>"
                ...
                <div class="span12" id="divCadastrarOs">
                  <form class="form-inline"  >
                    ...
                    <div class="span12" style="padding: 1%; margin-left: 0">
                      ...
                      <div class="span2" class="control-group">
                        <label for="idEmpresa" class="control-label">Departamento:</label>
                        <select class="span12 form-control" name="idDepartamento" id="idDepartamento" onchange="alterarLocal22(this.value)">         
                          <?php foreach($dados_departamento as $r){
                          ?>
                            <option value="<?php echo $r->idAlmoEstoqueDep ?>"><?php echo $r->descricaoDepartamento ?> </option>
                          <?php
                      ...
                      <?php if($this->permission->checkPermission($this->session->userdata('permissao'),'aAlmoxarifado')){ ?>
                        <label for="cliente" class="control-label"></label>
                        <a class="btn btn-success" onClick="document.getElementById('formEntradas').submit();" style="justify-content: flex-end; display: table;">Finalizar</a>   
        ...
        <table class="table table-bordered " id="tableInsert">
          ...
          $tabelaEntrada = json_decode($_COOKIE['tabelaEntrada']);
            ...
            <tr>
              ...
              <td><?php echo $r->idDepartamento." | ".$r->nomeDep?><input value=<?php echo $r->idDepartamento?> name='idDepartamento_[]' id='idDepartamento_[]' type='hidden'/></td>
                ...
                <div class="span12" id="divCadastrarOs">
                  <form class="form-inline"  >
                    <div class="span12" style="padding: 1%; margin-left: 0">
                      ...
                      <div class="span2" class="control-group">
                        <label for="idEmpresa" class="control-label">Departamento:</label>
                        <select class="span12 form-control" name="idDepartamentoS" id="idDepartamentoS" onchange="alterarEstoque1(this.value)">
                          <?php foreach($dados_departamento as $r){
                          ?>
                            <option value="<?php echo $r->idAlmoEstoqueDep ?>"><?php echo $r->descricaoDepartamento ?> </option>
                          <?php
                      ...
                      <div class="span2" class="control-group">
                        ...
                        <input class="span12" class="form-control" id="obsS" type="text" name="obsS" value=""/>
                      </div>
                    </div>

                    <div class="span12" style="padding: 1%; margin-left: 0">                      
                      <div class="span1" class="control-group">
                        <label for="cliente" class="control-label">Qtd. Saída:</label>
                      ...
                      </div><?php if($this->permission->checkPermission($this->session->userdata('permissao'),'aAlmoxarifado')){ ?>
                      <div class="span1" class="control-group" >
                        <label for="cliente" class="control-label"></label>
                        <a class="btn" class="form-control" onclick="inserirLinhaTabelaSaida()"style="justify-content: flex-end; display: table;">Adicionar</a>
                      </div>
                      <div class="span1" class="control-group" style="margin-left:10px">
                        <label for="cliente" class="control-label"></label>
                        <a class="btn btn-success" class="form-control" onClick="document.getElementById('formSaidas').submit();" style="justify-content: flex-end; display: table;">Finalizar</a>
                      </div>  <?php
                          }?>                    
                    </div>
                    <!--
          ...
          <tbody>
            ...
            if(isset($tabelaSaida)){
              foreach($tabelaSaida as $r){
                ...
                <td><?php echo $r->obs ?><input value=<?php echo $r->obs ?> name='obs_[]' id='obs_[]' type='hidden'/>
  ...
  <div class="row-fluid" style="margin-top:0">
    ...
    <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
                    ...
                    <div class="span12" style="padding: 1%; margin-left: 0">
                      ...
                      <div class="span3" class="control-group">
                        <label for="idEmpresa" class="control-label">Departamento:</label>
                        <select class="span12 form-control" name="idDepartamentoRel" id="idDepartamentoRel">      
                          <option value=""></option>   
                          <?php foreach($dados_departamento as $r){
                          ?>
                            <option value="<?php echo $r->idAlmoEstoqueDep ?>"><?php echo $r->descricaoDepartamento ?> </option>
                      ...
                      <div class="span2" class="control-group" style=" margin-left: 0">
                      ...
                      <div class="span6" class="control-group">
                        <label for="numpedido_os" class="control-label">Data:</label><br>
                          De: <input class="data" type="text" name="dataInicial" class="span5" /> |  Até:<input class="data" type="text" name="dataFinal" class="span5" />
                      </div>
                    </div>
  ...
  <div class="widget-box">
    ...
    <div class="widget-content nopadding" >
      <form>
        ...
        <div class="entradaRelatorioTAB" id="divRelEntrada">
          <div class="buttons">
	...
	font-size:10px;" border="1">
        ...
        <div class="saidaRelatorioTAB" id="divRelSaida">
          <div class="buttons">
                ...
                <div class="span12" id="divCadastrarOs">
                  <form class="form-inline">
                    <div class="span12" style="padding: 1%; margin-left: 0">
                      ...
                      <div class="span3" class="control-group">
                        <label for="idEmpresa" class="control-label">Departamento:</label>
                        <select class="span12 form-control" name="idDepartamentoLocal" id="idDepartamentoLocal" >                         
                          <?php foreach($dados_departamento as $r){
                          ?>
                            <option value="<?php echo $r->idAlmoEstoqueDep ?>"><?php echo $r->descricaoDepartamento ?> </option>
                          <?php
...
function inserirLinhaTabela(pn) {
  ...
  var idDepartamento = selectDep.options[selectDep.selectedIndex].value;
  var nomeDep = selectDep.options[selectDep.selectedIndex].text;
  ...
  if(typeof idDepartamento != "UNDEFINED" && idDepartamento != null && idDepartamento != "" && typeof pn != "UNDEFINED" && pn != null && pn != "" && typeof prod != "UNDEFINED" && prod != null && prod != "" && typeof idMedicao != "UNDEFINED" && idMedicao != null && idMedicao != ""  && typeof qtd != "UNDEFINED" && qtd != null && qtd != "" && typeof valorUnit != "UNDEFINED" && valorUnit != null && valorUnit != "")
  {
    ...
    newCell = newRow.insertCell(8);     
    newCell.innerHTML = idDepartamento+"| "+nomeDep+"<input value='"+idDepartamento+"' name='idDepartamento_[]' id='idDepartamento_[]' type='hidden'/>";
...
function alterarLocal1(){
	var selectdois = document.getElementById('idDepartamento');
	var idDepartamento = selectdois.options[selectdois.selectedIndex].value;
...
function alterarLocal2(value){
  var select = document.getElementById('idDepartamento');
...
$(document).ready(function(){
	...
	$("#prodS").autocomplete({
    source: "<?php echo base_url(); ?>index.php/almoxarifado/autoCompleteEstoqueSaida/1/1",
		minLength: 1,
		select: function( event, ui ) {
			 $('#idAlmoEstoqueS').val(ui.item.id);
       $('#localS').val(ui.item.local);
