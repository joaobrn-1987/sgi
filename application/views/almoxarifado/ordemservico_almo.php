    ...
    <div class="row-fluid" style="margin-top:0">
        <div class="span12">
            <div class="widget-box">
                ...
                <div class="widget-content nopadding">
                    <table class='comBordas' width='50%' align='left'>
                        <tr>
                            <td align='center'>
                                Cod. O.S.:: <font size='5'>1 | KRMB</font>
                            </td>
                            <td align='center'>
                                Cod. O.S.:: <font size='5'>2 | Petrolina</font></td>
                            <td align='center'>
                                Cod. O.S.:: <font size='5'>3 | UDI</font></td>
                            <td align='center'>
                                Cod. O.S.:: <font size='5'>6 | Pará</font></td>
                        </tr>
                    </table>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tab1">
                                ...
                                <div class="span12" id="divCadastrarOs">
                                    ...
                                    <form class="form-inline" action="<?php echo base_url() ?>index.php/almoxarifado/ordemservico" method="post" name="form8" id="form8">
                                ...
                                <table id="tableOs" class="table table-bordered ">
                                    ...
                                    <?php
                                        ...
                                        <?php
                                            ...
                                            echo '<td><font size="1">';
                                            if ($this->permission->checkPermission($this->session->userdata('permissao'), 'eDistribuirOs')) {
                                                if(($r->idOs == 1 || $r->idOs == 2 || $r->idOs == 3 || $r->idOs == 4 || $r->idOs == 5 || $r->idOs == 6 || $r->idOs == 7 || $r->idOs == 11 || $r->idOs == 12 || $r->idOs == 10 || $r->idOs == 13) || $r->idGrupoServico == 3)
