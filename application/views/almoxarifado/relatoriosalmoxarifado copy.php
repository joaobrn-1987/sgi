    ...
    function preencherTabelaEstoqueGeral(resultado){
      ...
      for(y=0;y<resultado.length;y++){
        ...
        if(resultado[x].valor_unit_medio == null){
          ...
          newCell.innerHTML = "R$ "+resultado[x].valor_unit_medio.replace(".",",");
        }   
        ...
        if(resultado[x].valor_total_entrada == null){
          ...
          newCell.innerHTML = "R$ "+resultado[x].valor_total_entrada.replace(".",",");
        }
        ...
        if(resultado[x].valor_total_saida == null){
          ...
          newCell.innerHTML = "R$ "+resultado[x].valor_total_saida.replace(".",",");
        }
        ...
        if(resultado[x].valor_total == null){
          ...
          newCell.innerHTML = "R$ "+resultado[x].valor_total.replace(".",",");
        }
