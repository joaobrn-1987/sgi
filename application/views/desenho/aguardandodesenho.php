...
<?php 
        ...
        <div class="widget-box">
            ...
            <div class="widget-content nopadding">
                <table class="table table-bordered " id="tableAguardandoDesenho">
                    ...
                    <tbody>
                        <?php foreach ($c->objOrcamento as $r) {
                            ...
                            for($x = 0;$x < $tot;$x++){
                                ...
                                if(!empty($orcitem->data_solicitar_desenho)){
									...
									//$statusOs = ($orcitem->idStatusOs);
									//$nomeStatusOs = ($orcitem->nomeStatusOs);
                                }
                            ...
                            echo '</td>';
							echo '<td >' . $c->status_execucao. '</td>';
							echo '<td >' . $nomeStatusOs . '</td>';	
    ...
    if($result){?>
        ...
        <div class="buttons">
            ...
            <a href=javascript:; class="export-csv btn btn-mini btn-inverse" data-filename="AguardandoDesenho">csv</a>
			<a href="javascript:;" class="export-xls btn btn-mini btn-inverse" data-filename="AguardandoDesenho">xls</a>
        </div>
                <div class="widget-content nopadding" id="divDesenho" >
                    <table class="table table-bordered " id="AguardandoDesenho">
                        <thead>
                            <tr>
...
<script type="text/javascript">
    ...
    $(function () {
      $(".export-csv").on('click', function (event) {
          ...
          var args = [$('#AguardandoDesenho'), filename + ".csv", 0];
  ...
  $(function () {
    ...
    $(".export-xls").on('click', function () {
      ...
      exportTableToExcel($('#AguardandoDesenho'), filename + ".xls");
    });
