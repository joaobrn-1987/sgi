...
<form action="<?php echo base_url() ?>index.php/desenho/finalizar"   enctype="multipart/form-data"  method="post" name="formFinalizar" id="formFinalizar">
                                                            ...
                                                            echo '<input type="hidden" id="id_orc_item_' . $contador_local_autocomplete . '" name="id_orc_item[]"   value="' . $d->idOrcamento_item . '"/>' .
                                                                ...
                                                                echo '<div class="span1">'. 
                                                                    ...
                                                                    if(!$d->nome){
                                                                        ...
                                                                        '<input readonly type="text" class="span12" value="' . $d->nome . '" />'.
                                                                        ...
                                                                        '<div id="modal-imagem_'.$d->idOrcamento_item.'" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">'.
                                                                            ...
                                                                            '<div class="modal-body">'.
                                                                                ...
                                                                                '<div class="span12" style="margin-left:0px;display:'.(($d->statusDesenho == 3)?"block":"none").'">'. /*
                                                                                    ...
                                                                                    '</div>'.                                                                             
                                                                                '</div>'.
                                                                                '<div class="span12" style="margin-left:0px;display:'.($d->idStatusEscopo==1?"block":"none").'">'. /*
                                                                                    '<div class="span3">'.
                                                                                        '<label>Nome Arquivo</label>'.
                                                                                        '<input type="text" name="nomeArquivo_'.$d->idOrcamento_item.'[]" id="nomeArquivo_'.$d->idOrcamento_item.'">'.
                                                                                    '</div>'.*/
    ...
    <div id="imagensDiv" style="display:none">
...
<script type="text/javascript">
    ...
    function adicionarItemCatalogo(pos) {
        ...
        var modal = '<div id="modal-imagem_novo_fab_'+pos+'_'+numOfRows+'" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">'+
                '<div class="modal-header">'+
                    '<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>'+
                    '<h5 id="myModalLabel">Anexar Desenho. PN.: </h5>'+
                '</div>'+
                '<div class="modal-body">'+
                    '<div class="span12" style="margin-left:0px;display:block">'+ 
                        '<div class="span3">'+
                            '<label> Arquivo </label>'+
                            '<input type="file"  name="imag_novo_fab_'+pos+'_'+numOfRows+'[]" id="imag_novo_fab_'+pos+'_'+numOfRows+'" accept=".pdf,.dwg">'+
                        '</div>'+   
                        '<div class=""span3>'+
                            '<a onclick="salvarArquivoNovoFab('+pos+','+numOfRows+','+contagemItem+')" role="button" data-toggle="modal" style="margin-right: 1%" class="btn btn-success" ><i class="fa fa-plus" style="color:white"></i> Salvar Desenho</a>'+
                        '</div>'+
                    '</div>'+
                    '<div class="span12"  style="margin-left:0px">'+                                                                                
                        '<div class="row-fluid" style="margin-top:0">'+
                                ...
                                '<div class="widget-box">'+
                                    ...
                                    '<div class="widget-content nopadding">'+
                                        '<div class="span12" id="divProdutosServicos" style=" margin-left: 0">'+
                                            '<div class="span12" id="divCadastrarOs">  '+                             
                                                '<div class="widget-box" style="margin-top:0px">'+                                       
                                                    '<table class="table table-bordered " id="tableDesenhos_novo_fab_'+pos+'_'+numOfRows+'">'+
                                                        '<thead>'+
                                                            '<tr>'+
                                                                '<th>Arquivo</th>'+
                                                                '<th>Status Desenho</th>'+
    ...
    function adicionarItemCheckList(pos) {
        ...
        var modal = '<div id="modal-imagem_novo_'+pos+'_'+numOfRows+'" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">'+
                '<div class="modal-header">'+
                    '<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>'+
                    '<h5 id="myModalLabel">Anexar Desenho. PN.: </h5>'+
                '</div>'+
                '<div class="modal-body">'+
                    '<div class="span12" style="margin-left:0px;display:block">'+ 
                        '<div class="span3">'+
                            '<label> Arquivo </label>'+
                            '<input type="file"  name="imag_novo_'+pos+'_'+numOfRows+'[]" id="imag_novo_'+pos+'_'+numOfRows+'" accept=".pdf,.dwg">'+
                        '</div>'+   
                        '<div class=""span3>'+
                            '<a onclick="salvarArquivoNovo('+pos+','+numOfRows+','+contagemItem+')" role="button" data-toggle="modal" style="margin-right: 1%" class="btn btn-success" ><i class="fa fa-plus" style="color:white"></i> Salvar Desenho</a>'+
                        '</div>'+
                    '</div>'+
                    '<div class="span12"  style="margin-left:0px">'+                                                                                
                        '<div class="row-fluid" style="margin-top:0">'+
                                ...
                                '<div class="widget-box">'+
                                    ...
                                    '<div class="widget-content nopadding">'+
                                        '<div class="span12" id="divProdutosServicos" style=" margin-left: 0">'+
                                            '<div class="span12" id="divCadastrarOs">  '+                             
                                                '<div class="widget-box" style="margin-top:0px">'+                                       
                                                    '<table class="table table-bordered " id="tableDesenhos_novo_'+pos+'_'+numOfRows+'">'+
                                                        '<thead>'+
                                                            '<tr>'+
                                                                '<th>Arquivo</th>'+
                                                                '<th>Status Desenho</th>'+
                ...
                '</div>'+ 
            '</div>';
        $("#tableEscopo_" + pos).children("tbody").append('<tr><td></td><td><input type="checkbox" name="checkItemComercial_novo_' + pos + '[]" class="span12"  id="checkItemComercial_novo" value=""></td><td><input type="text" class="span12" name="novoEscopoPN_' + pos + '[]" id="novoEscopoPN_' + pos + '_' + numOfRows + '"><input type="hidden" name="contagemNovo'+pos+'" value="'+contagemItem+'"><input type="hidden" class="span12" name="novoEscopoIdProduto_' + pos + '[]" id="novoEscopoIdProduto_' + pos + '_' + numOfRows + '"></td><td><input type="text" class="span12" readonly name="novoEscopoDescProd_' + pos + '[]" id="novoEscopoDescProd_' + pos + '_' + numOfRows + '"></td><td></td><td style="width:50px"><input type="text" class="span12 number" name="novoEscopoQtd_' + pos + '[]" id="novoEscopoQtd_' + pos + '_' + numOfRows + '"></td><td><select class="span12" name="novoEscopoIdClasse_' + pos + '[]" id="novoEscopoIdClasse_' + pos + '_' + numOfRows + '"><option value="">Selecione</option><option value="cil">Cilindro</option>' +
            '<option value="maq">Máquina</option>' +
            '<option value="pec">Peça</option>' +
            '<option value="sub">Subconjunto</option></select></td><td><a href="#modal-imagem_novo_'+pos+'_'+numOfRows+'" role="button" data-toggle="modal" style="margin-right: 1%" class="btn tip-top" ><i id="i_" class="icon-ban-circle" style="color:grey"></i></a>'+modal+'</td><td><button style="margin-right: 1%" data-toggle="modal" class="btn btn-danger tip-top " class="excluir" onclick="deleteRow3(this.parentNode.parentNode.rowIndex,'+pos+')"><font size=1>Excluir</font></button></td></tr>'/*+
            */);
    ...
    function salvarArquivoNovo(pos,numRow,test){
        var file_data = document.getElementById('imag_novo_'+pos+'_'+numRow); 
        var $this = $(file_data), $clone = $this.clone();
        $('#imagensDiv').append($clone);
        $($clone).attr('name','newImage_'+pos+'_'+test+'[]');
        $($clone).attr('id','');

        var html = "";
        html += "<tr>";
            html += "<td>";            
                html += "<a href=\""+URL.createObjectURL(file_data.files[0])+"\" target=\"_blank\">"+$(file_data).val().split('\\').pop()+"</a>";
            html += "</td>";
            html += "<td>";
                html += "Não salvo";
            html += "</td>";
        ...
        //$('#tableDesenhos_novo_'+pos+'_'+numRow+' tbody').empty();
        
        $('#tableDesenhos_novo_'+pos+'_'+numRow+' tbody').append(html);
        $(file_data).val(null);
        alert("O desenho será registrado ao clicar em salvar.");
        //$this.after($clone).appendTo(hiddenform);
    }

    function salvarArquivoNovoFab(pos,numRow,test){
        var file_data = document.getElementById('imag_novo_fab_'+pos+'_'+numRow); 
        var $this = $(file_data), $clone = $this.clone();
        $('#imagensDiv').append($clone);
        $($clone).attr('name','newImage_fab_'+pos+'_'+test+'[]');
        $($clone).attr('id','');
        ...
        $('#tableDesenhos_novo_fab_'+pos+'_'+numRow+' tbody').append(html);
        $(file_data).val(null);
        alert("O desenho será registrado ao clicar em salvar.");
        //$this.after($clone).appendTo(hiddenform);
    }
