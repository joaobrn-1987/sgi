                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tab1">
                                ...
                                <div class="span12" id="divCadastrarOs">
                                    ...
                                    <form class="form-inline" action="<?php echo base_url() ?>index.php/suprimentos/ordemservico" method="post" name="form8" id="form8">
                                ...
                                <table id="tableOs" class="table table-bordered ">
                                    ...
                                    <?php
                                        ...
                                        <?php
                                            ...
                                            echo '<td><font size="1">';
                                            if ($this->permission->checkPermission($this->session->userdata('permissao'), 'eDistribuirOs')) {
                                                if(($r->idOs == 1 || $r->idOs == 2 || $r->idOs == 3 || $r->idOs == 4 || $r->idOs == 5 || $r->idOs == 6 || $r->idOs == 11 || $r->idOs == 12 || $r->idOs == 10 || $r->idOs == 13) || $r->idGrupoServico == 3)
