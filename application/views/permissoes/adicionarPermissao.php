                            ...
                            <table class="table table-bordered">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <label>
                                                <input name="aObsPlanejamento" class="marcar" type="checkbox" value="1" />
                                    ...
                                    <tr>
                                        <td>
                                            <label>
                                                <input name="vProcessos" class="marcar" type="checkbox" value="1" />
                                                <span class="lbl">Visualizar Processos</span>
                                            </label>
                                        </td>
                                        <td>
                                            <label>
                                                <input name="eProcessos" class="marcar" type="checkbox" value="1" />
                                                <span class="lbl">Editar Processos</span>
                                            </label>
                                        </td>
                                        <td>
                                            <label>
                                                <input name="aProcessos" class="marcar" type="checkbox" value="1" />
                                                <span class="lbl">Adicionar Processos</span>
                                            </label>
                                        </td>
                                        <td>
                                            <label>
                                                <input name="aGruposProcessos" class="marcar" type="checkbox" value="1" />
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <label>
                                                <input name="receberMercadoria" class="marcar" type="checkbox" value="1" />
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <label>
                                                <input name="desenhoTotal" class="marcar" type="checkbox" value="1" />
