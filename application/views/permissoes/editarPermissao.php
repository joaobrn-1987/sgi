<?php $permissoes = unserialize($result->permissoes, ['allowed_classes' => false]); ?>
                            ...
                            <table class="table table-bordered">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <label>
                                                <input <?php if (isset($permissoes['aObsPlanejamento'])) {
                                                            if ($permissoes['aObsPlanejamento'] == '1') {
                                                                echo 'checked';
                                                            }
                                                        } ?> name="aObsPlanejamento" class="marcar" type="checkbox" value="1" />
                                                <span class="lbl">Observação PCP</span>
                                            </label>
                                        </td>
                                        <td>
                                            <label>
                                    ...
                                    <tr>
                                        <td>
                                            <label>
                                                <input <?php if (isset($permissoes['vProcessos'])) {
                                                            if ($permissoes['vProcessos'] == '1') {
                                                                echo 'checked';
                                                            }
                                                        } ?> name="vProcessos" class="marcar" type="checkbox" value="1" />
                                                <span class="lbl">Visualizar Processos</span>
                                            </label>
                                        </td>
                                        <td>
                                            <label>
                                                <input <?php if (isset($permissoes['eProcessos'])) {
                                                            if ($permissoes['eProcessos'] == '1') {
                                                                echo 'checked';
                                                            }
                                                        } ?> name="eProcessos" class="marcar" type="checkbox" value="1" />
                                                <span class="lbl">Editar Processos</span>
                                            </label>
                                        </td>
                                        <td>
                                            <label>
                                                <input <?php if (isset($permissoes['aProcessos'])) {
                                                            if ($permissoes['aProcessos'] == '1') {
                                                                echo 'checked';
                                                            }
                                                        } ?> name="aProcessos" class="marcar" type="checkbox" value="1" />
                                                <span class="lbl">Adicionar Processos</span>
                                            </label>
                                        </td>
                                        <td>
                                            <label>
                                                <input <?php if (isset($permissoes['aGruposProcessos'])) {
                                                            if ($permissoes['aGruposProcessos'] == '1') {
                                                                echo 'checked';
                                                            }
                                                        } ?> name="aGruposProcessos" class="marcar" type="checkbox" value="1" />
                                                <span class="lbl">Adicionar Grupo Processos</span>
                                            </label>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <label>
                                                <input <?php if (isset($permissoes['receberMercadoria'])) {
                                                            if ($permissoes['receberMercadoria'] == '1') {
                                                                echo 'checked';
                                                            }
                                                        } ?> name="receberMercadoria" class="marcar" type="checkbox" value="1" />
                                                <span class="lbl"> Receber Mercadoria</span>
                                            </label>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <label>
                                                <input <?php if (isset($permissoes['desenhoTotal'])) {
                                                            if ($permissoes['desenhoTotal'] == '1') {
                                                                echo 'checked';
                                                            }
                                                        } ?> name="desenhoTotal" class="marcar" type="checkbox" value="1" />
                                                <span class="lbl">Excluir Qualquer Desenho</span>
                                            </label>
                                        </td>
                                    </tr>
                                </tbody>
