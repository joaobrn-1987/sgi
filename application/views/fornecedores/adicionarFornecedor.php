	...
	<div class="widget-content nopadding">
		...
		<div class="span12" id="divProdutosServicos" style=" margin-left: 0">
            <ul class="nav nav-tabs">
				...
				<li id="tabSubOs"><a href="#tab3" data-toggle="tab">
					<font color='red'>Cadastro <strong>NACIONAL</strong></font>
				</a></li>
				
                <li id="tabEscopo"><a href="#tab7" data-toggle="tab">
                    <font color='red'>Cadastro <strong>INTERNACIONAL</strong></font>
				</a></li>
        ...
        <div class="widget-content nopadding">
			...
			<div class="span12" "widget-title" id="divProdutosServicos" style=" margin-left: 0">
									...
									<div class="span12">
										<div class="widget-box">
											<div class="widget-title">
												...
												<h5>Fornecedor Nacional</h5>
											</div>
											<div class="widget-content nopadding">
												<?php if ($custom_error != '') {
													echo '<div class="alert alert-danger">' . $custom_error . '</div>';
												} ?>
												<form action="<?php echo base_url(); ?>index.php/fornecedores/adicionar" id="formFornecedor" method="post" class="form-horizontal" >
    <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">


													<input type="hidden" name="tipoFor" value="1">
														...
														<div class="span12">
															<div class="span6 offset3">
																<!--<button type="submit" class="btn btn-success"><i class="icon-plus icon-white"></i> Adicionar</button>-->
																 <button type="button" class="btn btn-success" onclick="submitForm('formFornecedor')"><i class="icon-plus icon-white"></i> Adicionar</button>
</form>
									...
									<div class="span12">
										<div class="widget-box">
											<div class="widget-title">
												...
												<h5>Fornecedor Internacional Comex</h5>
											</div>
											<div class="widget-content nopadding">
												<?php if ($custom_error != '') {
													echo '<div class="alert alert-danger">' . $custom_error . '</div>';
												...
												<form action="<?php echo base_url(); ?>index.php/fornecedores/adicionarInt" id="formFornecedorInt" method="post" class="form-horizontal" >
    <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
...
-->
													...
													<div class="control-group">
														...
														<div class="controls">
															<input class="span8" id="site" type="text" name="site" value="<?php echo set_value('site'); ?>"  />
														</div>
													</div>
													...
													<div class="control-group" class="control-label">
														<label for="endcomp" class="control-label">Endereço completo<span class=""></span></label>
														<div class="controls">
															<input class="span8" id="endcomp" type="text" name="endcomp" value="<?php echo set_value('endcomp'); ?>"  />
														</div>
													</div>
													...
													<div class="form-actions">
														<div class="span12">
															<div class="span6 offset3">
																<!--<button type="submit" class="btn btn-success"><i class="icon-plus icon-white"></i> Adicionar</button>-->
																 <button type="submit" class="btn btn-success" onclick="submitForm('formFornecedorInt')"><i class="icon-plus icon-white"></i> Adicionar</button>
																<!-- <button type="submit" class="btn btn-success"><i class="icon-plus icon-white"></i> Adicionar</button>
																 <!-- Link que será clicado -->
																	<!--<a href="#tab7" data-toggle="tab" id="tab7" style="display:none;"></a>
																	<!-- Botão que dispara o clique no link -->
																	<!--<button type="submit" onclick="document.getElementById('tab7').click();">Adicionar</button>-->
