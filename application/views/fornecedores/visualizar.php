<div class="widget-box">
    <div class="widget-title">
        <ul class="nav nav-tabs">
			...
			if($this->permission->checkPermission($this->session->userdata('permissao'),'eFornecedor') && ($result->tipofor == '2')) {
				echo '<a title="Icon Title" class="btn btn-mini btn-info" href="'.base_url().'index.php/fornecedores/editarInt/'.$result->idFornecedores.'"><i class="icon-pencil icon-white"></i> Editar</a>'; 
			} elseif ($this->permission->checkPermission($this->session->userdata('permissao'),'eFornecedor') && ($result->tipofor == '1') || ($result->tipofor == '') ) {
				echo '<a title="Icon Title" class="btn btn-mini btn-info" href="'.base_url().'index.php/fornecedores/editar/'.$result->idFornecedores.'"><i class="icon-pencil icon-white"></i> Editar</a>'; 
			} 
			?>
                                        ...
                                        <table class="table table-bordered">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><?php echo $result->nomeFornecedor ?></td>
                                                </tr>
                                                <tr>
                                ...
                                <div class="collapse accordion-body" id="collapseGThree">
                                    <div class="widget-content">
                                        <table class="table table-bordered">
                                            <tbody>
											    <tr>
                                                    <td style="text-align: right"><strong>End. Internacional</strong></td>
                                                    <td><?php echo $result->endcomp ?></td>
                                                </tr>
                                                <tr>
