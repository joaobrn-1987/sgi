...
class Permissoes_model extends CI_Model {
    ...
    function getUsuariosComPermissao($like){
		$query = 'SELECT usuarios.* FROM `permissoes` join usuarios on usuarios.permissoes_id = permissoes.idPermissao WHERE permissoes like \'%'.$like.'%\'';
